...
export const MYSTIC_CLASS: ExpandedClassData = {
  ...
  weaponProficiencies: ['Simple weapons', 'Martial weapons', 'Katanas', 'Wakizashis'],
  ...
  classFeatures: [
    ...
    },
    {
      ...
      id: 'animus',
      shortDescription:
        'Combat resource pool: starts at 1+WIS mod on first turn, +1/turn, +1 on maneuver initiation',
      description:
    ...
    },
    {
      ...
      shortDescription:
        'Standard action — change active element (air/earth/fire/water); or 1 animus free action while changing stance',
    ...
    },
    {
      ...
      id: 'blade-meditation',
      shortDescription:
        'Full-round, 1 animus — grant all withheld maneuvers then expend; melee attackers take 1d6+/2 animus active-element damage until next turn',
      activationMode: 'action',
      activationCost: { resourceId: 'mystic_animus', amount: 1 },
      description:
      ...
      effects: [
        {
          type: 'special',
          target: 'special.blade_meditation_retaliation',
          value: 0,
          source: 'Blade Meditation',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      id: 'elemental-glyph',
      shortDescription:
        'Move, 1 animus — apply chosen elemental glyph to IL-mod allies in sight for 1+IL-mod rounds',
      activationMode: 'action',
      activationCost: { resourceId: 'mystic_animus', amount: 1 },
      description:
      ...
      effects: [
        {
          type: 'special',
          target: 'special.elemental_glyph',
          value: 0,
          source: 'Elemental Glyph',
        },
      ],
    },
    {
      ...
      effects: [
        {
          type: 'special',
          target: 'special.elemental_glyph_air',
          value: 0,
          source: 'Elemental Glyph: Air',
        },
      ],
    },
    {
      ...
      effects: [
        {
          type: 'special',
          target: 'special.elemental_glyph_darkness',
          value: 0,
          source: 'Elemental Glyph: Darkness',
        },
      ],
    },
    {
      ...
      effects: [
        {
          type: 'special',
          target: 'special.elemental_glyph_earth',
          value: 0,
          source: 'Elemental Glyph: Earth',
        },
      ],
    },
    {
      ...
      effects: [
        {
          type: 'special',
          target: 'special.elemental_glyph_fire',
          value: 0,
          source: 'Elemental Glyph: Fire',
        },
      ],
    },
    {
      ...
      effects: [
        {
          type: 'special',
          target: 'special.elemental_glyph_illumination',
          value: 0,
          source: 'Elemental Glyph: Illumination',
        },
      ],
    },
    {
      ...
      effects: [
        {
          type: 'special',
          target: 'special.elemental_glyph_metal',
          value: 0,
          source: 'Elemental Glyph: Metal',
        },
      ],
    },
    {
      ...
      effects: [
        {
          type: 'special',
          target: 'special.elemental_glyph_water',
          value: 0,
          source: 'Elemental Glyph: Water',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      shortDescription:
        'Free, 1/day (scaling +1 per 4 levels after 6th) — expend a granted maneuver, immediately replace it with any known maneuver',
      activationMode: 'action',
      resourcePool: {
        id: 'instant_enlightenment_uses',
        name: 'Instant Enlightenment',
        rechargeOn: 'rest',
        maxFormula: '1 + max(0, floor((mysticLevel - 6) / 4))',
        restRecoveryMode: 'full',
      },
      description:
    ...
    },
    {
      ...
      level: 6,
      description: "The mystic's arcane defense insight bonus increases to +2.",
      effects: [],
    },
    {
      name: 'Bonus Feat',
    ...
    },
    {
      ...
      level: 8,
      description: "The mystic's elemental glyphs gain their 8th-level benefits.",
      effects: [],
    },
    {
      name: 'Quell Magic',
      ...
      id: 'quell-magic',
      shortDescription:
        'Standard — spend animus equal to spell/power level to suppress it within 30 ft for IL-mod rounds',
      activationMode: 'action',
      description:
    ...
    },
    {
      ...
      level: 10,
      description: 'The mystic can use instant enlightenment 2/day.',
      effects: [],
    },
    {
      name: 'Arcane Defense Increase',
      level: 11,
      description: "The mystic's arcane defense insight bonus increases to +3.",
      effects: [],
    },
    {
      name: 'Bonus Feat',
    ...
    },
    {
      ...
      level: 13,
      description: "The mystic's elemental glyphs gain their 13th-level benefits.",
      effects: [],
    },
    {
      name: 'Instant Enlightenment Increase',
      level: 14,
      description: 'The mystic can use instant enlightenment 3/day.',
      effects: [],
    },
    {
      name: 'Font of Animus',
      ...
      id: 'font-of-animus',
      shortDescription:
        'Move, (WIS mod+1)/day — add 1d6+WIS mod animus; resets pool if used again; usable outside combat for 1 minute',
      activationMode: 'action',
      resourcePool: {
        id: 'font_of_animus_uses',
        name: 'Font of Animus',
        rechargeOn: 'rest',
        maxFormula: 'max(1, 1 + wisMod)',
        restRecoveryMode: 'full',
    ...
    },
    {
      name: 'Arcane Defense Increase',
      level: 16,
      description: "The mystic's arcane defense insight bonus increases to +4.",
      effects: [],
    },
    {
      name: 'Bonus Feat',
    ...
    },
    {
      name: 'Instant Enlightenment Increase',
      level: 18,
      description: 'The mystic can use instant enlightenment 4/day.',
      effects: [],
    },
    {
      name: 'Elemental Glyph (IV)',
      level: 19,
      description: "The mystic's elemental glyphs gain their 19th-level benefits.",
      effects: [],
    },
    {
      name: 'Glyph Mastery',
      ...
      id: 'glyph-mastery',
      shortDescription:
        'Move, 2 animus — manifest two elemental glyphs simultaneously, regardless of active element',
      activationMode: 'action',
      activationCost: { resourceId: 'mystic_animus', amount: 2 },
      description:
      ...
      effects: [
        {
          type: 'special',
          target: 'special.glyph_mastery',
          value: 0,
          source: 'Glyph Mastery',
        },
      ],
    },
    {
      name: 'Arcane Defense Increase',
      level: 20,
      description: "The mystic's arcane defense insight bonus increases to +5.",
      effects: [],
    },
  ],
  spellcasting: {
