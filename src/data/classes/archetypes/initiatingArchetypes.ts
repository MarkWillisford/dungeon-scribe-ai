...
export const GRANT_INITIATING_ARCHETYPES: ArchetypeData[] = [
  ...
  // ──────────────────────────────────────────────
  {
    ...
    modifiedFeatures: [
      'Smite Evil (2 uses instead of increasing progression)',
      'Aura of Courage (halved range)',
    ],
    newFeatures: [
      {
        name: 'Initiating',
  ...
  // ──────────────────────────────────────────────
  {
    ...
    modifiedFeatures: [
      'Favored Terrain (retained)',
      'Track (retained)',
      'Swift Tracker (retained)',
    ],
    newFeatures: [
      {
        name: 'Initiating',
...
export const DISCIPLINE_SWAP_ARCHETYPES: ArchetypeData[] = [
...

  {
    ...
    replacedFeatures: [
      ...
      'Discipline Access (varies — TODO: verify)',
    ],
