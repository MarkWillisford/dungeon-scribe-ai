...
export const HYBRID_CLASSES_EXPANDED: ExpandedClassData[] = [
  // ─── ARCANIST (Sorcerer + Wizard) ──────────────────────────────────────────
  {
    ...
    classFeatures: [
      ...
      { name: 'Arcanist Exploit', level: 3, description: 'Gain an additional arcanist exploit.' },
      { name: 'Arcanist Exploit', level: 5, description: 'Gain an additional arcanist exploit.' },
      { name: 'Arcanist Exploit', level: 7, description: 'Gain an additional arcanist exploit.' },
      { name: 'Arcanist Exploit', level: 9, description: 'Gain an additional arcanist exploit.' },
      {
      ...
      { name: 'Greater Exploit', level: 13, description: 'Gain an additional greater exploit.' },
      { name: 'Greater Exploit', level: 15, description: 'Gain an additional greater exploit.' },
      { name: 'Greater Exploit', level: 17, description: 'Gain an additional greater exploit.' },
      { name: 'Greater Exploit', level: 19, description: 'Gain an additional greater exploit.' },
      {
  ...
  // ─── BLOODRAGER (Barbarian + Sorcerer) ─────────────────────────────────────
  {
    ...
    classFeatures: [
      ...
      { name: 'Damage Reduction', level: 10, description: 'Damage reduction increases to 2/—.' },
      {
      ...
      { name: 'Damage Reduction', level: 13, description: 'Damage reduction increases to 3/—.' },
      {
      ...
      { name: 'Damage Reduction', level: 16, description: 'Damage reduction increases to 4/—.' },
      {
      ...
      { name: 'Damage Reduction', level: 19, description: 'Damage reduction increases to 5/—.' },
      {
  ...
  // ─── BRAWLER (Fighter + Monk) ──────────────────────────────────────────────
  {
    ...
    classFeatures: [
      ...
      { name: 'Bonus Combat Feat', level: 5, description: 'Gain a bonus combat feat.' },
      {
        name: 'Maneuver Training',
        level: 7,
        description: 'Select an additional maneuver and increase existing bonuses by +1.',
      },
      { name: 'Bonus Combat Feat', level: 8, description: 'Gain a bonus combat feat.' },
      { name: 'AC Bonus', level: 9, description: 'AC bonus increases to +2.' },
      { name: 'Knockout', level: 10, description: 'Knockout increases to 2/day.' },
      { name: 'Bonus Combat Feat', level: 11, description: 'Gain a bonus combat feat.' },
      {
        name: 'Maneuver Training',
        level: 11,
        description: 'Select an additional maneuver and increase existing bonuses by +1.',
      },
      { name: 'AC Bonus', level: 13, description: 'AC bonus increases to +3.' },
      { name: 'Bonus Combat Feat', level: 14, description: 'Gain a bonus combat feat.' },
      {
        name: 'Maneuver Training',
        level: 15,
        description: 'Select an additional maneuver and increase existing bonuses by +1.',
      ...
      { name: 'Knockout', level: 16, description: 'Knockout increases to 3/day.' },
      { name: 'Bonus Combat Feat', level: 17, description: 'Gain a bonus combat feat.' },
      { name: 'AC Bonus', level: 18, description: 'AC bonus increases to +4.' },
      {
        name: 'Maneuver Training',
        level: 19,
        description: 'Select an additional maneuver and increase existing bonuses by +1.',
      ...
      { name: 'Bonus Combat Feat', level: 20, description: 'Gain a bonus combat feat.' },
    ],
    spellcasting: {
      type: 'None',
      casting: 'None',
  ...
  // ─── HUNTER (Druid + Ranger) ───────────────────────────────────────────────
  {
    ...
    classFeatures: [
      ...
      { name: 'Teamwork Feat', level: 6, description: 'Gain an additional bonus teamwork feat.' },
      {
        name: 'Bonus Trick',
        level: 7,
        description:
      ...
      { name: 'Teamwork Feat', level: 9, description: 'Gain an additional bonus teamwork feat.' },
      {
      ...
      { name: 'Teamwork Feat', level: 12, description: 'Gain an additional bonus teamwork feat.' },
      {
        name: 'Bonus Trick',
        level: 13,
      ...
      { name: 'Teamwork Feat', level: 15, description: 'Gain an additional bonus teamwork feat.' },
      {
      ...
      { name: 'Teamwork Feat', level: 18, description: 'Gain an additional bonus teamwork feat.' },
      {
        name: 'Bonus Trick',
        level: 19,
        description: 'The animal companion learns another bonus trick.',
  ...
  // ─── INVESTIGATOR (Alchemist + Rogue) ──────────────────────────────────────
  {
    ...
    classFeatures: [
      ...
      { name: 'Poison Resistance', level: 5, description: 'Poison resistance increases to +4.' },
      { name: 'Trap Sense', level: 6, description: 'Trap sense increases to +2.' },
      {
        name: 'Investigator Talent',
        level: 7,
        description: 'Gain an additional investigator talent.',
      },
      { name: 'Poison Resistance', level: 8, description: 'Poison resistance increases to +6.' },
      {
        name: 'Investigator Talent',
        level: 9,
        description: 'Gain an additional investigator talent.',
      },
      { name: 'Trap Sense', level: 9, description: 'Trap sense increases to +3.' },
      {
      ...
      { name: 'Trap Sense', level: 12, description: 'Trap sense increases to +4.' },
      {
        name: 'Investigator Talent',
        level: 13,
        description: 'Gain an additional investigator talent.',
      ...
      { name: 'Trap Sense', level: 15, description: 'Trap sense increases to +5.' },
      {
        name: 'Investigator Talent',
        level: 17,
        description: 'Gain an additional investigator talent.',
      },
      { name: 'Trap Sense', level: 18, description: 'Trap sense increases to +6.' },
      {
        name: 'Investigator Talent',
        level: 19,
        description: 'Gain an additional investigator talent.',
  ...
  // ─── SHAMAN (Oracle + Witch) ───────────────────────────────────────────────
  {
    ...
    classFeatures: [
      ...
      { name: 'Hex', level: 4, description: 'The shaman gains an additional hex.' },
      {
      ...
      { name: 'Hex', level: 8, description: 'The shaman gains an additional hex.' },
      { name: 'Hex', level: 10, description: 'The shaman gains an additional hex.' },
      { name: 'Hex', level: 12, description: 'The shaman gains an additional hex.' },
      {
      ...
      { name: 'Hex', level: 16, description: 'The shaman gains an additional hex.' },
      { name: 'Hex', level: 18, description: 'The shaman gains an additional hex.' },
      {
        name: 'Manifestation',
        level: 20,
        description:
      ...
      { name: 'Hex', level: 20, description: 'The shaman gains an additional hex.' },
    ],
    spellcasting: {
      type: 'Divine',
      casting: 'Prepared',
  ...
  // ─── SKALD (Bard + Barbarian) ──────────────────────────────────────────────
  {
    ...
    classFeatures: [
      ...
      { name: 'Rage Power', level: 6, description: 'The skald learns an additional rage power.' },
      {
        name: 'Lore Master',
        level: 7,
        description:
      ...
      { name: 'Rage Power', level: 9, description: 'The skald learns an additional rage power.' },
      {
        name: 'Dirge of Doom',
        level: 10,
        description:
      ...
      { name: 'Spell Kenning', level: 11, description: 'Spell kenning increases to 2/day.' },
      { name: 'Rage Power', level: 12, description: 'The skald learns an additional rage power.' },
      { name: 'Lore Master', level: 13, description: 'Lore master take-20 increases to 2/day.' },
      {
      ...
      { name: 'Damage Reduction', level: 14, description: 'Damage reduction increases to 2/—.' },
      { name: 'Rage Power', level: 15, description: 'The skald learns an additional rage power.' },
      { name: 'Spell Kenning', level: 17, description: 'Spell kenning increases to 3/day.' },
      { name: 'Rage Power', level: 18, description: 'The skald learns an additional rage power.' },
      { name: 'Damage Reduction', level: 19, description: 'Damage reduction increases to 3/—.' },
      { name: 'Lore Master', level: 19, description: 'Lore master take-20 increases to 3/day.' },
      {
        name: 'Master Skald',
        level: 20,
        description:
  ...
  // ─── SLAYER (Ranger + Rogue) ───────────────────────────────────────────────
  {
    ...
    classFeatures: [
      ...
      { name: 'Slayer Talent', level: 4, description: 'Gain an additional slayer talent.' },
      {
        name: 'Studied Target',
        level: 5,
        description:
      ...
      { name: 'Sneak Attack', level: 6, description: 'Sneak attack increases to 2d6.' },
      { name: 'Slayer Talent', level: 6, description: 'Gain an additional slayer talent.' },
      {
        name: 'Stalker',
        level: 7,
        description:
      ...
      { name: 'Slayer Talent', level: 8, description: 'Gain an additional slayer talent.' },
      { name: 'Sneak Attack', level: 9, description: 'Sneak attack increases to 3d6.' },
      {
      ...
      { name: 'Slayer Talent', level: 10, description: 'Gain an additional slayer talent.' },
      {
        name: 'Swift Tracker',
        level: 11,
        description:
      ...
      { name: 'Sneak Attack', level: 12, description: 'Sneak attack increases to 4d6.' },
      { name: 'Slayer Talent', level: 12, description: 'Gain an additional slayer talent.' },
      {
      ...
      { name: 'Slayer Talent', level: 14, description: 'Gain an additional slayer talent.' },
      {
        name: 'Quarry',
        level: 14,
        description:
      ...
      { name: 'Sneak Attack', level: 15, description: 'Sneak attack increases to 5d6.' },
      { name: 'Slayer Talent', level: 16, description: 'Gain an additional slayer talent.' },
      { name: 'Slayer Talent', level: 18, description: 'Gain an additional slayer talent.' },
      { name: 'Sneak Attack', level: 18, description: 'Sneak attack increases to 6d6.' },
      {
      ...
      { name: 'Slayer Talent', level: 20, description: 'Gain an additional slayer talent.' },
    ],
    spellcasting: {
      type: 'None',
      casting: 'None',
  ...
  // ─── SWASHBUCKLER (Fighter + Gunslinger) ───────────────────────────────────
  {
    ...
    classFeatures: [
      ...
      { name: 'Charmed Life', level: 6, description: 'Charmed life increases to 4/day.' },
      {
        name: 'Deeds',
        level: 7,
        description:
      ...
      { name: 'Bonus Feat', level: 8, description: 'Gain a bonus combat feat.' },
      {
        name: 'Swashbuckler Weapon Training',
        level: 9,
        description: 'Weapon training bonus increases to +2.',
      },
      { name: 'Charmed Life', level: 10, description: 'Charmed life increases to 5/day.' },
      {
        name: 'Deeds',
        level: 11,
        description:
      ...
      { name: 'Bonus Feat', level: 12, description: 'Gain a bonus combat feat.' },
      {
        name: 'Swashbuckler Weapon Training',
        level: 13,
        description: 'Weapon training bonus increases to +3.',
      },
      { name: 'Charmed Life', level: 14, description: 'Charmed life increases to 6/day.' },
      {
        name: 'Deeds',
        level: 15,
        description:
      ...
      { name: 'Bonus Feat', level: 16, description: 'Gain a bonus combat feat.' },
      {
        name: 'Swashbuckler Weapon Training',
        level: 17,
        description: 'Weapon training bonus increases to +4.',
      },
      { name: 'Charmed Life', level: 18, description: 'Charmed life increases to 7/day.' },
      {
        name: 'Deeds',
        level: 19,
        description:
      ...
      { name: 'Nimble', level: 19, description: 'Nimble bonus reaches maximum of +5.' },
      { name: 'Bonus Feat', level: 20, description: 'Gain a bonus combat feat.' },
      {
  ...
  // ─── WARPRIEST (Cleric + Fighter) ──────────────────────────────────────────
  {
    ...
    classFeatures: [
      ...
      { name: 'Fervor', level: 5, description: 'Fervor damage/healing increases to 2d6.' },
      { name: 'Bonus Feat', level: 6, description: 'Gain a bonus combat feat.' },
      {
        name: 'Sacred Armor',
        level: 7,
        description:
      ...
      { name: 'Fervor', level: 8, description: 'Fervor damage/healing increases to 3d6.' },
      {
        name: 'Sacred Weapon Enhancement',
        level: 8,
        description: 'Sacred weapon enhancement increases to +2.',
      },
      { name: 'Bonus Feat', level: 9, description: 'Gain a bonus combat feat.' },
      {
        name: 'Blessings',
        level: 10,
        description:
      ...
      { name: 'Sacred Armor', level: 10, description: 'Sacred armor enhancement increases to +2.' },
      { name: 'Fervor', level: 11, description: 'Fervor damage/healing increases to 4d6.' },
      { name: 'Bonus Feat', level: 12, description: 'Gain a bonus combat feat.' },
      {
        name: 'Sacred Weapon Enhancement',
        level: 12,
      ...
      { name: 'Sacred Armor', level: 13, description: 'Sacred armor enhancement increases to +3.' },
      { name: 'Fervor', level: 14, description: 'Fervor damage/healing increases to 5d6.' },
      { name: 'Bonus Feat', level: 15, description: 'Gain a bonus combat feat.' },
      {
        name: 'Sacred Weapon Enhancement',
        level: 16,
        description: 'Sacred weapon enhancement increases to +4.',
      },
      { name: 'Sacred Armor', level: 16, description: 'Sacred armor enhancement increases to +4.' },
      { name: 'Fervor', level: 17, description: 'Fervor damage/healing increases to 6d6.' },
      { name: 'Bonus Feat', level: 18, description: 'Gain a bonus combat feat.' },
      { name: 'Sacred Armor', level: 19, description: 'Sacred armor enhancement increases to +5.' },
      {
        name: 'Sacred Weapon Enhancement',
        level: 20,
        description: 'Sacred weapon enhancement increases to +5.',
      },
      { name: 'Fervor', level: 20, description: 'Fervor damage/healing increases to 7d6.' },
      {
        name: 'Aspect of War',
        level: 20,
        description:
