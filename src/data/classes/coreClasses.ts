...
export const CORE_CLASSES_EXPANDED: ExpandedClassData[] = [
  ...
  },
  {
    ...
    classFeatures: [
      ...
      },
      {
        ...
        level: 6,
        description: 'Wild shape usage increases to 2/day.',
        effects: [],
      },
      {
        name: 'Wild Shape 3/day',
        level: 8,
        description: 'Wild shape usage increases to 3/day.',
        effects: [],
      },
      {
        name: 'Venom Immunity',
      ...
      },
      {
        ...
        level: 10,
        description: 'Wild shape usage increases to 4/day.',
        effects: [],
      },
      {
        name: 'Wild Shape 5/day',
        level: 12,
        description: 'Wild shape usage increases to 5/day.',
        effects: [],
      },
      {
      ...
      },
      {
        ...
        level: 14,
        description: 'Wild shape usage increases to 6/day.',
        effects: [],
      },
      {
        name: 'Timeless Body',
      ...
      },
      {
        ...
        level: 16,
        description: 'Wild shape usage increases to 7/day.',
        effects: [],
      },
      {
        name: 'Wild Shape 8/day',
        level: 18,
        description: 'Wild shape usage increases to 8/day.',
        effects: [],
      },
      {
  ...
  },
  {
    ...
    classFeatures: [
      ...
      { name: 'Bravery +2', level: 6, description: 'Bravery bonus increases to +2.', effects: [] },
      {
        name: 'Bonus Feat',
        level: 6,
        description: 'The fighter gains a bonus combat feat.',
      ...
      },
      {
        ...
        level: 7,
        description: 'Armor training bonus increases by +1.',
        effects: [],
      },
      {
        name: 'Bonus Feat',
      ...
      { name: 'Bravery +3', level: 10, description: 'Bravery bonus increases to +3.', effects: [] },
      {
        name: 'Bonus Feat',
        level: 10,
        description: 'The fighter gains a bonus combat feat.',
      ...
      { name: 'Bravery +4', level: 14, description: 'Bravery bonus increases to +4.', effects: [] },
      {
        name: 'Bonus Feat',
        level: 14,
        description: 'The fighter gains a bonus combat feat.',
      ...
      { name: 'Bravery +5', level: 18, description: 'Bravery bonus increases to +5.', effects: [] },
      {
        name: 'Bonus Feat',
        level: 18,
        description: 'The fighter gains a bonus combat feat.',
  ...
  },
  {
    ...
    classFeatures: [
      ...
      { name: 'Bonus Feat', level: 6, description: 'The monk selects a bonus feat.', effects: [] },
      {
      ...
      {
        name: 'Slow Fall 30 ft.',
        level: 6,
        description: 'Slow fall distance increases to 30 ft.',
        effects: [],
      },
      {
      ...
      {
        name: 'Slow Fall 40 ft.',
        level: 8,
        description: 'Slow fall distance increases to 40 ft.',
        effects: [],
      },
      {
      ...
      { name: 'Bonus Feat', level: 10, description: 'The monk selects a bonus feat.', effects: [] },
      {
        name: 'Ki Pool (lawful)',
        level: 10,
        description:
      ...
      { name: 'Bonus Feat', level: 14, description: 'The monk selects a bonus feat.', effects: [] },
      {
      ...
      { name: 'Bonus Feat', level: 18, description: 'The monk selects a bonus feat.', effects: [] },
      {
  ...
  },
  {
    ...
    classFeatures: [
      ...
      },
      {
        name: 'Mercy',
        level: 6,
        description: 'The paladin selects an additional mercy.',
        effects: [],
      },
      {
  ...
  },
  {
    ...
    classFeatures: [
      ...
      },
      {
        name: 'Bonus Feat',
        level: 10,
        description: 'The wizard gains an additional bonus feat.',
        effects: [],
      },
      {
        name: 'Bonus Feat',
