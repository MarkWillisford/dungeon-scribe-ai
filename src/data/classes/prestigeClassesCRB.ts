...
export const PRESTIGE_CLASSES_CRB: ExpandedClassData[] = [
  ...
  // ────────────────────────────────────────────────────────────────────────────
  {
    ...
    classFeatures: [
      ...
      { name: 'Improved Reaction +4', level: 8, description: 'Initiative bonus increases to +4.' },
      {
        name: 'Deflect Arrows',
        level: 9,
        description:
  ...
  // ────────────────────────────────────────────────────────────────────────────
  {
    ...
    classFeatures: [
      ...
      { name: 'Secret', level: 4, description: 'The loremaster selects an additional secret.' },
      {
        name: 'Greater Lore',
        level: 6,
        description:
      ...
      { name: 'Secret', level: 6, description: 'The loremaster selects an additional secret.' },
      { name: 'Secret', level: 8, description: 'The loremaster selects an additional secret.' },
      {
        name: 'True Lore',
        level: 10,
        description:
      ...
      { name: 'Secret', level: 10, description: 'The loremaster selects an additional secret.' },
      {
        name: 'Spellcasting',
        level: 1,
        description:
