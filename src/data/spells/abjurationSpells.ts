...
export const ABJURATION_SPELLS: SpellDefinition[] = [
  ...
  // ─── batch_gap_A_1 ─────────────────────────────────────────────────────────────
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'flask of holy water worth 25 gp',
      divine: true,
    },
    castingTime: '1 minute',
    range: 'Touch',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'crystalline sphere worth 10 gp',
    },
    castingTime: '1 standard action',
    range: 'Personal',
    target: 'You',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'vial of holy water',
      divine: true,
    },
    castingTime: '1 round',
    range: 'Touch',
  ...
  },
  {
    ...
    components: {
      ...
      material: true,
      materialComponents:
        "rare herbs, incense, and jewels worth 500 gp per the target's character level or HD",
    },
    castingTime: '1 minute',
    range: 'Touch',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      focus: true,
      focusComponents: 'cloak or outer garment',
      material: false,
    },
    castingTime: '1 standard action',
    range: 'Personal',
    ...
    spellResistance: 'No',
    description:
      'An animated cloak or similar garment provides a +2 shield bonus to AC. Each round during your turn, you can use a free action to direct the cloak to aid another action for skill checks, attack rolls, or AC. The cloak uses a bonus equal to your caster level plus your key spellcasting ability modifier.',
  ...
  {
    name: 'Antitech Field',
    classLevels: { druid: 6, sorcerer: 7, wizard: 7 },
    school: 'Abjuration',
    components: {
      verbal: true,
      somatic: true,
      material: true,
      materialComponents: 'pinch of rust',
      divine: true,
    },
    castingTime: '1 standard action',
    range: '10 ft.',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a small drop of antitoxin',
    },
    castingTime: '1 standard action',
    range: 'Touch',
    target: 'Creature touched',
  ...
  },
  {
    ...
    spellResistance: 'Yes',
    description:
      "This spell works similarly to a targeted dispel magic but only affects creatures and requires a melee touch attack. Upon successful touch attack and spell dispel, the removed spell transfers to the caster instead of remaining on the original target. The caster cannot make new saving throws or spell resistance checks and must accept the spell's effects regardless of benefit. The transferred spell's duration remains unchanged.",
    source: 'Pathfinder Roleplaying Game: Ultimate Magic',
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Atonement',
    classLevels: { cleric: 5, oracle: 5, druid: 5, inquisitor: 5 },
    school: 'Abjuration',
    components: {
      verbal: true,
      somatic: true,
      ...
      focus: true,
      focusComponents: 'a set of prayer beads or other prayer device worth at least 500 gp',
      divine: true,
    },
    castingTime: '1 hour',
    range: 'Touch',
  ...
  },
  {
    ...
    spellResistance: 'Yes (harmless)',
    description:
      "This spell enhances a paladin's existing aura of courage ability. While active, all allies within the aura are immune to fear (magical or otherwise). The spell requires the caster to possess the aura of courage class feature to function—without it, the spell has no effect.",
    source: 'Pathfinder Player Companion: Champions of Purity',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'Yes (harmless)',
    description:
      'This spell protects attended items of targeted creatures. It increases the DC for Sleight of Hand checks to remove warded items by 20 and grants affected creatures a +20 bonus to their CMD against disarm and steal combat maneuvers.',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'cold iron nail',
      focus: false,
      divine: false,
    },
    castingTime: '1 standard action',
  ...
  },
  {
    ...
    spellResistance: 'Yes',
    description:
      "This spell enables a caster to transfer one or more paladin or antipaladin auras to another creature. The caster maintains personal aura benefits while the target becomes the aura's center. For example, transferring aura of courage preserves the caster's fear immunity while granting the target a +4 morale bonus on fear saves. Certain auras cannot be transferred, such as those affecting only the caster.",
    source: 'Pathfinder Roleplaying Game: Advanced Class Guide',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'Yes (harmless)',
    description:
      "This spell allows a caster to bestow divine grace on another good creature for a short amount of time, infusing that creature with a portion of holy virtue. Upon touching the recipient, the caster grants a sacred bonus to saving throws equal to the target's Charisma bonus (if any) on all saving throws.",
    source: "Pathfinder Roleplaying Game: Advanced Player's Guide",
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Blade Snare',
    classLevels: { druid: 3, magus: 3, ranger: 3, sorcerer: 3, wizard: 3 },
    school: 'Abjuration',
    components: { verbal: true, somatic: true, material: false, focus: false, divine: false },
    castingTime: '1 standard action',
    range: 'Personal',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a feather or small object symbolizing good fortune',
      focus: false,
      divine: false,
    },
    castingTime: '1 standard action',
    ...
    spellResistance: 'No',
    description:
      'The spell grants the caster a luck bonus to CMD and saving throws against movement-restricting effects equal to +1 per 6 caster levels (minimum +1, maximum +3). The caster can also terminate the spell early to gain a +20 foot enhancement bonus to base speed for 1 round per whole minute of duration remaining.',
  ...
  // ─── batch_gap_B_2 ─────────────────────────────────────────────────────────────
  {
    ...
    spellResistance: 'No',
    description:
      "This protective spell grants immunity to damaging area effects you personally cast. Additionally, you may dismiss the spell as an immediate action if caught in another caster's damaging area spell, gaining immunity to that specific casting.",
    source: 'Pathfinder Roleplaying Game: Advanced Class Guide',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a red bloodstone worth 500 gp',
      focus: false,
      divine: false,
    },
    castingTime: '1 standard action',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a drop of clear oil',
      focus: false,
      divine: true,
    },
    castingTime: '1 standard action',
    ...
    spellResistance: 'Yes (harmless)',
    description:
      'This spell functions similarly to protection from energy but offers protection exclusively against acid and fire damage. Beyond damage protection, the affected item becomes completely waterproof (this protection extends to other liquids as well, such as alcohol and oil).',
    source: 'Pathfinder Chronicles: Seekers of Secrets',
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Bullet Shield',
    classLevels: { alchemist: 2, bloodrager: 2, psychic: 2, sorcerer: 2, wizard: 2 },
    school: 'Abjuration',
    components: {
      verbal: true,
      somatic: true,
      material: true,
      materialComponents: 'a bullet',
      focus: false,
      divine: false,
    },
    castingTime: '1 standard action',
    ...
    spellResistance: 'Yes (harmless)',
    description:
      'The spell grants the warded creature a +4 deflection bonus to AC against firearm and ranged attacks, with an additional +1 to the bonus for every five caster levels (maximum +8 at 20th level).',
    source: 'Pathfinder Roleplaying Game: Ultimate Combat',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    components: {
      ...
      material: false,
      focus: true,
      focusComponents: 'one to four adamantine bullets, each worth 61 gp',
      divine: false,
    },
    castingTime: '1 standard action',
    range: 'Personal',
  ...
  {
    name: 'Calm Air',
    classLevels: { druid: 4, sorcerer: 5, wizard: 5, summoner: 4 },
    school: 'Abjuration',
    descriptor: ['Air'],
    components: { verbal: true, somatic: true, material: false, focus: false, divine: false },
    castingTime: '1 standard action',
    ...
    spellResistance: 'No',
    description:
      "This abjuration disperses fog, dust, and airborne particles while reducing wind strength by one step per four caster levels (minimum light wind). Magical wind/cloud effects are suppressed; suppressing them requires a caster level check (DC 11 + effect's caster level).",
  ...
  },
  {
    ...
    spellResistance: 'Yes',
    description:
      'The caster makes a melee touch attack dealing 2d8 points of damage + 1 point per caster level (maximum +15). The spell disrupts magical control effects by making dispel checks against magic jar, ghost malevolence, and enchantment (compulsion) spells, prioritizing highest-level effects. A successful Will save reduces damage by half.',
    source: "Advanced Player's Guide",
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Caustic Safeguard',
    classLevels: { alchemist: 3, bloodrager: 3, magus: 3, sorcerer: 4, wizard: 4 },
    school: 'Abjuration',
    descriptor: ['Acid'],
    components: {
      verbal: true,
      somatic: true,
      material: true,
      materialComponents: 'a thin metal wire and a vial of acid',
      focus: false,
      divine: false,
    },
    castingTime: '1 round',
    ...
    spellResistance: 'No',
    description:
      'The spell imbues an object with an acidic ward dealing 1d6 acid damage per 2 caster levels (maximum 10d6) to any creature other than the caster who touches it. The caster can designate one creature per 4 caster levels to safely handle the warded object.',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: '2 silver coins',
      focus: false,
      divine: false,
    },
    castingTime: '1 standard action',
    ...
    spellResistance: 'Yes (harmless)',
    description:
      'The spell grants affected targets immunity to the harmful effects of touching or drinking from the River Styx and a +4 profane bonus on saves against memory-altering effects like modify memory or mindwipe.',
    source: 'Book of the Damned',
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Circle of Clarity',
    classLevels: { cleric: 7, oracle: 7, shaman: 8, sorcerer: 7, wizard: 7 },
    school: 'Abjuration',
    components: {
      verbal: true,
      somatic: true,
      material: false,
      focus: true,
      focusComponents: 'crystal lens worth 100 gp',
      divine: false,
    },
    castingTime: '1 standard action',
    range: 'Medium (100 ft. + 10 ft./level)',
    ...
    spellResistance: 'Yes (harmless)',
    description:
      'Creates a magical emanation granting creatures +4 bonus on saves against figments and glamers. Negates non-total concealment and provides a perception bonus equal to half caster level (max +10).',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'clay and iron filings',
      focus: false,
      divine: false,
    },
    castingTime: '1 standard action',
    ...
    spellResistance: 'Yes (harmless)',
    description:
      "The recipient's skin hardens to a clay-like consistency, providing DR 5/adamantine. The protective effect lasts until it has absorbed damage equal to 5 points times the caster's level (maximum total of 50 points).",
  ...
  },
  {
    ...
    spellResistance: 'Yes (harmless)',
    description:
      'The spell creates a protective chaotic aura providing: +4 deflection bonus to AC and +4 resistance bonus on saves; spell resistance 25 against lawful spells; protection from possession and mental influence; and forces lawful melee attackers to make a Will save or become confused for 1 round.',
    source: 'Core Rulebook',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a leaf from a shade tree',
      focus: false,
      divine: false,
    },
    castingTime: '1 standard action',
    ...
    spellResistance: 'Yes (harmless)',
    description:
      'This protective charm reduces environmental sun damage by one severity level and lessens sunlight-related penalties by 1 point. Does not protect against direct sunlight effects on light-sensitive creatures.',
    source: "Advanced Player's Guide",
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Cloak of Winds',
    classLevels: { bloodrager: 3, druid: 3, magus: 3, ranger: 3, sorcerer: 3, wizard: 3 },
    school: 'Abjuration',
    descriptor: ['Air'],
    components: { verbal: true, somatic: true, material: false, focus: false, divine: false },
    castingTime: '1 standard action',
    ...
    spellResistance: 'Yes (harmless)',
    description:
      'The spell envelops a target in whirling wind. Benefits include immunity to being checked or blown away by windstorm-level winds, a -4 penalty to ranged attacks against the subject, and the ability to knock tiny or smaller attackers prone.',
    source: "Advanced Player's Guide",
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'Yes',
    description:
      "Cast immediately before another spell on the same willing creature. Creates a conditional binding tied to the paired spell. If the spell's recipient violates the oath or prohibition while conditional favor remains in effect, the paired spell is undone as if never cast.",
  ...
  // ─── batch_gap_C_2 ─────────────────────────────────────────────────────────────
  {
    ...
    spellResistance: 'Yes (harmless)',
    description:
      'This protective spell reduces damage from alignment-based magical effects by 5 points (increasing to 10 at 7th level, 15 at 11th level). The caster selects one alignment type to protect against.',
    source: 'Bestiary 2',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    components: {
      ...
      material: false,
      focus: true,
      focusComponents: 'a set of scales worth 500 gp',
      divine: false,
    },
    castingTime: '1 standard action',
    range: '20 ft.',
    ...
    spellResistance: 'Yes',
    description:
      'The spell creates an oscillating bronze aura granting targets +4 deflection bonus to AC and +4 resistance bonus on saving throws. It provides spell resistance against neutral-aligned casters and protects from possession. Melee attackers of neutral alignment suffer sickening or nauseating effects.',
    source: 'Planar Adventures',
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Covetous Aura',
    classLevels: { bard: 5, sorcerer: 5, wizard: 5 },
    school: 'Abjuration',
    components: { verbal: true, somatic: true, material: false, focus: false, divine: false },
    castingTime: '1 standard action',
    range: 'Personal',
    ...
    spellResistance: 'No',
    description:
      'The spell creates an aura allowing the caster to immediately gain the benefit of any harmless spell of 3rd level or lower cast within range as if it had also targeted the caster. Once the caster gains a spell benefit, the aura ends.',
  ...
  },
  {
    ...
    spellResistance: 'Yes',
    description:
      'The caster places a personal rune on an object. The mark can be visible or invisible. Creatures other than the caster that touch the warded object and fail a Fortitude save have their skin turn bright red for 1 hour per level. The ward cannot be dispelled but can be removed by the caster or erase.',
    source: 'Advanced Class Guide',
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Curse of Magic Negation',
    classLevels: { cleric: 5, oracle: 5, inquisitor: 4, sorcerer: 4, wizard: 4, witch: 4 },
    school: 'Abjuration',
    descriptor: ['Curse'],
    components: {
      verbal: true,
      somatic: true,
      material: true,
      materialComponents: 'powdered lead and platinum worth 250 gp',
      focus: false,
      divine: false,
    },
    castingTime: '1 round',
    ...
    spellResistance: 'No',
    description:
      "The spell disrupts a target's capacity to utilize magical energies, imposing the negated spellblight condition. Dispel checks attempting to remove this spellblight suffer a -5 penalty.",
    source: 'Ultimate Magic',
    verificationStatus: 'needs_review' as const,
  },
  ...
  // ─── batch_gap_D_1 ─────────────────────────────────────────────────────────────
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a stone that has never seen sunlight',
    },
    castingTime: '1 standard action',
    range: 'Close (25 ft. + 5 ft./2 levels)',
  ...
  },
  {
    ...
    spellResistance: 'Yes (harmless)',
    description:
      'Grants a dodge bonus to AC equal to +1 for each size category by which an attacker exceeds the target, capped at +1 per 3 caster levels. Gnome recipients gain a maximum of +1 per 2 caster levels.',
    source: 'Pathfinder Roleplaying Game',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'Yes (harmless, object)',
    description:
      'Functions similarly to sanctify armor. When the caster uses their judgment or smite ability, they gain DR 5/good while wearing the enchanted armor.',
    source: 'Pathfinder Roleplaying Game',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a piece of rubber dipped in glue',
    },
    castingTime: '1 standard action',
    range: 'Personal',
    target: 'You',
  ...
  // ─── batch_gap_D_2 ─────────────────────────────────────────────────────────────
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'pouch of silvered powder worth 25 gp',
    },
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a piece of wool',
    },
    castingTime: '1 standard action',
    range: 'Personal',
    target: 'You',
    ...
    spellResistance: 'None',
    description:
      "Reduces the detection range of divination effects targeting the caster. When the caster would normally fall within a detection spell's area of effect (such as detect magic, detect evil, or detect undead), the area of effect is reduced by half for the purposes of detecting the caster or caster's possessions. The detecting caster remains unaware of this range reduction.",
    source: 'Pathfinder Roleplaying Game',
    verificationStatus: 'needs_review' as const,
  },
  {
  ...
  },
  {
    ...
    range: 'Touch',
    target:
      'You and a touched, neutral creature from another plane, or you and an enchantment on a touched creature or object',
    duration: '1 round/level or until discharged',
    savingThrow: 'See text',
    spellResistance: 'See text',
    description:
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'tiny silver bell, chime, or gong',
    },
    castingTime: '1 standard action',
    range: 'Touch',
    ...
    spellResistance: 'Yes',
    description:
      'Temporarily negates magical silence within its area so that normal sounds can be heard within the overlapping areas of effect. Automatically counters or dispels any magical silence effect of equal or lower level targeting the same subject. When cast against a higher-level silence effect, it functions as dispel magic.',
    source: 'Pathfinder Roleplaying Game',
    verificationStatus: 'needs_review' as const,
  },
  {
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'turtle shell piece',
    },
    castingTime: '1 standard action',
    range: 'Personal',
    target: 'You',
    ...
    spellResistance: 'None',
    description:
      "Reduces incoming damage from natural attacks. When struck by an opponent's natural attacks, the damage is resolved as if the attack came from a creature one size smaller per 5 caster levels (maximum four size categories smaller at CL 20th). Cannot reduce natural attack base damage below 1d2.",
    source: "Pathfinder Player Companion: Dragonslayer's Handbook",
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'hollow glass ball or dreamcatcher',
    },
    castingTime: '1 standard action',
    range: 'Touch',
    target: 'One creature touched',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'pinch of pumice',
    },
    castingTime: '10 minutes',
    range: 'Touch',
  ...
  },
  {
    ...
    spellResistance: 'Yes',
    description:
      'This protective spell shields your mind from external mental intrusion, specifically blocking divination and enchantment spells targeting thoughts or memories. When another creature attempts a mind-affecting spell against you, that caster must succeed at a caster level check (DC 11 + your caster level) or the spell fails. Non-thought-based detection effects remain unaffected.',
    source: 'Pathfinder Roleplaying Game Occult Adventures',
    verificationStatus: 'needs_review' as const,
  },
  ...
  // ─── batch_gap_E_2 ─────────────────────────────────────────────────────────────
  {
    ...
    spellResistance: 'No',
    description:
      'A magical field appears around you, glowing with a chaotic blast of multicolored hues. The field grants a 20% miss chance against ranged attacks that require attack rolls, functioning like concealment. Distance-based attacks unaffected by concealment mechanics are not impacted.',
    source: 'Pathfinder Roleplaying Game Core Rulebook',
    verificationStatus: 'needs_review' as const,
  },
  {
  ...
  },
  {
    ...
    components: {
      ...
      material: false,
      focus: true,
      focusComponents: 'a short segment of chain',
    },
    castingTime: '1 standard action',
    range: 'Medium (100 ft. + 10 ft./level)',
    ...
    spellResistance: 'No',
    description:
      'This spell functions similarly to alarm but alerts you when creatures exit rather than enter the warded area. You can attune up to one additional creature per caster level, allowing attuned creatures to pass without triggering the alarm. Mental alerts can be sent to all attuned creatures.',
  ...
  },
  {
    ...
    spellResistance: 'No',
    description:
      'This abjuration grants enhanced mobility against larger attackers. When a creature at least one size category larger than you misses with an attack, you can use an immediate action to move up to 5 feet away from that creature. This movement increases by 5 feet for every 5 caster levels. This movement does not provoke attacks of opportunity.',
    source: 'Pathfinder Roleplaying Game Advanced Race Guide',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a miniature broken hourglass',
    },
    castingTime: '1 standard action',
    range: 'Medium (100 ft. + 10 ft./level)',
  ...
  // ─── batch_gap_F_1 ─────────────────────────────────────────────────────────────
  {
    ...
    classLevels: { cleric: 1, oracle: 1, inquisitor: 1, paladin: 1, magus: 1 },
    school: 'abjuration',
    ...
    spellResistance: 'no',
    description:
      'While active, you may reroll one attack roll, combat maneuver check, or skill check before the results are revealed. The second result must be accepted regardless of outcome. The spell concludes once the reroll is used. Only one instance of this spell may affect the caster simultaneously.',
  ...
  },
  {
    ...
    spellResistance: 'no',
    description:
      'Your person and your equipment stay clean and dry. Dust and moisture slough off immediately; even when you are completely soiled, your appearance reverts to a pristine state over the course of 1 minute. You gain a +2 circumstance bonus on Fortitude saving throws against inhaled and ingested diseases.',
    source: "Pathfinder Player Companion: Disciple's Doctrine",
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Fire Trap',
    classLevels: { druid: 2, sorcerer: 4, wizard: 4 },
    school: 'abjuration',
    descriptor: ['fire'],
    components: {
      verbal: true,
  ...
  },
  {
    ...
    components: {
      ...
      somatic: false,
      material: true,
      materialComponents: 'soothing incense worth 400 gp',
    },
    castingTime: '1 hour',
    range: 'personal',
    target: 'you',
  ...
  // ─── batch_gap_F_2 ─────────────────────────────────────────────────────────────
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a pinch of manure',
    },
    castingTime: '1 round',
    range: 'close (25 ft. + 5 ft./2 levels)',
    target:
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a strip of kelp bound to the target',
      divine: true,
    },
    castingTime: '1 standard action',
    range: 'touch',
    ...
    spellResistance: 'yes (harmless)',
    description:
      'This spell grants underwater mobility similar to freedom of movement, allowing normal movement and attacks without typical underwater combat penalties. However, it provides no protection against grapples, paralysis, or movement-impeding magic like solid fog, slow, or web.',
  ...
  },
  {
    ...
    spellResistance: 'yes',
    description:
      "This spell liberates a subject from magical constraints and physical restrictions on movement. The spell removes effects such as binding, entanglement, grappling, imprisonment, maze, paralysis, petrification, pinning, sleep, slow, stunning, temporal stasis, and web. To free a creature from imprisonment or maze specifically, you must know the creature's name and background, and must cast the spell at the location where it was entombed or banished into the maze.",
    source: 'Pathfinder Roleplaying Game Core Rulebook',
    verificationStatus: 'needs_review' as const,
  },
  ...
  {
    name: 'Gird Ally',
    classLevels: { cleric: 2, oracle: 2, druid: 2, sorcerer: 2, wizard: 2, summoner: 2, witch: 2 },
    school: 'abjuration',
    components: { verbal: true, somatic: true, material: false },
    castingTime: '1 standard action',
    range: 'Close (25 ft. + 5 ft./2 levels)',
    target:
      'one summoned creature you control per level, no two of which can be more than 30 ft. apart',
    duration: '1 round/level (D)',
    savingThrow: 'none',
    spellResistance: 'no',
    description:
      'The spell creates a magical protective field around summoned creatures. Targets gain a deflection bonus to AC equal to 1 + 1 for every 6 caster levels (maximum +4 at 18th level). Summoners can also target their eidolon with this spell.',
    source: "Pathfinder Player Companion: Monster Summoner's Handbook",
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Globe of Tranquil Water',
    classLevels: { cleric: 4, oracle: 4, druid: 4, shaman: 4, sorcerer: 5, wizard: 5, witch: 4 },
    school: 'abjuration',
    components: {
      verbal: true,
      somatic: true,
      material: true,
      materialComponents: 'a glass globe',
      divine: true,
    },
    castingTime: '1 standard action',
    range: '20 ft.',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'powdered diamond worth 200 gp',
    },
    castingTime: '10 minutes',
    range: 'touch',
  ...
  // ─── batch_gap_G_2 ─────────────────────────────────────────────────────────────
  {
    ...
    classLevels: { cleric: 6, oracle: 6, inquisitor: 6, 'rune domain': 6 },
    school: 'abjuration',
    components: {
      verbal: true,
      somatic: true,
      material: true,
      materialComponents: 'incense sprinkled with powdered diamond worth at least 400 gp',
    },
    castingTime: '10 minutes',
    range: 'touch',
    target: 'object touched or up to 5 sq. ft. per caster level',
    ...
    spellResistance: 'no (object); yes (see text)',
    description:
      'This spell functions as glyph of warding, except that a blast glyph deals damage up to 10d8 and a spell glyph can store a spell of 6th level or lower.',
    source: 'Pathfinder Roleplaying Game Core Rulebook',
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Grace',
    classLevels: { cleric: 2, oracle: 2, paladin: 1 },
    school: 'abjuration',
    components: { verbal: true, somatic: false, material: false },
    castingTime: '1 swift action',
    range: 'personal',
    ...
    spellResistance: 'none',
    description:
      'Your movement does not provoke attacks of opportunity for the duration of this spell.',
    source: "Pathfinder Roleplaying Game: Advanced Player's Guide",
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    components: {
      ...
      somatic: true,
      focus: true,
      focusComponents: 'an unattended, non-magical object',
      material: false,
    },
    ...
    spellResistance: 'yes',
    description:
      'Creates a protective aura granting human defenders within the area damage reduction 2/magic. The protection persists if creatures leave and reenter the area. The spell suspends if the focus object moves but resumes when replaced.',
  ...
  },
  {
    ...
    spellResistance: 'yes',
    description:
      'This spell functions as guardian monument, lesser, except it grants human defenders within the area damage reduction 4/magic instead of DR 2/magic.',
    source: 'Pathfinder Player Companion: Arcane Anthology',
    verificationStatus: 'needs_review' as const,
  },
  {
  ...
  },
  {
    ...
    spellResistance: 'none',
    description:
      "The caster selects a specific monster type and one of its special attacks previously identified through Knowledge checks or research. This grants a +4 insight bonus on saving throws against that specific attack. Using a trophy from an identical monster variety increases the bonus to +6. The bonus does not extend to saves against other monsters' similar abilities, spell-like abilities, or class or equipment-derived attacks.",
  ...
  },
  {
    ...
    components: {
      ...
      focus: true,
      focusComponents: 'a small silver rod',
    },
  ...
  },
  {
    ...
    spellResistance: 'none',
    description:
      "The caster summons weapons of divine force appearing as their deity's favored weapon. The spell grants additional weapons at higher caster levels: one at 6th, two at 10th, three at 14th, and five maximum at 18th level. Each weapon provides +1 deflection bonus to AC. As a standard action, the caster may throw a weapon at targets within 30 feet, dealing 2d6 points of force damage. Thrown weapons disappear and reduce the deflection bonus by 1 per weapon thrown, ending the spell once all weapons are deployed.",
    source: 'Pathfinder Roleplaying Game',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'no (object) and yes (see text)',
    description:
      "This abjuration functions similarly to the glyph of warding spell, but stores a hex (excluding major or grand hexes) instead of a spell. The triggered hex uses the spell's caster level and DC. If the hex has a target, it targets the intruder. If the hex has an area or amorphous effect, the area or effect is centered on the intruder. A greater version (Level 5 for shaman and witch) allows storage of major hexes and requires powdered diamond worth 400 gp as a material component.",
    source: 'Pathfinder Roleplaying Game',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'yes (harmless)',
    description:
      'The spell grants the target creature a +4 resistance bonus on saving throws against witch hexes.',
    source: 'Pathfinder Roleplaying Game',
    verificationStatus: 'needs_review' as const,
  },
  {
  ...
  },
  {
    ...
    spellResistance: 'yes',
    description:
      'The spell renders warded creatures undetectable to undead through normal and supernatural senses including blindsense, blindsight, scent, and tremorsense. Non-intelligent undead automatically fail to perceive targets. Intelligent undead receive a Will save; if failed, they cannot see the warded creatures. The spell terminates immediately for all recipients if any warded creature channels positive energy, turns/commands undead, touches an undead creature, or attacks anything.',
    source: 'Pathfinder Roleplaying Game Core Rulebook',
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Hold Portal',
    classLevels: { psychic: 1, sorcerer: 1, wizard: 1 },
    school: 'abjuration',
    components: { verbal: true, somatic: false, material: false },
    castingTime: '1 standard action',
    range: 'medium (100 ft. + 10 ft./level)',
  ...
  },
  {
    ...
    spellResistance: 'yes (harmless)',
    description:
      'This divine protection grants warded creatures four distinct benefits: a +4 deflection bonus to AC and +4 resistance bonus on saves against all attacks; spell resistance 25 against evil spells; protection from possession and mental influence; and causes evil melee attackers to become blinded (with a Fortitude save to negate).',
    source: 'Pathfinder Roleplaying Game Core Rulebook',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'no',
    description:
      "This abjuration enables a caster to magically project the defense of your shield to protect another creature at a distance. Using a swift action, the caster designates a target within 30 feet to receive the shield's bonuses to Armor Class. The protection lasts until the caster's next turn, after which it can be redirected. The caster loses shield benefits while projecting protection and cannot use shield special abilities during projection.",
    source: 'Pathfinder Roleplaying Game',
    verificationStatus: 'needs_review' as const,
  },
  ...
  {
    name: 'Homeward Bound',
    classLevels: { cleric: 3, sorcerer: 4, wizard: 4 },
    school: 'abjuration',
    components: { verbal: true, somatic: true, material: false },
    castingTime: '1 minute',
    range: 'touch',
    ...
    spellResistance: 'yes',
    description:
      "This spell operates identically to the dismissal spell but requires the creature's consent to cast. It sends a willing extraplanar being back to its home plane.",
    source: 'Pathfinder Roleplaying Game',
    verificationStatus: 'needs_review' as const,
  },
  {
  ...
  },
  {
    ...
    spellResistance: 'yes',
    description:
      'This spell brands two chosen creatures, restricting their ability to attack each other. Both targets must make Will saves to attempt attacks against one another, including targeted spells. Failed saves prevent the attack and waste the action. Area-of-effect abilities bypass this restriction.',
    source: "Pathfinder Roleplaying Game Advanced Player's Guide",
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a tiny fragment of a mirror',
    },
    castingTime: '1 standard action',
    range: 'personal',
    target: 'you',
  ...
  },
  {
    ...
    spellResistance: 'no',
    description:
      'You create a mental energy barrier granting a +4 shield bonus to AC and reducing damage from mind thrust I and II by half (quarter damage on a successful Will save).',
    source: 'Pathfinder Roleplaying Game Occult Adventures',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'no',
    description:
      'You create a mental energy barrier granting a +6 shield bonus to AC and protecting against mind thrust I, II, and III (half damage, quarter on successful Will save). Can be undercast.',
    source: 'Pathfinder Roleplaying Game Occult Adventures',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'no',
    description:
      'You create a mental energy barrier providing a +8 shield bonus to AC. You are immune to mind thrust I and take half damage from mind thrust II-IV (quarter on successful Will save). Can be undercast.',
    source: 'Pathfinder Roleplaying Game Occult Adventures',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'no',
    description:
      'As mental barrier III with a 25% chance to negate critical hit and sneak attack additional damage (light fortification). You are immune to mind thrust I-II and take half damage from mind thrust III-V (quarter on successful Will save). Can be undercast.',
    source: 'Pathfinder Roleplaying Game Occult Adventures',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'no',
    description:
      'As mental barrier III with a 50% chance to negate critical hit and sneak attack additional damage (moderate fortification). You are immune to mind thrust I-III and take half damage from mind thrust IV-VI (quarter on successful Will save). Can be undercast.',
    source: 'Pathfinder Roleplaying Game Occult Adventures',
    verificationStatus: 'needs_review' as const,
  },
  ...
  // ─── batch_gap_P_2 ─────────────────────────────────────────────────────────────
  {
    ...
    spellResistance: 'no',
    description:
      'You release a powerful vocalization that removes enchantment and paralysis effects. It functions similarly to break enchantment but targets only you and only affects those two effect types. You can use this spell even while paralyzed or unable to speak due to enchantment, with specific limitations regarding silence, gags, or non-magical speech impediments.',
  ...
  // ─── batch_gap_S2_1 ─────────────────────────────────────────────────────────────
  {
    ...
    spellResistance: 'Yes',
    description:
      "Mirrors the effects of shield other but exclusively targets the caster's animal companion or familiar. Permits spellcasters who gain these companions through alternative class features, archetypes, or prestige classes to prepare and cast this spell as a 1st-level option.",
    source: 'd20pfsrd.com',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'Yes',
    description:
      "Creates a magical barrier that protects a target's vital areas, providing a 25% chance to negate critical hits or sneak attacks and convert them to normal damage. The effect does not stack with similar fortification abilities.",
    source: 'd20pfsrd.com',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'Yes',
    description:
      'Allows secure communication between the caster and one target within range, with divination unable to spy on the protected exchange. The spell protects only spoken communication; written words and sign language remain unshielded.',
    source: 'd20pfsrd.com',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'No',
    description:
      "Safeguards a tribal standard or banner so that non-tribal members attempting to attack or touch it must succeed at a Will save or be prevented, functioning similarly to sanctuary for standards. Also increases the banner's hardness by 2 and adds 10 hit points for the duration.",
    source: 'd20pfsrd.com',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'No',
    description:
      'An invisible protective disk grants a +2 shield bonus to AC, negates magic missile attacks, and works against incorporeal touch attacks. The caster may dismiss the shield as a free action, causing it to deal 1d6 electrical damage to all creatures within a 5-foot burst, including the caster.',
    source: 'd20pfsrd.com',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'No',
    description:
      "Strips one ongoing magical effect from a touched creature and claims it as the caster's own. The caster can specify a particular spell effect or target the highest-level spell first. If successful, any remaining duration transfers to the caster, who may attempt a new saving throw if applicable.",
    source: 'd20pfsrd.com',
    verificationStatus: 'needs_review' as const,
  },
  ...
  // ─── batch_gap_S2_2 ─────────────────────────────────────────────────────────────
  {
    ...
    spellResistance: 'No',
    description:
      'Soothes the elemental spirit of a targeted construct, reducing its chance of going berserk by 1d4% per four caster levels (maximum 5d4%). If the construct is already berserk and the caster is its master, grants an immediate roll to end the berserk state and reset the berserk chance to zero.',
    source: 'd20pfsrd.com',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'Yes',
    description:
      'Manifests a whip of bluish-purple magical energy to strip protective enchantments from a target; if the target has harmless spells or effects, it must make a Will save or lose all such protections instantly. If the target lacks beneficial magical effects, it becomes confused for 1d4 rounds instead.',
    source: 'd20pfsrd.com',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'No',
    description:
      'Creates a zone where the caster selects specific spells to suppress (one per five caster levels), functioning like antimagic field but only preventing the selected spells. The effect can negate antimagic field itself; artifacts and deity-cast effects remain unaffected.',
    source: 'd20pfsrd.com',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'Yes',
    description:
      'Generates disruptive magical energy that forces the target to lose prepared spells or spell slots each round, starting with 3rd-level and descending. Spontaneous casters lose 3rd-level slots with the same progression. The target may attempt a Will save each round to end the effect.',
    source: 'd20pfsrd.com',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'No',
    description:
      'Creates a localized area where any spell, spell-like ability, or magic item activation automatically triggers a primal magic event unless the caster succeeds on a concentration check (DC 15 + twice the spell level). The caster gains a +4 insight bonus to concentration checks within their own spellscar.',
    source: 'd20pfsrd.com',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'Yes',
    description:
      'Creates a disruptive magical blast forcing the target to lose a prepared spell or spell slot (starting with 3rd-level and descending). The caster can then cast the stolen spell on their next turn if it appears on their spell list. The spell has no effect on spell-like abilities.',
    source: 'd20pfsrd.com',
    verificationStatus: 'needs_review' as const,
  },
  {
  ...
  // ─── batch_gap_T_1 ─────────────────────────────────────────────────────────────
  {
    ...
    spellResistance: 'yes (harmless)',
    description:
      'Affected creatures must form an unbroken adjacent chain (linear or irregular). Each target gains a +2 deflection bonus to AC while staying within 5 feet of at least one other affected creature. Breaking this proximity ends the spell for that creature only.',
    source: 'Pathfinder Roleplaying Game',
    verificationStatus: 'needs_review' as const,
  },
  {
  ...
  },
  {
    ...
    spellResistance: 'yes (harmless)',
    description:
      "You project mental fortification granting spell resistance equal to 10 + double this spell's level against psychic magic and any mind-affecting effects. Creatures in the area gain protection except against your own spells. This spell can be undercast.",
    source: 'Pathfinder Roleplaying Game Occult Adventures',
    verificationStatus: 'needs_review' as const,
  },
  {
