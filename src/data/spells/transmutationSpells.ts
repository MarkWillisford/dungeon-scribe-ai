...
export const TRANSMUTATION_SPELLS: SpellDefinition[] = [
  // ─── batch_001 ─────────────────────────────────────────────────────────────
  {
  ...
  {
    name: "Aboleth's Lung",
    classLevels: { cleric: 2, druid: 2, sorcerer: 2, wizard: 2, witch: 2 },
    school: 'Transmutation',
    components: {
      verbal: true,
      somatic: true,
      material: true,
      materialComponents: 'piece of seaweed',
      divine: true,
    },
    castingTime: '1 standard action',
    range: 'Touch',
    ...
    spellResistance: 'Yes',
    description:
      'The spell allows touched creatures to breathe water freely, but they lose the ability to breathe air. The caster divides the total duration equally among all touched creatures. The spell has no effect on creatures that already possess water-breathing ability.',
    source: 'Pathfinder Player Companion: Cheliax, Empire of Devils',
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Absorbing Inhalation',
    classLevels: { alchemist: 4, bloodrager: 4, druid: 4, sorcerer: 4, wizard: 4 },
    school: 'Transmutation',
    descriptor: ['air'],
  ...
  },
  {
    ...
    spellResistance: 'Yes (harmless)',
    description:
      'This transmutation spell magically enhances simple food, providing enough nutrition to sustain a Medium or smaller creature for a full day. The spell does not create food itself, so it cannot prevent starvation alone, but it can extend limited food supplies over extended periods.',
    source: 'Pathfinder Player Companion: People of the River',
    verificationStatus: 'needs_review' as const,
  },
  {
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'ginger root shavings',
    },
    castingTime: '1 standard action',
    range: 'Personal',
    target: 'You',
    ...
    spellResistance: 'None',
    description:
      "This spell's energy quickens your steps, allowing fancy footwork. The caster gains a +10-foot enhancement bonus to speed and a +1 dodge bonus to AC. These bonuses don't stack with haste or similar effects. While affected by alacrity, the caster can take 5-foot steps in difficult terrain.",
    source: "Pathfinder Player Companion: Adventurer's Armory 2",
    verificationStatus: 'needs_review' as const,
  },
  {
  ...
  },
  {
    ...
    spellResistance: 'Yes (harmless, object)',
    description:
      'This spell imbues a weapon with chaotic, evil, good, or lawful alignment as the caster chooses. An aligned weapon can bypass damage reduction of creatures with opposing alignments. The spell cannot be cast on natural weapons or on weapons already possessing alignment.',
    source: 'Pathfinder Roleplaying Game: Core Rulebook',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'No',
    description:
      'This spell requires maintaining an active bardic performance. While maintaining that performance, you gain benefits identical to the haste spell. The spell ends if your bardic performance ceases or is interrupted. As an immediate action during bardic performance, you may dismiss allegro to reroll either a Reflex save or Dexterity-based skill check before results are revealed. Allegro dispels and is dispelled by slow.',
    source: 'Pathfinder Roleplaying Game: Ultimate Magic',
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Amplify Stench',
    classLevels: { cleric: 2, druid: 2, oracle: 2, psychic: 2, shaman: 2, sorcerer: 2, wizard: 2 },
    school: 'Transmutation',
    components: { verbal: true, somatic: true, material: false },
    castingTime: '1 standard action',
    range: 'Personal',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a bit of oak root',
    },
    castingTime: '1 standard action',
    range: 'Personal',
    target: 'You',
  ...
  {
    name: 'Angelic Aspect',
    classLevels: { cleric: 5, paladin: 3, sorcerer: 5, wizard: 5 },
    school: 'Transmutation',
    descriptor: ['good'],
    components: { verbal: true, somatic: true, material: false },
    castingTime: '1 standard action',
    ...
    spellResistance: 'No',
    description:
      'This spell provides low-light vision, darkvision 60 feet, acid/cold resistance 10, DR 5/evil, feathered wings with 30-foot flight speed (average maneuverability), and makes natural/wielded weapons count as good-aligned for damage reduction purposes.',
  ...
  {
    name: 'Ape Walk',
    classLevels: { druid: 3, ranger: 2, sorcerer: 3, wizard: 3 },
    school: 'Transmutation',
    components: {
      verbal: true,
      somatic: true,
      material: true,
      materialComponents: 'an ape or monkey paw',
    },
    castingTime: '1 standard action',
    range: 'Touch',
    target: 'Creature touched',
    ...
    spellResistance: 'Yes (harmless)',
    description:
      'The spell grants the subject enhanced climbing abilities matching an ape or monkey, providing a climb speed of 30 feet and a +8 racial bonus on Climb skill checks. The creature must have free hands to climb this way. Additionally, with 10 feet of running space, the subject can long jump up to 10 feet without an Acrobatics check.',
    source: 'Pathfinder Player Companion: Wilderness Origins',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'No',
    description:
      'The spell animates a tree branch to attack foes. Tree size depends on caster level: Huge (CL 10 or lower), Gargantuan (CL 11-15), or Colossal (CL 16+). The branch makes slam attacks using a Strength score of 10 plus caster level, with adjustments based on size. Damage ranges from 2d6 (Huge) to 4d6 (Colossal) plus 1.5x Strength modifier. The caster designates targets and can redirect the tree with a move action. The tree cannot flank or move from its location.',
    source: 'Pathfinder Roleplaying Game: Ultimate Wilderness',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    components: {
      ...
      focus: true,
      focusComponents:
        'an ornate miniature cannon forged with a drop of your blood that costs 5,000 gp',
      material: false,
    },
    castingTime: '1 round',
    range: 'Close (25 ft. + 5 ft./2 levels)',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'blank scroll or spellbook page',
    },
    castingTime: '1 standard action',
    range: 'Close (25 ft. + 5 ft./2 levels)',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      focus: true,
      focusComponents: 'corpse of deceased creature',
      material: false,
    },
    castingTime: '1 minute',
    range: 'Personal',
  ...
  },
  {
    ...
    spellResistance: 'No',
    description:
      'The spell causes a melee weapon to elongate and become whip-like. As part of casting, the caster can attempt a trip combat maneuver against one creature within 20 feet, gaining a +10 bonus on the roll. After the maneuver, the weapon returns to its normal form.',
    source: 'Pathfinder Roleplaying Game: Advanced Class Guide',
    verificationStatus: 'needs_review' as const,
  },
  {
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'handful of snow, earth, or gravel',
      focus: false,
      divine: false,
    },
    castingTime: '1 standard action',
  ...
  },
  {
    ...
    spellResistance: 'Yes (object)',
    description:
      'This transmutation spell imbues a flask (1 pint) of water with positive energy, turning it into holy water.',
    source: 'Pathfinder Roleplaying Game Core Rulebook',
    verificationStatus: 'needs_review' as const,
  },
  {
  ...
  },
  {
    ...
    classLevels: { cleric: 3, oracle: 3, inquisitor: 3, paladin: 3, ranger: 3 },
    school: 'Transmutation',
    components: { verbal: true, somatic: true, material: false, focus: false, divine: false },
    castingTime: '1 round',
    range: 'Close (25 ft. + 5 ft./2 levels)',
  ...
  },
  {
    ...
    spellResistance: 'Yes (harmless)',
    description:
      'The spell grants the target creature slick, clammy skin and regenerative abilities: fast healing 5, fire resistance 20, and a +2 competence bonus to Combat Maneuver Defense.',
    source: "Pathfinder Roleplaying Game: Advanced Player's Guide",
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Blightburn Weapon',
    classLevels: { alchemist: 4, inquisitor: 4, magus: 4, sorcerer: 5, wizard: 5, witch: 5 },
    school: 'Transmutation',
    components: { verbal: true, somatic: true, material: false, focus: false, divine: true },
    castingTime: '1 standard action',
    range: 'Close (25 ft. + 5 ft./2 levels)',
    ...
    spellResistance: 'Yes (object)',
    description:
      'The spell transforms a weapon into pure blightburn material. Affected weapons function normally but inflict 2d6 points of fire damage each round in contact with creatures touched or struck. Additionally, the weapon radiates a 10-foot aura causing blightburn sickness (a disease with DC matching the spell).',
    source: 'Pathfinder Player Companion: Kobolds of Golarion',
    verificationStatus: 'needs_review' as const,
  },
  ...
  // ─── batch_gap_B_2 ─────────────────────────────────────────────────────────────
  {
    ...
    spellResistance: 'Yes (harmless)',
    description:
      "The spell grants the target a 5-foot-radius aura. When creatures within this aura sustain at least 5 points of piercing, slashing, or bleed damage from a single attack, burning blood sprays in a randomly determined adjacent square, dealing 1d6 fire damage to that square's occupant and 1 splash damage to creatures within 5 feet. Only one spray activates per creature per round. Creatures lacking blood are unaffected.",
    source: 'Pathfinder Roleplaying Game: Advanced Race Guide',
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Blood Sentinel',
    classLevels: { alchemist: 3, sorcerer: 3, wizard: 3 },
    school: 'Transmutation',
    components: {
      verbal: true,
      somatic: true,
      material: true,
      materialComponents:
        'a life-sized animal sculpture of a familiar made of clay, cloth, stone, or wood, plus mandrake root worth 25 gp',
      focus: false,
      divine: false,
    },
    castingTime: '1 standard action',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'an iron coil',
      focus: false,
      divine: false,
    },
    castingTime: '1 standard action',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: false,
      material: true,
      materialComponents: 'a jagged shard of bone from a humanoid creature',
      focus: false,
      divine: false,
    },
    castingTime: '1 standard action',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: "a dirty scrap of a good priest's raiment",
      focus: false,
      divine: false,
    },
    castingTime: '1 standard action',
    ...
    spellResistance: 'No',
    description:
      'The caster temporarily gains any stains and gifts that corruption grants to the touched creature while the target retains them. If gifts have limited uses, the caster has none remaining. The caster takes 1d3 Wisdom drain upon casting.',
    source: 'Pathfinder Roleplaying Game: Horror Adventures',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'No',
    description:
      "This extract modifies your magical reserve to alter your next bomb's behavior. You can only maintain one bomb admixture effect at a time; drinking another replaces the previous one. When you throw your next bomb during the extract's duration, choose one target that would normally be hit by the bomb's splash damage — that target is affected as if it suffered a direct hit from the bomb instead.",
  ...
  },
  {
    ...
    spellResistance: 'Yes',
    description:
      "This transmutation curse etches a national, organizational, or order symbol onto the target, inflicting 1 point of damage. The recipient loses the ability to speak and comprehend their racial language and homeland or primary culture's language (if different). The spell never suppresses Common or Undercommon.",
    source: "Pathfinder Roleplaying Game: Adventurer's Guide",
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'Yes',
    description:
      "This curse spell etches a magical brand on the target, inflicting 1d6 points of damage. The primary effect reduces all of the target's movement speeds by half (rounded down to the next 5-foot increment). The brand persists even if concealed by clothing or physically removed.",
    source: "Pathfinder Roleplaying Game: Adventurer's Guide",
    verificationStatus: 'needs_review' as const,
  },
  {
  ...
  },
  {
    ...
    range: 'Close (25 ft. + 5 ft./2 levels)',
    target:
      'One willing creature plus one additional willing creature per 3 levels, no two more than 30 ft. apart',
    duration: '1 hour/level',
    savingThrow: 'None',
    spellResistance: 'No',
    description:
      'This spell grants low-light vision to affected creatures. Those already possessing this ability experience enhanced vision, seeing four times as far in conditions of dim light. Additionally, creatures positioned within 10 feet of spell beneficiaries cannot gain concealment from dim light conditions.',
    source: 'Pathfinder Player Companion: Blood of the Ancients',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'Yes',
    description:
      'The spell grants a creature the ability to trade defensive capability for offensive power. Each round as a swift action, the target can reduce its natural armor bonus to AC and gain an equal enhancement bonus to damage rolls from natural attacks. The maximum reduction/bonus equals 1 point per 3 caster levels (capped at -5/+5 at 15th level). The creature cannot reduce natural armor below 0.',
    source: "Pathfinder Roleplaying Game: Advanced Player's Guide",
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'Yes (object)',
    description:
      "This spell weakens structural integrity by reducing the hardness of any non-magical surface within its area by 2 points per caster level. The caster designates a flat surface as the spell's center, and the hardness reduction persists throughout the spell's duration.",
    source: 'Pathfinder Campaign Setting: Inner Sea Gods',
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Buoyancy',
    classLevels: { bard: 2, psychic: 2, shaman: 2, sorcerer: 2, wizard: 2, witch: 2 },
    school: 'Transmutation',
    components: { verbal: true, somatic: false, material: false, focus: false, divine: false },
    castingTime: '1 immediate action',
    range: 'Close (25 ft. + 5 ft./2 levels)',
    target:
      'One Medium or smaller object or creature per level; no two targets more than 20 ft. apart',
    duration: 'Up to 1 round/level (see text)',
    savingThrow: 'Will negates (harmless) or Will negates (object)',
    spellResistance: 'Yes (object)',
    description:
      'The spell makes affected creatures or objects extremely buoyant — they naturally float on water at least 1 foot deep. Creatures attempting to deliberately submerge must succeed at a DC 20 Swim check each round to remain underwater. The spell ends if the creature or object spends at least 1 round on dry land.',
    source: 'Pathfinder Roleplaying Game: Ultimate Combat',
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Burning Disarm',
    classLevels: { cleric: 1, oracle: 1, druid: 1, sorcerer: 1, wizard: 1 },
    school: 'Transmutation',
    descriptor: ['fire'],
    components: { verbal: true, somatic: true, material: false, focus: false, divine: false },
    castingTime: '1 standard action',
  ...
  },
  {
    ...
    spellResistance: 'No',
    description:
      "The spell allows a caster to draw upon the body's inner reserves of strength. When about to make a d20 roll based on Strength, Dexterity, or Constitution, the caster gains a +8 enhancement bonus to one of those ability scores for that specific roll. However, the caster becomes fatigued for 1 round afterward.",
    source: 'Pathfinder Roleplaying Game: Occult Adventures',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'No',
    description:
      "This spell allows you to plumb the depths of your mind for insight before making a d20 roll based on Intelligence, Wisdom, or Charisma. The caster gains a +8 enhancement bonus to whichever of these three ability scores applies to the roll. The character becomes dazed for 1 round following the spell's use.",
    source: 'Pathfinder Roleplaying Game: Occult Adventures',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'No',
    description:
      "Until the end of your turn, you gain a +20-foot bonus to speed (or +10-foot bonus if wearing Medium or Heavy armor), your movement does not provoke attacks of opportunity, and you can move through larger creatures' spaces but cannot end movement in an occupied space.",
    source: 'Pathfinder Roleplaying Game: Ultimate Combat',
    verificationStatus: 'needs_review' as const,
  },
  ...
  // ─── batch_gap_C_1 ─────────────────────────────────────────────────────────────
  {
    ...
    components: {
      ...
      material: false,
      focus: true,
      focusComponents: 'tiny diamond pick worth 500 gp',
      divine: false,
    },
    castingTime: '1 standard action',
    range: 'Close (25 ft. + 5 ft./2 levels)',
    ...
    spellResistance: 'No',
    description:
      'The spell allows excavation of snow, earth, dust, sand, and loose/packed rocks or ice filling one 5-ft. cube per level. If buried, the caster can create space around themselves and tunnel with remaining cubes. Has no effect on earth creatures or solid rock.',
  ...
  },
  {
    ...
    spellResistance: 'Yes (harmless)',
    description:
      'This spell grants divine protection to a companion creature. The target receives spell resistance against evil casters, a bonus to saving throws, and damage reduction. Affected creatures may develop a celestial appearance.',
  ...
  },
  {
    ...
    spellResistance: 'Yes',
    description:
      "The caster channels divine power to create one of four core ceremonies: funeral, holiday fete, marriage, or naming, plus two domain-based ceremonies. Each grants affected subjects a sacred or profane boon lasting 1 hour per caster level. Only subjects within one alignment step of the caster's deity qualify.",
  ...
  },
  {
    ...
    spellResistance: 'No',
    description:
      'This spell infuses an item with minor psychic energy, allowing detection by detect psychic significance. The caster can imprint ownership history and personal information that can be revealed through object reading or psychometry.',
  ...
  },
  {
    ...
    spellResistance: 'None',
    description:
      "The caster gains a +5 bonus on Bluff, Diplomacy, and Intimidate skill checks when persuading listeners that they face trouble from authorities or legal consequences if they refuse the caster's requests.",
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'miniature hoe',
      focus: false,
      divine: true,
    },
    castingTime: '10 minutes',
    ...
    spellResistance: 'No',
    description:
      'This transmutation spell clears vegetation from a designated area, moving trees and shrubs to create a 20-foot-radius open space. The spell cannot affect plant creatures. Vegetation returns when the duration expires.',
  ...
  },
  {
    ...
    spellResistance: 'Yes (harmless, object)',
    description:
      'The spell transforms coins into projectile weapons with bullet-like velocity (20-foot range increment). Different coin types deal varying damage: copper (1d4), silver (1d6), gold (1d8), platinum (1d10). All gain +1 bonus damage per 2 caster levels (max +10).',
  ...
  },
  {
    ...
    spellResistance: 'Yes',
    description:
      "The spell grants control over plant creatures, allowing them to understand the caster and perceive their actions favorably. Affected plants won't attack the caster. Plants refuse suicidal or obviously harmful commands.",
    source: 'Core Rulebook',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'palm-sized stone',
      focus: false,
      divine: true,
    },
    castingTime: '1 standard action',
    ...
    spellResistance: 'Yes (harmless)',
    description:
      "The spell removes the creature's need to breathe, preventing drowning and immunity to inhaled poisons. While holding its breath, a creature cannot speak or cast spells with a verbal component unless using Silent Spell.",
    source: 'Heroes of the Darklands',
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Condensed Ether',
    classLevels: { psychic: 4, sorcerer: 5, wizard: 5, spiritualist: 3 },
    school: 'Transmutation',
    components: {
      verbal: true,
      somatic: true,
      material: true,
      materialComponents: 'crushed amber',
      focus: false,
      divine: false,
    },
    castingTime: '1 standard action',
    ...
    spellResistance: 'No',
    description:
      'This spell thickens the boundary between the Ethereal and Material Planes, significantly impeding movement through the area. Creatures move at half speed and cannot take 5-foot steps. They suffer -2 AC and Reflex penalties. Ranged attacks are ineffective, and magic rays have a 20% miss chance.',
    source: 'Occult Adventures',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'Yes',
    description:
      "The caster, while affected by a drug, can transfer its effects to others through melee touch attacks. Recipients experience the drug's effects without suffering ability damage or addiction risk. Cannot transmit effects from potions, poisons, elixirs, or mutagens.",
  ...
  // ─── batch_gap_C_2 ─────────────────────────────────────────────────────────────
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a tiny gong',
      focus: false,
      divine: false,
    },
    castingTime: '1 standard action',
    ...
    spellResistance: 'Yes',
    description:
      'Critical threats made by the affected creature automatically fail to confirm. However, guaranteed critical confirmations from class features remain unaffected.',
  ...
  },
  {
    ...
    spellResistance: 'No',
    description:
      "The caster seizes command of a construct from its original master. While concentrating, the caster directs it as though they were its creator. Each round, a Spellcraft check (DC 10 + construct's HD) maintains control. The original creator can attempt to regain control via opposed Spellcraft checks.",
  ...
  },
  {
    ...
    spellResistance: 'No',
    description:
      "The caster can command plant creatures for a short period. Plants understand vocal commands regardless of language and won't attack the caster. Self-destructive commands are ignored.",
    source: 'Core Rulebook',
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Control Vermin',
    classLevels: { cleric: 3, druid: 2, ranger: 4, sorcerer: 3, wizard: 3, witch: 2 },
    school: 'Transmutation',
    components: { verbal: true, somatic: true, material: false, focus: false, divine: true },
    castingTime: '1 standard action',
    range: 'Close (25 ft. + 5 ft./2 levels)',
    ...
    spellResistance: 'No',
    description:
      'The caster and designated allies can use Handle Animal and Ride checks to influence targeted vermin as if they were animals with animal-level intelligence.',
  ...
  },
  {
    ...
    spellResistance: 'None',
    description:
      'This spell operates similarly to whispering wind but enables two-way communication. After delivering an initial message, it waits for 1 round, copies what it hears, and returns at the same speed. The wind continues this pattern until the duration expires or dismissal occurs.',
  ...
  },
  {
    ...
    spellResistance: 'Yes (harmless)',
    description:
      'The target sprouts extra eyes across its body, gaining all-around vision and immunity to flanking.',
    source: 'Ultimate Magic',
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Create Holds',
    classLevels: { druid: 4, ranger: 3, sorcerer: 4, wizard: 4 },
    school: 'Transmutation',
    components: {
      verbal: true,
      somatic: true,
      material: true,
      materialComponents: 'handful of pebbles',
      focus: false,
      divine: false,
    },
    castingTime: '1 standard action',
    ...
    spellResistance: 'No',
    description:
      'The spell creates a path of graspable handholds on earthen, plaster, stone, or wooden walls. Handholds appear in pairs approximately 3 feet apart, 10 inches long and protruding about 6 inches. The path can extend up to 30 feet plus 10 additional feet per 3 caster levels (maximum 90 feet).',
    source: "Dungeoneer's Handbook",
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Crimson Breath',
    classLevels: { alchemist: 4, cleric: 4, druid: 4, sorcerer: 4, wizard: 4, witch: 4 },
    school: 'Transmutation',
    components: { verbal: false, somatic: true, material: false, focus: false, divine: false },
    castingTime: '1 standard action',
    range: 'Close (25 ft. + 5 ft./2 levels)',
    ...
    spellResistance: 'No',
    description:
      'The caster\'s salivary glands transform to fill with potent venom. A ranged touch attack delivers a dose of "breath of the mantis god" poison. The Fortitude save DC matches the spell\'s DC.',
    source: "Adventurer's Guide",
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'dried blood from an evil outsider, sprinkled on the weapon',
      focus: false,
      divine: false,
    },
    castingTime: '1 standard action',
    ...
    spellResistance: 'No',
    description:
      'This enchantment imbues a melee weapon with holy energy, granting it the bane quality against evil outsiders. Upon scoring a critical hit against such creatures, the caster deals normal critical damage and nauseates the target for 1d3 rounds (reducible to sickened via Fortitude save).',
    source: 'Inner Sea Magic',
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Curse of Burning Sleep',
    classLevels: { shaman: 4, sorcerer: 4, wizard: 4, witch: 4 },
    school: 'Transmutation',
    descriptor: ['Curse', 'Fire'],
    components: {
      verbal: true,
      somatic: true,
      material: true,
      materialComponents: 'a feather and a drop of oil',
      focus: false,
      divine: false,
    },
    castingTime: '1 standard action',
    ...
    spellResistance: 'Yes',
    description:
      'A curse activates one hour after the creature next falls asleep, causing it to burst into flame and take 1d6 fire damage per 2 caster levels (maximum 8d6), then catch fire dealing 2d6 fire damage per round until extinguished.',
    source: 'Advanced Class Guide',
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Curse of Fell Seasons',
    classLevels: { druid: 9, shaman: 9, sorcerer: 9, wizard: 9, witch: 9 },
    school: 'Transmutation',
    ...
    components: {
      ...
      material: false,
      focus: true,
      focusComponents: 'darkwood carving of a tree worth 15,000 gp',
      divine: false,
    },
    castingTime: '10 minutes',
    range: 'Touch',
    ...
    spellResistance: 'No',
    description:
      'The caster touches the ground to drastically alter regional weather patterns through an unseasonable weather curse. The focus becomes integrated into the cursed area and remains retrievable only if the curse is lifted.',
  ...
  },
  {
    ...
    spellResistance: 'Yes',
    description:
      "Causes the caster's hand to crackle with electricity to destroy a single robot within range via ranged touch attack. On a failed save: 12d6 points of damage plus 1 point per caster level. On a successful save: 3d6 points of damage plus 1 point per caster level. Cyborgs and androids take half damage and gain a +4 bonus on their saving throw.",
  ...
  },
  {
    ...
    components: {
      ...
      material: true,
      divine: true,
      materialComponents: 'coarse sand pinch',
    },
    castingTime: '1 standard action',
    range: 'Medium (100 ft. + 10 ft./level)',
    target: 'One creature',
    ...
    spellResistance: 'Yes',
    description:
      "Weakens a target creature's resistance to one selected energy type: acid, cold, electricity, fire, or sonic. The creature's resistance decreases by 5 (minimum 0), with an additional 5-point reduction for every 5 caster levels beyond 3rd (maximum reduction of 20 at caster level 18).",
    source: 'Pathfinder Roleplaying Game',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'Yes (harmless, object)',
    description:
      "Renders a melee weapon particularly effective against undead. Any undead creature with HD equal to or less than the caster's level must succeed on a Will save or be destroyed utterly if struck in combat with this weapon. The destruction effect bypasses normal spell resistance.",
    source: 'Pathfinder Roleplaying Game Core Rulebook',
    verificationStatus: 'needs_review' as const,
  },
  {
  ...
  },
  {
    ...
    spellResistance: 'None',
    description:
      'The caster selects one creature within 60 feet previously damaged. If that target possesses a burrow, climb, fly, or swim speed, the caster gains that movement type at the same speed and maneuverability. When gaining burrow or swim speed, the caster can breathe normally while using these forms of movement.',
    source: 'Pathfinder Roleplaying Game',
    verificationStatus: 'needs_review' as const,
  },
  ...
  // ─── batch_gap_F_1 ─────────────────────────────────────────────────────────────
  {
    ...
    spellResistance: 'no',
    description:
      'You change outfits or create a disguise out of materials you are wearing or carrying, using styling, makeup, piercings, and similar superficial modifications. The spell cannot alter your body or change object structures but produces an immediate non-magical disguise. Effectiveness depends on a Disguise skill check.',
    source: 'Pathfinder Roleplaying Game Ultimate Intrigue',
    verificationStatus: 'needs_review' as const,
  },
  {
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a folded-paper mask',
    },
    castingTime: '1 standard action',
    range: 'personal',
    target: 'you',
    ...
    spellResistance: 'no',
    description:
      'This spell alters details of your appearance so that you are no longer recognizable as yourself. The new appearance must remain within normal parameters for your race, ethnicity, and gender. While you cannot control specific appearance details, you may choose to recreate a previously-used appearance, enabling you to maintain established identities across castings.',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a drow eyelash',
    },
    castingTime: '1 standard action',
    range: 'medium (100 ft. + 10 ft./level)',
    ...
    spellResistance: 'yes',
    description:
      'Affected creatures gain light blindness. When exposed to bright light, affected targets are blinded for 1 full round and are dazzled in successive rounds. If cast in bright light, targets become immediately blinded and dazzled starting at their next turn.',
    source: 'Pathfinder Player Companion: Blood of Shadows',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'yes',
    description:
      "This curse inflicts unrelenting hunger on the victim. Upon failing their save, the target begins starving and the spell deals nonlethal damage limited to the target's current hit points. Food provides no relief — eating actually nauseates the creature for 1 round unless they succeed at a DC 12 Fortitude save, though consumables retain their other effects (poisons, potions, etc.). The curse responds to break enchantment, limited wish, miracle, remove curse, or wish spells.",
    source: "Pathfinder Roleplaying Game Advanced Player's Guide",
    verificationStatus: 'needs_review' as const,
  },
  {
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: "a pinch of powdered fool's gold",
    },
    castingTime: '1 standard action',
    range: 'close (25 ft. + 5 ft./2 levels)',
    target: '1 firearm',
  ...
  // ─── batch_gap_G_1 ─────────────────────────────────────────────────────────────
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a branding iron and a strip of white silk worth 10 gp',
    },
    castingTime: '10 minutes',
    range: 'touch',
    target:
      'one willing creature and one object touched; object up to 2 cubic feet per caster level, at least one size category smaller than target creature',
    duration: '1 day/level (D)',
    savingThrow: 'none',
    spellResistance: 'no',
    description:
      "The spell transforms an object into shadowy, intangible matter and links it to the target's body via a brand. The object merges with the target's flesh and can be retrieved or reabsorbed as a full-round action. When wielded, the item becomes solid and functions normally but cannot be removed, disarmed, or stolen except through the full-round action. If dispelled while inside the body, the object bursts out dealing 3d6 piercing and slashing damage (bypassing damage reduction) plus 1d6 bleed damage.",
    source: 'Pathfinder Roleplaying Game Ultimate Intrigue',
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Ghostbane Dirge',
    classLevels: { bard: 2, cleric: 2, oracle: 2, inquisitor: 2, paladin: 1, shaman: 2 },
    school: 'transmutation',
    components: {
      verbal: true,
      somatic: true,
      material: true,
      materialComponents: 'an old reed from a wind instrument',
      divine: true,
    },
    castingTime: '1 standard action',
    range: 'Close (25 ft. + 5 ft./2 levels)',
  ...
  },
  {
    ...
    classLevels: { bard: 4, cleric: 5, oracle: 5, inquisitor: 5, paladin: 3, shaman: 5 },
    school: 'transmutation',
    components: {
      verbal: true,
      somatic: true,
  ...
  {
    name: 'Golden Guise',
    classLevels: { bard: 2, sorcerer: 3, wizard: 3, witch: 3 },
    school: 'transmutation',
    components: {
      verbal: true,
      somatic: true,
      material: true,
      materialComponents: '10 gold pieces',
    },
    castingTime: '1 standard action',
    range: 'Close (25 ft. + 5 ft./2 levels)',
  ...
  },
  {
    ...
    spellResistance: 'yes',
    description:
      'The spell enchants freshly picked berries to provide nutritional sustenance equivalent to a meal for a Medium creature. Each berry heals 1 point of damage when consumed, with a maximum cumulative healing of 8 points per 24-hour period. Druids of 3rd level or higher can identify affected berries.',
    source: 'Pathfinder Roleplaying Game Core Rulebook',
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Grappling Scarf',
    classLevels: { bard: 1, inquisitor: 1, occultist: 1, skald: 1, sorcerer: 1, wizard: 1 },
    school: 'transmutation',
    components: {
      verbal: true,
      somatic: true,
      focus: true,
      focusComponents: 'a scarf',
      material: false,
    },
    castingTime: '1 standard action',
    range: 'personal',
    ...
    spellResistance: 'no',
    description:
      "A worn scarf frays into hook-like shapes and extends up to 100 feet, functioning as a grappling hook with a 20-foot range increment. The scarf becomes as strong and easy to climb as a knotted silk rope despite retaining its weight. Upon the spell duration's end, it returns to its normal form.",
    source: "Pathfinder Player Companion: Adventurer's Armory 2",
    verificationStatus: 'needs_review' as const,
  },
  {
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a small lead weight',
    },
    castingTime: '1 standard action',
    range: 'Medium (100 ft. + 10 ft./level)',
    target: 'one creature',
  ...
  {
    name: 'Hellmouth Lash',
    classLevels: { bloodrager: 4, sorcerer: 4, wizard: 4, witch: 4 },
    school: 'transmutation',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a drop of ink',
    },
    castingTime: '1 round',
    range: 'personal',
    target: 'you',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a cipher written on parchment',
      divine: true,
    },
    castingTime: '1 standard action',
    range: 'close (25 ft. + 5 ft./2 levels)',
    ...
    spellResistance: 'yes',
    description:
      "This transmutation spell enhances subjects' ability to communicate covertly. All affected creatures gain a +10 competence bonus on Bluff checks to send secret messages. Conversely, creatures attempting to intercept these messages via opposed Sense Motive checks suffer a -5 penalty. All spell subjects must share a common language to exchange hidden messages successfully.",
    source: 'Pathfinder Roleplaying Game',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    components: {
      ...
      material: false,
      focus: true,
      focusComponents: 'Y-shaped wooden rod',
    },
    castingTime: '1 hour',
    range: 'touch',
    ...
    spellResistance: 'no',
    description:
      'The caster meditates for one hour while holding the Y-shaped rod, walking through natural areas to locate moisture. Upon completion, the rod is thrust into the ground, causing fresh, clean water to trickle forth at a rate of 1 gallon every 10 minutes. The spell cannot be cast indoors, in worked stone, or within 1 mile of an existing hidden spring, though underground casting is permitted.',
    source: 'Pathfinder Roleplaying Game',
    verificationStatus: 'needs_review' as const,
  },
  {
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a flask of holy water or 5 pounds of powdered silver worth 25 gp',
    },
    castingTime: '1 standard action',
    range: 'medium (100 ft. + 10 ft./level)',
  ...
  {
    name: 'Hungry Earth',
    classLevels: { druid: 5, sorcerer: 5, wizard: 5, witch: 5 },
    school: 'transmutation',
    components: { verbal: true, somatic: true, material: false },
    castingTime: '1 standard action',
    range: 'medium (100 ft. + 10 ft./level)',
  ...
  },
  {
    ...
    classLevels: { bloodrager: 2, druid: 3, magus: 3, sorcerer: 3, wizard: 3 },
    school: 'transmutation',
    descriptor: ['air'],
    components: {
      verbal: true,
  ...
  // ─── batch_gap_M_1 ─────────────────────────────────────────────────────────────
  {
    ...
    spellResistance: 'no',
    description:
      "You point your finger at an object and can lift it and move it at will from a distance. As a move action, you can propel the object as far as 15 feet in any direction, though the spell ends if the distance between you and the object exceeds the spell's range.",
    source: 'Pathfinder Roleplaying Game Core Rulebook',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'yes',
    description:
      'You project your consciousness into an object within range that resembles you, functioning like enter image. Beyond observation and manipulation, you can interact socially with nearby creatures and leverage your normal interpersonal abilities. You gain a +5 bonus on Bluff checks and Diplomacy checks to make requests, and a +2 bonus on Intimidate checks, with size-based modifiers applied accordingly.',
    source: 'Pathfinder Roleplaying Game Ultimate Intrigue',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'yes (harmless)',
    description:
      'You create golden animal-shaped masks around the faces of the targets, granting each recipient one animal special ability from beast shape I. You may select different abilities for each target.',
    source: 'Pathfinder Campaign Setting: Inner Sea Races',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a drop of your blood',
    },
    castingTime: '1 standard action',
    range: 'touch',
    target: 'one weapon touched',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'powdered skymetal worth 10,000 gp',
    },
    castingTime: '1 standard action',
    range: 'touch',
  ...
  },
  {
    ...
    components: {
      ...
      material: false,
      focus: true,
      focusComponents: 'a piece of copper wire',
    },
    castingTime: '1 standard action',
    range: 'medium (100 ft. + 10 ft./level)',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'contact or inhaled poison worth 100 gp (for poisonous variant)',
    },
    castingTime: '1 standard action',
    range: 'personal',
    target: 'you',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a shard of mirror',
    },
    castingTime: '1 standard action',
    range: 'personal',
    target: 'you',
    ...
    spellResistance: 'none',
    description:
      "Your next melee attack splits to target two adjacent opponents. You compare your attack roll against both opponents' AC values. Damage is split equally if both are hit or full damage if only one is hit. A +2 bonus applies if the targets are flanking you.",
    source: 'Pathfinder Roleplaying Game Ultimate Combat',
    verificationStatus: 'needs_review' as const,
  },
  ...
  // ─── batch_gap_P_1 ─────────────────────────────────────────────────────────────
  {
    ...
    classLevels: { cleric: 7, occultist: 5, psychic: 7, sorcerer: 7, wizard: 7, witch: 7 },
    school: 'transmutation',
    components: {
      verbal: true,
      somatic: true,
      material: true,
      materialComponents: 'a pinch of fine sand',
      focus: false,
      divine: false,
    },
    castingTime: '1 standard action',
    ...
    spellResistance: 'no',
    description:
      'Affected creatures appear normal but become particle-based, gaining fast healing 1 and immunity to bleed damage and precision damage effects. Fast healing increases at caster levels 10, 15, and 20. Targets may end the effect as a swift action to regain 5d6 hit points and make additional saving throws against disease or poison.',
    source: 'Occult Adventures',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'yes (harmless)',
    description:
      'Affected subjects leave no footprints or scent trail while moving, making non-magical tracking impossible.',
    source: 'Core Rulebook',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'no',
    description:
      "You and one animal companion gain darkvision to 100 feet, tremorsense to 20 feet, and a 40-foot enhancement bonus to movement speed. You can track at full speed without penalty, or gain +4 to Survival checks if you already possess this ability. The spell's effects immediately cease if you or your animal companion attack or are attacked by another creature.",
  ...
  // ─── batch_gap_P_2 ─────────────────────────────────────────────────────────────
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: "a scrap of a knight's banner",
      focus: false,
      divine: false,
    },
    castingTime: '1 standard action',
  ...
  },
  {
    ...
    description:
      "The spell converts an egg's contents into small centipede poison (injury, DC 11, frequency 1/round for 4 rounds, effect 1 Dexterity damage, cure 1 save). At duration's end, the poison reverts to harmless egg substance. The egg must be whole and unbroken (raw or cooked). When applied to weapons, you have no chance of self-poisoning.",
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a dose of poison',
      focus: false,
      divine: false,
    },
    castingTime: '1 standard action',
    ...
    spellResistance: 'no',
    description:
      "You ingest one poison without harm, then regurgitate a different poison of your choice into a container. A Craft (alchemy) check is required against the new poison's DC. Success creates the desired poison; failure results in an inert substance. Rolling a natural 1 exposes you to the original poison (unless protected by venom immunity). The new poison's cost cannot exceed the original poison's cost.",
  ...
  {
    name: 'Raging Rubble',
    classLevels: { bard: 3, bloodrager: 3, cleric: 3, druid: 3, sorcerer: 3, wizard: 3, witch: 3 },
    school: 'transmutation',
    descriptor: ['earth'],
    components: { verbal: true, somatic: true, material: false, divine: true },
    castingTime: '1 round',
    ...
    spellResistance: 'yes',
    description:
      'You animate rubble, gravel, or small stones into a dangerous swarm occupying a 10-foot space. The animated debris deals 1d6 hit points damage and causes distraction (DC 12) to creatures within it. As a move action, you direct the rubble to move up to 10 feet per round. When attacked, it functions as a Medium animated object using the young creature simple template with swarm subtype.',
    source: 'Pathfinder Roleplaying Game',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'hoof shavings from a mule',
    },
    castingTime: '1 standard action',
    range: 'close (25 ft. + 5 ft./2 levels)',
    target: '1 firearm',
    ...
    spellResistance: 'yes (object)',
    description:
      'The spell causes a targeted firearm to discharge spontaneously with extreme recoil. The wielder or carrier must make effort to maintain grip, becoming flat-footed until their next turn begins. If already flat-footed, they are instead knocked prone. Any loaded ammunition discharges and is wasted.',
    source: 'Pathfinder Roleplaying Game',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: '1 ounce of blood',
    },
    castingTime: '1 standard action',
    range: 'touch',
    ...
    spellResistance: 'yes (harmless, object)',
    description:
      'You infuse a hat with blood, granting its wearer a +2 bonus on damage rolls. Additionally, the wearer regains 1d4 hit points whenever they deliver the killing blow to a living creature while wearing the enchanted hat.',
    source: 'Pathfinder Player Companion: Heroes from the Fringe (2018)',
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Renovation',
    classLevels: { bard: 5, sorcerer: 4, wizard: 4 },
    school: 'transmutation',
    components: {
      verbal: true,
      somatic: true,
      material: true,
      materialComponents: 'silver dust worth 1,000 gp',
    },
    castingTime: '8 hours',
    range: 'touch',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'mustard seed',
      divine: true,
    },
    castingTime: '1 standard action',
    range: 'touch',
    ...
    spellResistance: 'yes (harmless)',
    description:
      'The target creature secretes a foul liquid that makes it repugnant to most living creatures. When struck by bite attacks or swallow whole abilities, attackers must succeed at a Fortitude save or become nauseated until the end of their next turn. Subsequent failed saves against the same spell inflict the sickened condition instead.',
    source: "Pathfinder Player Companion: Monster Hunter's Handbook (2017)",
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Resist Starvation',
    classLevels: { antipaladin: 1, cleric: 1, oracle: 1, shaman: 1, warpriest: 1 },
    school: 'transmutation',
    components: {
      verbal: true,
      somatic: true,
      material: true,
      materialComponents: 'crumb of food',
    },
    castingTime: '1 standard action',
    range: 'touch',
    ...
    spellResistance: 'yes (harmless)',
    description:
      "The spell prevents the starvation DC penalty from increasing if the target refrains from eating on the day of casting. However, it only functions if the target hasn't already attempted at least one Constitution check to avoid starvation.",
    source: 'Pathfinder Roleplaying Game',
    verificationStatus: 'needs_review' as const,
  },
  {
  ...
  },
  {
    ...
    components: {
      ...
      material: false,
      focus: true,
      focusComponents: 'bell, chimes, gong, or cymbals',
    },
    castingTime: '1 standard action',
    range: '30 feet',
  ...
  // ─── batch_gap_R_2 ─────────────────────────────────────────────────────────────
  {
    ...
    components: {
      ...
      material: false,
      focus: true,
      focusComponents: 'one suit of armor',
    },
    castingTime: '1 standard action',
    range: 'close (25 ft. + 5 ft./2 levels)',
  ...
  },
  {
    ...
    spellResistance: 'yes (harmless)',
    description:
      'The spell grants the target the ability to breathe water and a swim speed of 30 feet. The recipient gains a +8 bonus on swimming checks and may take 10 on Swim checks even while distracted or endangered. The target can use the run action while swimming in straight lines. Notably, the spell does not make the target unable to breathe air, maintaining dual respiratory capability.',
    source: 'Pathfinder Roleplaying Game',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a knucklebone',
      divine: true,
    },
    castingTime: '1 standard action',
    range: 'medium (100 ft. + 10 ft./level)',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a hardened piece of tree sap',
    },
    castingTime: '1 standard action',
    range: 'close (25 ft. + 5 ft./2 levels)',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a pinch of hops',
    },
    castingTime: '1 round',
    range: 'close (25 ft. + 5 ft./2 levels)',
  ...
  },
  {
    ...
    spellResistance: 'no',
    description:
      "You inscribe an angular rune on a weapon's surface to enhance its durability. A weapon that bears this rune multiplies its hit points by 2, as if it were one size category larger than it actually is. Multiple runes of this type on the same weapon provide no additional benefit.",
    source: 'Pathfinder Companion: Dwarves of Golarion (2009)',
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Rune of Ruin',
    classLevels: { alchemist: 4, bard: 4, inquisitor: 4, sorcerer: 5, wizard: 5, witch: 5 },
    school: 'transmutation',
    descriptor: ['curse'],
    components: {
      verbal: true,
      somatic: true,
      material: true,
      materialComponents: 'self-portrait on thin paper',
    },
    castingTime: '1 standard action',
    range: 'medium (100 ft. + 10 ft./level)',
    target: '1 object',
  ...
  },
  {
    ...
    spellResistance: 'No',
    description:
      'Transforms a wielded shield into orbiting shards (2 plus 1 per 2 caster levels, max 12) that can be directed to attack adjacent foes as a move action. The shards deal slashing and piercing damage and are treated as magic weapons; they reform into the original shield when the spell ends.',
    source: 'd20pfsrd.com',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'No',
    description:
      'Manifests five flaming wings providing a fly speed of 50 feet with average maneuverability. Each time the caster sustains fire damage, one wing disappears and grants fire resistance 30 for the remainder of that round. When reduced to a single wing, maneuverability becomes poor; losing the final wing grants complete fire immunity for an additional minute.',
    source: 'd20pfsrd.com',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'No',
    description:
      'Functions similarly to entangle but enhances plants with an irritating sap. Creatures entering the affected area or ending their turn there must make a Fortitude save or become sickened for the duration and an additional 1d4 rounds afterward, classified as a poison effect.',
    source: 'd20pfsrd.com',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'No',
    description:
      'Functions similarly to the message spell but transmits only that the caster is a worshiper of a designated deity. The spell conveys meaning nonverbally and bypasses language barriers.',
    source: 'd20pfsrd.com',
    verificationStatus: 'needs_review' as const,
  },
  {
  ...
  // ─── batch_gap_S2_2 ─────────────────────────────────────────────────────────────
  {
    ...
    spellResistance: 'Yes',
    description:
      'Produces decorative fireworks shaped like dragons; each round the caster designates a 5-foot square within range and launches a pyrotechnic that deals 1d4 fire damage and inflicts the dazzled condition on creatures in the target square (Reflex save for half damage and negation of dazzled).',
    source: 'd20pfsrd.com',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'No',
    description:
      'Transforms a flexible cord into a magical trap that blends seamlessly into surroundings, either lifting a creature upward (dealing 1d6 damage) or entangling it when triggered. Escape requires a DC 23 Escape Artist or Strength check as a full-round action; the snare has AC 7 and 5 hit points.',
    source: 'd20pfsrd.com',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'No',
    description:
      'Enables the caster to deliver a single dose of potable liquid from their possession into a willing touched recipient as a standard action. Functions with beneficial liquids including alcoholic beverages, potions, and elixirs, but excludes harmful substances like poisons.',
    source: 'd20pfsrd.com',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    spellResistance: 'No',
    description:
      "Creates a magical aura around a weapon so that the first time each round it damages a creature with spell resistance, that creature's spell resistance is reduced by 5 for 1 round. Multiple hits don't stack the reduction within the same round.",
    source: 'd20pfsrd.com',
    verificationStatus: 'needs_review' as const,
  },
  ...
  // ─── batch_gap_T_1 ─────────────────────────────────────────────────────────────
  {
    ...
    components: {
      ...
      focus: true,
      focusComponents:
        'gold and sapphire ring worth 500 gp, which caster must wear for spell duration',
    },
    castingTime: '1 standard action',
    range: 'personal',
    target: 'you',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a tiny ball of bitumen',
    },
    castingTime: '1 standard action',
    range: 'close (25 ft. + 5 ft./2 levels)',
  ...
  },
  {
    ...
    components: {
      ...
      material: true,
      divine: true,
      materialComponents: 'hardened tar ball',
    },
    castingTime: '1 standard action',
    range: 'close (25 ft. + 5 ft./2 levels)',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a potion to be tattooed and special inks worth 500 gp',
    },
    castingTime: '1 minute',
    range: 'touch',
  ...
  },
  {
    ...
    components: {
      ...
      material: false,
      focus: true,
      focusComponents: 'miniature of the target siege engine, 10 gp',
    },
    castingTime: '1 minute',
    range: 'close (25 ft. + 5 ft./2 levels)',
  ...
  },
  {
    ...
    classLevels: { magus: 4, psychic: 3, sorcerer: 4, wizard: 4, spiritualist: 4 },
    school: 'transmutation',
    components: { verbal: true, somatic: true, material: false },
    castingTime: '1 standard action',
    range: 'close (25 ft. + 5 ft./2 levels)',
    ...
    spellResistance: 'yes',
    description:
      'This spell operates similarly to telekinesis but with limited application. It enables you to perform specific combat maneuvers through telekinetic force, including bull rush, disarm, drag, grapple (with pinning), reposition, steal, and trip actions against a target creature.',
    source: 'Pathfinder Roleplaying Game',
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Telekinetic Volley',
    classLevels: { magus: 2, sorcerer: 2, wizard: 2 },
    school: 'transmutation',
    components: { verbal: true, somatic: true, material: false },
    castingTime: '1 standard action',
    range: 'touch',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'powdered diamond, emerald, ruby, and sapphire dust worth 5,000 gp',
    },
    castingTime: '1 standard action',
    range: 'touch',
    target: 'creature touched',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'shavings from a holy symbol',
    },
    castingTime: '1 standard action',
    range: 'personal',
    target: 'you',
  ...
  },
  {
    ...
    spellResistance: 'no',
    description:
      'This spell operates identically to entangle, except the plants actively drain vitality from targets. Any creature that fails a save to avoid becoming entangled or fails a check to break free takes 1d2 points of Constitution damage.',
    source: 'Pathfinder Player Companion: Legacy of the First World',
    verificationStatus: 'needs_review' as const,
  },
  {
  ...
  },
  {
    ...
    components: {
      ...
      material: true,
      divine: true,
      materialComponents: 'three-pointed knot',
    },
    castingTime: '1 standard action',
    range: 'personal',
    target: 'you',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a piece of spent thunderstone',
    },
    castingTime: '1 standard action',
    range: 'close (25 ft. + 5 ft./2 levels)',
    target: '1 loaded firearm',
    ...
    spellResistance: 'yes (object); see text',
    description:
      "When cast on a firearm, this spell creates a thunderous report, even if the firearm is not loaded. All creatures within 15 feet must make a Fortitude save or suffer deafness lasting 1 minute. The firearm's wielder takes a -4 penalty on this save and experiences a +1 increase to misfire range for 1d4 rounds. Any loaded ammunition is wasted if the firearm was loaded when targeted.",
    source: 'Pathfinder Roleplaying Game',
    verificationStatus: 'needs_review' as const,
  },
  ...
  // ─── batch_gap_T_2 ─────────────────────────────────────────────────────────────
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'tiny hourglass',
    },
    castingTime: '1 standard action',
    range: '30 ft.',
    ...
    spellResistance: 'yes',
    description:
      "You create a temporal disturbance affecting all creatures within the area. Each round at the start of a creature's turn, a 50% chance determines the effect: the creature either gains the benefits of haste or suffers the effects of slow.",
    source: 'Pathfinder Roleplaying Game',
    verificationStatus: 'needs_review' as const,
  },
  {
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a hard biscuit broken into pieces',
    },
    castingTime: '1 standard action',
    range: 'touch',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a hard biscuit',
    },
    castingTime: '1 standard action',
    range: 'personal',
    target: 'you',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'oak root shaving',
    },
    castingTime: '1 standard action',
    range: 'personal',
    target: 'you',
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'tattooing needle',
    },
    castingTime: '1 standard action',
    range: 'touch',
    ...
    spellResistance: 'yes',
    description:
      'This transmutation spell enables you to move one magical tattoo between creatures. The recipient can attempt a Fortitude save to resist the transfer; if successful, the spell fails and you become staggered for 1 round by the backlash of magical energy. A magical tattoo may be transferred from a deceased creature to a living host, provided the corpse has not been dead longer than one hour per caster level.',
    source: 'Pathfinder Campaign Setting: Inner Sea Magic',
    verificationStatus: 'needs_review' as const,
  },
  {
    name: 'Treasure Stitching',
    classLevels: { bard: 4, cleric: 5, oracle: 5, sorcerer: 5, wizard: 5 },
    school: 'transmutation',
    components: {
      verbal: true,
      somatic: true,
      material: true,
      materialComponents: 'a piece of embroidered cloth no larger than 10-ft. square worth 100 gp',
    },
    castingTime: '1 standard action',
    range: 'close (25 ft. + 5 ft./2 levels)',
    ...
    spellResistance: 'yes (object)',
    description:
      "You transform objects placed on embroidered cloth into a two-dimensional sewn representation for storage and transport. Any amount of weight can be stored as long as the pile stays within the cloth's dimensions (up to 10-foot cube). You can restore objects as a full-round action; anyone else must dispel the spell to recover items. Destruction of the cloth results in permanent loss of stored objects. Artifacts and unique objects cannot be affected.",
    source: 'Pathfinder Roleplaying Game',
    verificationStatus: 'needs_review' as const,
  },
  {
  ...
  },
  {
    ...
    spellResistance: 'no',
    description:
      'This spell animates a rope or vine to automatically trip creatures within a designated 10-foot-square area. The animated rope uses a Combat Maneuver Bonus equal to your caster level plus 2, and does not provoke attacks of opportunity. Targets that were running, jumping, or charging when tripped sustain 1d6 nonlethal damage. Creatures aware of the tripvine receive a +4 bonus to their Combat Maneuver Defense against it.',
    source: 'Pathfinder Roleplaying Game',
    verificationStatus: 'needs_review' as const,
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialComponents: 'a length of wire bent into a circle',
    },
    castingTime: '1 standard action',
    range: 'close (25 ft. + 5 ft./2 levels)',
    target: 'one creature',
