...
export const eidolonEvolutionsUc3pt4pt: EidolonEvolutionEntry[] = [
  ...
  },
  {
    ...
    subtypeRestrictions: ['agathion', 'daemon', 'demon', 'devil', 'div', 'elemental', 'protean', 'psychopomp'],
    summoner: 'unchained',
    source: 'pf1e-unchained',
    isOfficial: true,
    visibility: 'global',
  ...
  },
  {
    ...
    prerequisites: [
      ...
      {
        type: 'special',
        description: 'Must have aberrant, daemon, demon, or devil subtype, or the undead appearance evolution',
      },
    ],
    summoner: 'unchained',
    source: 'pf1e-horror-realms',
