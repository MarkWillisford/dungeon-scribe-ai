        ...
        options: [
          {
            id: 'aberrant',
            name: 'Aberrant',
            description: 'Alien, aberrant outsider. No alignment restriction.',
          },
          {
            id: 'aeon',
            name: 'Aeon',
            description:
              'Neutral outsider. DR 10/chaotic. Immunity to cold, poison; resistance 10 acid/electricity.',
          },
          {
            id: 'agathion',
            name: 'Agathion',
            description:
              'Neutral good outsider. DR 10/evil. Immunity to electricity, petrification.',
          },
          {
            id: 'ancestor',
            name: 'Ancestor',
            description: 'Neutral outsider representing ancestral spirits.',
          },
          {
            id: 'angel',
            name: 'Angel',
            description: 'Good outsider. DR 10/evil. Immunity to acid, cold, petrification.',
          },
          {
            id: 'archon',
            name: 'Archon',
            description:
              'Lawful good outsider. DR 10/evil. Immunity to electricity, petrification.',
          },
          { id: 'astral', name: 'Astral', description: 'Outsider connected to the Astral Plane.' },
          {
            ...
            name: 'Azata',
            description:
              'Chaotic good outsider. DR 10/evil and lawful. Immunity to electricity, petrification.',
          },
          {
            id: 'daemon',
            name: 'Daemon',
            description:
              'Neutral evil outsider. DR 10/good. Immunity to acid, death, disease, poison.',
          },
          { id: 'deepwater', name: 'Deepwater', description: 'Outsider from the deep ocean.' },
          {
            ...
            name: 'Demon',
            description:
              'Chaotic evil outsider. DR 10/good. Immunity to electricity, poison; resistance 10 acid/cold/fire.',
          },
          {
            id: 'devil',
            name: 'Devil',
            description: 'Lawful evil outsider. DR 10/good and silver. Immunity to fire, poison.',
          },
          {
            id: 'div',
            name: 'Div',
            description: 'Neutral evil outsider. DR 10/good. Immunity to fire, poison.',
          },
          {
            id: 'elemental',
            name: 'Elemental',
            description: 'Neutral outsider. DR 5/— (earth/water) or none. Element immunity varies.',
          },
          {
            id: 'genie',
            name: 'Genie',
            description: 'Outsider tied to an elemental plane. Immunity varies by element.',
          },
          {
            id: 'inevitable',
            name: 'Inevitable',
            description: 'Lawful neutral outsider. DR 10/chaotic. Immunity to cold, petrification.',
          },
          {
            id: 'kami',
            name: 'Kami',
            description:
              'Neutral outsider. DR 10/cold iron. Immunity to bleed, mind-affecting, petrification, polymorph.',
          },
          {
            id: 'kyton',
            name: 'Kyton',
            description: 'Lawful evil outsider. DR 10/good and silver. Immunity to cold.',
          },
          {
            id: 'plant',
            name: 'Plant',
            description:
              'Plant-like outsider. DR 10/magic. Immunity to mind-affecting, paralysis, poison, sleep, stunning.',
          },
          {
            id: 'protean',
            name: 'Protean',
            description:
              'Chaotic neutral outsider. DR 10/lawful. Immunity to acid; resistance 10 electricity.',
          },
          {
            id: 'psychopomp',
            name: 'Psychopomp',
            description: 'Neutral outsider. DR 10/alignment. Immunity to death, disease.',
          },
          { id: 'radiant', name: 'Radiant', description: 'Good outsider of light and radiance.' },
          {
            id: 'shadow',
            name: 'Shadow',
            description: 'Outsider from the Shadow Plane. DR 10/magic.',
          },
          {
            id: 'storykin',
            name: 'Storykin',
            description: 'Outsider of the First World, connected to the fey.',
          },
          {
            id: 'twinned',
            name: 'Twinned',
            description: 'Outsider mystically linked to its summoner.',
          },
