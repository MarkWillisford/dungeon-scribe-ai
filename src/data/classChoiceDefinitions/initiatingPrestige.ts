...
export const battleTemplarDefinitions: ClassChoiceDefinition[] = [
  {
    ...
    optionSource: 'collection',
    collectionName: 'maneuvers',
    collectionFilter: { includesDisciplines: ['golden-lion', 'iron-tortoise'] },
    source: 'dsp-powe',
    isOfficial: false,
    verificationStatus: 'needs_review' as const,
    visibility: 'global',
...
export const dragonFuryDefinitions: ClassChoiceDefinition[] = [
  {
    ...
    optionSource: 'collection',
    collectionName: 'maneuvers',
    collectionFilter: { includesDisciplines: ['mithral-current', 'primal-fury'] },
    source: 'dsp-pow',
    isOfficial: false,
    verificationStatus: 'needs_review' as const,
    visibility: 'global',
...
export const landsknechtDefinitions: ClassChoiceDefinition[] = [
  {
    ...
    optionSource: 'collection',
    collectionName: 'maneuvers',
    collectionFilter: { includesDisciplines: ['mithral-current', 'scarlet-throne'] },
    source: 'dsp-powe',
    isOfficial: false,
    verificationStatus: 'needs_review' as const,
    visibility: 'global',
...
export const phoenixChampionDefinitions: ClassChoiceDefinition[] = [
  {
    ...
    optionSource: 'collection',
    collectionName: 'maneuvers',
    collectionFilter: { includesDisciplines: ['solar-wind', 'tempest-gale'] },
    source: 'dsp-pow',
    isOfficial: false,
    verificationStatus: 'needs_review' as const,
    visibility: 'global',
...
export const umbralBladeDefinitions: ClassChoiceDefinition[] = [
  {
    ...
    optionSource: 'collection',
    collectionName: 'maneuvers',
    collectionFilter: { includesDisciplines: ['veiled-moon'] },
    source: 'dsp-powe',
    isOfficial: false,
    verificationStatus: 'needs_review' as const,
    visibility: 'global',
