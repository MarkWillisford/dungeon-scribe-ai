...
const MERCY_OPTIONS = [
  ...
  { id: 'mercy-diseased', name: 'Diseased', description: "The paladin's lay on hands ability also acts as remove disease." },
  { id: 'mercy-staggered', name: 'Staggered', description: 'The staggered condition is removed, as long as it is not caused by a permanent condition.' },
  // Available from level 9
  { id: 'mercy-cursed', name: 'Cursed', description: "The paladin's lay on hands ability also acts as remove curse." },
  { id: 'mercy-exhausted', name: 'Exhausted', description: 'The exhausted condition is removed (requires the fatigued mercy).' },
  { id: 'mercy-frightened', name: 'Frightened', description: 'The frightened condition is removed (requires the shaken mercy).' },
  { id: 'mercy-injured', name: 'Injured', description: 'Ability damage is removed (1 point per use).' },
  { id: 'mercy-nauseated', name: 'Nauseated', description: 'The nauseated condition is removed (requires the sickened mercy).' },
  { id: 'mercy-poisoned', name: 'Poisoned', description: "The paladin's lay on hands ability also acts as neutralize poison." },
  // Available from level 12
  { id: 'mercy-blinded', name: 'Blinded', description: 'The blinded condition is removed (requires the dazed mercy).' },
  { id: 'mercy-deafened', name: 'Deafened', description: 'The deafened condition is removed (requires the shaken mercy).' },
  { id: 'mercy-paralyzed', name: 'Paralyzed', description: 'The paralyzed condition is removed.' },
  { id: 'mercy-stunned', name: 'Stunned', description: 'The stunned condition is removed (requires the dazed mercy).' },
];
    ...
    optionGroups: [
      {
        ...
        options: MERCY_OPTIONS.slice(0, 2),
      },
      {
        id: 'mercies-6',
        name: 'Level 6+ Mercies',
        minClassLevel: 6,
        options: MERCY_OPTIONS.slice(2, 5),
      },
      {
        id: 'mercies-9',
        name: 'Level 9+ Mercies',
        minClassLevel: 9,
        options: MERCY_OPTIONS.slice(5, 11),
      },
      {
        id: 'mercies-12',
        name: 'Level 12+ Mercies',
        minClassLevel: 12,
        options: MERCY_OPTIONS.slice(11),
      },
    ],
    source: 'pf1e-core',
    isOfficial: true,
