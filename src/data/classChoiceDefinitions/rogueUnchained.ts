        ...
        options: [
          {
            id: 'dagger',
            name: 'Dagger',
            description: 'Light weapon — 1d4 piercing or slashing, 19-20/×2.',
          },
          { id: 'kukri', name: 'Kukri', description: 'Light weapon — 1d4 slashing, 18-20/×2.' },
          {
            id: 'punching-dagger',
            name: 'Punching Dagger',
            description: 'Light weapon — 1d4 piercing, ×3.',
          },
          {
            id: 'rapier',
            name: 'Rapier',
            description: 'One-handed weapon — 1d6 piercing, 18-20/×2.',
          },
          { id: 'sap', name: 'Sap', description: 'Light weapon — 1d6 nonlethal bludgeoning, ×2.' },
          {
            id: 'short-sword',
            name: 'Short Sword',
            description: 'Light weapon — 1d6 piercing, 19-20/×2.',
          },
          { id: 'sickle', name: 'Sickle', description: 'Light weapon — 1d6 slashing, ×2.' },
          {
            id: 'starknife',
            name: 'Starknife',
            description: 'Light weapon — 1d4 piercing, ×3, can be thrown.',
          },
          {
            id: 'sword-cane',
            name: 'Sword Cane',
            description: 'One-handed weapon — 1d6 piercing, ×2, concealable.',
          },
          {
            id: 'whip',
            name: 'Whip',
            description: 'Exotic weapon — 1d3 nonlethal, ×2, 15-ft. reach, does not threaten.',
          },
          {
            id: 'kama',
            name: 'Kama',
            description: 'Light weapon — 1d6 slashing, ×2, monk weapon.',
          },
          {
            id: 'nunchaku',
            name: 'Nunchaku',
            description: 'Light weapon — 1d6 bludgeoning, ×2, monk weapon, disarm bonus.',
          },
        ],
      },
    ],
