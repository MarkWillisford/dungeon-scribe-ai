...
export const ELEMENTAL_MASTERS_FEATS: FeatDefinition[] = [
    ...
    effects: [
      {
        ...
        condition: { type: 'custom', description: 'DR/piercing equal to spell level for 1 round after casting a water-descriptor spell', params: {} },
      },
    ],
    activationMode: 'conditional',
...

  {
    id: 'flumefire_rage',
    name: 'Flumefire Rage',
    description: 'Your meditation before a rune-engraved stone in the Flume Warrens unlocks the secret of its blazing power. When casting evocation spells dealing fire damage, you add +1 fire damage per die. You must succeed at a Fortitude save (DC 15 + the spell\'s or blast\'s level) or become fatigued. You cannot use this feat while already fatigued or while unable to become fatigued. During a rage, the bonus increases to +2 fire damage per die and you roll the Fortitude save twice, taking the better result. This feat does not grant the ability to cast spells while raging.',
    shortDescription: 'Add +1 fire damage per die to evocation fire spells, or +2 while raging, with a Fortitude save or become fatigued.',
    source: "Pathfinder Player Companion: Elemental Master's Handbook",
    types: ['general'],
    prerequisites: [
      { type: 'ability_score', ability: 'CHA', minimum: 15 },
      { type: 'special', description: 'Bloodrage class feature, elemental focus class feature, or Varisian Tattoo (evocation)' },
    ],
    effects: [
      {
        type: 'bonus',
        ...
        condition: { type: 'custom', description: '+1 fire damage per die on evocation fire spells (+2 while raging)', params: {} },
      },
    ],
    activationMode: 'conditional',
    ...
    effects: [
      {
        ...
        condition: { type: 'custom', description: 'Fast healing 1 for 3+ rounds after avoiding fire damage', params: {} },
      },
    ],
    activationMode: 'conditional',
...

  {
    ...
    description: 'Your allies cover you when your guard is down. Allied creatures who also have this feat prevent attacks of opportunity against you when you pick up an item from the ground, retrieve a stored item, sheathe a weapon, or stand up from prone.',
    shortDescription: 'Allies with this feat prevent attacks of opportunity against you for certain vulnerable actions.',
    source: "Pathfinder Player Companion: Elemental Master's Handbook",
    types: ['teamwork'],
    prerequisites: [],
    effects: [],
...

  {
    ...
    description: "You have learned one of the secrets of Kraggodan's defenders and can lock your armor and shield into an impenetrable barrier. As a move action while wearing heavy armor and a heavy or tower shield, you increase both your armor bonus and your shield bonus to AC by 1 each. This benefit persists until you move or are moved from your current square. You must be in contact with solid ground to gain this bonus. You can never increase an armor or shield bonus to AC by more than 1 each in this way.",
    shortDescription: 'As a move action while stationary in heavy armor and heavy shield, gain +1 armor and +1 shield bonus to AC.',
    source: "Pathfinder Player Companion: Elemental Master's Handbook",
    types: ['combat'],
    prerequisites: [
    ...
    effects: [
      {
        ...
        condition: { type: 'custom', description: 'While stationary, wearing heavy armor and heavy or tower shield', params: {} },
      },
      {
        type: 'bonus',
...

  {
    ...
    description: 'You can move while gathering elemental power. When you take a move action to gather power, you can move up to half your base speed as part of that action. When you take a full-round action to gather power, you can move up to half your speed at the start of your turn. This movement provokes attacks of opportunity as normal and cannot be negated through Acrobatics. If you take damage during gathering or before releasing the blast, the concentration check DC increases by twice the blast\'s effective spell level.',
...

  {
    id: 'mountain_eyes',
    name: 'Mountain Eyes',
    description: 'Your gaze cuts through vapors with ease. You ignore concealment from fog, rain, smoke, wind, gases, and weather effects, including magical effects such as obscuring mist. You also reduce Perception check penalties from such effects by up to 4. Within 10 feet, total concealment from these sources is treated as regular concealment (20% miss chance) instead.',
    shortDescription: 'Ignore concealment from fog, rain, smoke, and similar effects; treat total concealment from them as normal concealment within 10 feet.',
    source: "Pathfinder Player Companion: Elemental Master's Handbook",
    types: ['general'],
    prerequisites: [
    ...
    effects: [
      {
        ...
        condition: { type: 'custom', description: 'Reduces Perception penalties from fog, smoke, and weather by up to 4', params: {} },
      },
    ],
    activationMode: 'passive',
...

  {
    id: 'storm_breaker',
    name: 'Storm Breaker',
    description: 'After the Eye of Abendego, no other storm, magic or mundane, can faze you. You are treated as two sizes larger than your actual size when calculating whether you can be moved by wind or currents, including the vortex and whirlwind special abilities of monsters. If you have at least 11 Hit Dice, you cannot be moved by nonmagical wind unless you so choose.',
    shortDescription: 'Count as two sizes larger against wind and current displacement effects; at 11 HD, ignore nonmagical wind movement entirely.',
    source: "Pathfinder Player Companion: Elemental Master's Handbook",
    types: ['general'],
    prerequisites: [],
    effects: [],
...

  {
    id: 'tundra_stride',
    name: 'Tundra Stride',
    description: 'Whether as predator or prey, you have learned to move like the arctic wind when survival is at stake. You gain a +10-foot enhancement bonus to your base speed while charging, running, or withdrawing. This bonus also applies to overland movement calculations in plains terrain. The feat\'s benefits are lost while wearing heavy armor or carrying a heavy load.',
    shortDescription: 'Gain +10 ft. enhancement bonus to speed while charging, running, or withdrawing; lost in heavy armor or heavy load.',
    source: "Pathfinder Player Companion: Elemental Master's Handbook",
    types: ['general'],
    prerequisites: [
    ...
    effects: [
      {
        ...
        condition: { type: 'custom', description: 'While charging, running, or withdrawing; not in heavy armor or heavy load', params: {} },
      },
    ],
    activationMode: 'conditional',
