    ...
    effects: [
      {
        ...
        source: 'Unusual Origin (Changeling)',
      },
    ],
    activationMode: 'conditional',
    ...
    effects: [
      {
        ...
        bonusType: BonusType.UNTYPED,
        target: 'special.ability',
        source: 'Unusual Origin (Fetchling)',
      },
    ],
    activationMode: 'conditional',
    ...
    effects: [
      {
        ...
        value: 4,
        bonusType: BonusType.UNTYPED,
        source: 'Sense Metals and Minerals',
      },
      {
        type: 'bonus',
