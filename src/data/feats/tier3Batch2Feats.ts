...
export const TIER3_BATCH2_FEATS: FeatDefinition[] = [
  ...
  // ─── Heroes of the Darklands (6 new — have 2 already) ────────────────────────
  {
    ...
    effects: [{ type: 'bonus', target: 'climb', value: 5, bonusType: BonusType.UNTYPED, source: 'Assisted Ascension' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    prerequisites: [],
    effects: [
      { type: 'bonus', target: 'perception', value: 4, bonusType: BonusType.UNTYPED, source: 'Sense Metals and Minerals' },
      { type: 'bonus', target: 'appraise', value: 4, bonusType: BonusType.UNTYPED, source: 'Sense Metals and Minerals' },
    ],
    activationMode: 'passive',
  ...
  },
  {
    ...
    effects: [{ type: 'bonus', target: 'land', value: 5, bonusType: BonusType.UNTYPED, source: 'Terrain Celerity' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [
      { type: 'bonus', target: 'mind_affecting', value: 2, bonusType: BonusType.RACIAL, source: 'Jackal Heritage' },
      { type: 'bonus', target: 'perception', value: 2, bonusType: BonusType.RACIAL, source: 'Jackal Heritage' },
    ],
    activationMode: 'passive',
  ...
  },
  {
    ...
    prerequisites: [],
    effects: [
      { type: 'bonus', target: 'swim', value: 2, bonusType: BonusType.UNTYPED, source: 'River Raider' },
      { type: 'bonus', target: 'stealth', value: 2, bonusType: BonusType.UNTYPED, source: 'River Raider' },
    ],
    activationMode: 'conditional',
