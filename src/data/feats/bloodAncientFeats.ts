...
export const BLOOD_ANCIENTS_FEATS: FeatDefinition[] = [
  ...
  },
  {
    ...
    prerequisites: [
      { type: 'skill', skillId: 'knowledge_history', ranks: 3 },
      {
        type: 'special',
        description:
          'Connection to a lost culture (relic/object, extensive research, or cultural/direct descent)',
      },
    ],
    effects: [],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    prerequisites: [
      {
        type: 'special',
        description: 'Must be devoted to the philosophy of Pao-Lung; cannot worship any deities',
      },
    ],
    effects: [],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [
      {
        type: 'bonus',
        target: 'special.astrological_event_detection',
        value: 3,
        bonusType: BonusType.UNTYPED,
  ...
  },
  {
    ...
    effects: [
      {
        type: 'bonus',
        target: 'special.vs_triggering_reach_attack',
        value: 4,
        bonusType: BonusType.UNTYPED,
  ...
  },
  {
    ...
    effects: [
      {
        type: 'bonus',
        target: 'special.oath_related_checks',
        value: 1,
