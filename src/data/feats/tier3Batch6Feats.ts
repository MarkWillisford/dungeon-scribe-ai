...
export const TIER3_BATCH6_FEATS: FeatDefinition[] = [
  // ─── The Harrow Handbook (Deadly Dealer already in acg-extra.ts) ──────────────
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'All-Consuming Swing' }],
  ...
  },
  {
    ...
    effects: [{ type: 'skill_bonus', target: 'intimidate', value: 2, bonusType: BonusType.UNTYPED, source: "Bear's Balance" }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 4, bonusType: BonusType.ENHANCEMENT, target: 'special', source: 'Harrowed Summoning' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    shortDescription: 'Sacrifice your flanking bonus to grant +1 flanking to all allies vs. same foe.',
    source: 'Pathfinder Player Companion: The Harrow Handbook',
    types: ['combat'],
    prerequisites: [
    ...
    effects: [{ type: 'special', value: 1, bonusType: BonusType.UNTYPED, target: 'special', source: 'Merciless Beating' }],
    activationMode: 'conditional',
  ...
  // ─── Dwarves of Golarion (Darting Viper + Dorn-Dergar Master in armoryFeats) ──
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Bounding Hammer' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Sliding Axe Throw' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Stance of the Xorn' }],
  ...
  // ─── People of the North (Cold Celerity + Tribal Scars in adventurersGuideFeats) ─
  {
    ...
    shortDescription: '+2 saves vs. hag/witch abilities; crits let allies re-save vs. their effects.',
    source: 'Pathfinder Player Companion: People of the North',
    types: ['combat'],
    prerequisites: [{ type: 'feat', featId: 'iron_will' }],
    effects: [{ type: 'save_bonus', target: 'hex', value: 2, bonusType: BonusType.UNTYPED, source: 'Witchbreaker' }],
    activationMode: 'conditional',
  ...
  // ─── Seekers of Secrets (Boon Companion in ultimateWilderness.ts) ─────────────
  {
    ...
    types: ['general'],
    prerequisites: [{ type: 'special', description: '2 ranks each in 5 different Knowledge skills' }],
    effects: [{ type: 'special', value: 2, bonusType: BonusType.UNTYPED, target: 'knowledge', source: 'Dilettante' }],
    activationMode: 'passive',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Friendly Switch' }],
    activationMode: 'conditional',
