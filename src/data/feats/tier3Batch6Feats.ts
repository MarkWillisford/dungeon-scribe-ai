...
export const TIER3_BATCH6_FEATS: FeatDefinition[] = [
  ...
  },
  {
    ...
    effects: [{ type: 'bonus', target: 'intimidate', value: 2, bonusType: BonusType.UNTYPED, source: "Bear's Balance" }],
    activationMode: 'conditional',
  ...
  // ─── People of the North (Cold Celerity + Tribal Scars in adventurersGuideFeats) ─
  {
    ...
    effects: [{ type: 'bonus', target: 'hex', value: 2, bonusType: BonusType.UNTYPED, source: 'Witchbreaker' }],
    activationMode: 'conditional',
