...
export const TIER3_BATCH3_FEATS: FeatDefinition[] = [
  // ─── Demon Hunter's Handbook ──────────────────────────────────────────────────
  {
    ...
    prerequisites: [],
    effects: [{ type: 'special', value: 2, bonusType: BonusType.UNTYPED, target: 'special', source: 'Coordinated Distraction' }],
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: "Exorcist's Rebuttal" }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 5, bonusType: BonusType.UNTYPED, target: 'special', source: 'Punch Through' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    shortDescription: 'Successful SR penetration lets next ally with this feat roll twice vs. same target.',
    source: "Pathfinder Player Companion: Demon Hunter's Handbook",
    types: ['teamwork'],
    prerequisites: [{ type: 'feat', featId: 'spell_penetration' }],
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Spell Chain' }],
    activationMode: 'conditional',
  ...
  // ─── Undead Slayer's Handbook ─────────────────────────────────────────────────
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Align Equipment' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    shortDescription: 'Channel energy to temporarily enchant weapons/armor with anti-undead properties.',
    source: "Pathfinder Player Companion: Undead Slayer's Handbook",
    types: ['general'],
    prerequisites: [
      { type: 'caster_level', minimum: 3 },
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Bless Equipment' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Greater Bless Equipment' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Holy Water Assault' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Improved Bless Equipment' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Lingering Smite' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Weapon Versatility' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Gun Twirling' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Named Bullet' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 4, bonusType: BonusType.MORALE, target: 'cohort_will', source: 'Practiced Leadership' }],
    activationMode: 'passive',
  ...
  },
  {
    ...
    source: 'Pathfinder Player Companion: Champions of Balance',
    types: ['general'],
    prerequisites: [{ type: 'special', description: 'Chaotic neutral, lawful neutral, or neutral alignment' }],
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Summon Neutral Monster' }],
    activationMode: 'conditional',
  ...
  // ─── People of the Stars ──────────────────────────────────────────────────────
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Astrological Timing' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    shortDescription: '+2 Knowledge (geography) for stars; can\'t get lost at night; 1/night Knowledge reroll.',
    source: 'Pathfinder Player Companion: People of the Stars',
    types: ['general'],
    prerequisites: [],
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Empathy' }],
    activationMode: 'passive',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 1, bonusType: BonusType.UNTYPED, target: 'special', source: 'Extra Surge' }],
    activationMode: 'passive',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Nanite Disruption' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Rapid Recovery' }],
    activationMode: 'conditional',
