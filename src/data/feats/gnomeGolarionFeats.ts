...
export const GNOME_GOLARION_FEATS: FeatDefinition[] = [
  {
    ...
    effects: [{ type: 'special', value: -2, bonusType: BonusType.UNTYPED, target: 'special', source: 'Arcane School Spirit' }],
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Babble-Peddler' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Bewildering Koan' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Blood Ties' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Caustic Slur' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Effortless Trickery' }],
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 3, bonusType: BonusType.UNTYPED, target: 'special', source: 'Extra Gnome Magic' }],
    activationMode: 'passive',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 5, bonusType: BonusType.UNTYPED, target: 'escape_artist', source: 'Helpless Prisoner' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Invoke Primal Instinct' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Master of Wonders' }],
    activationMode: 'conditional',
  ...
  },
  {
    id: 'tantrum',
    name: 'Tantrum',
    description: 'You may use the Bluff skill to feint while raging. The effect of the feint lasts only until the first time you hit the target.',
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Tantrum' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    shortDescription: 'Figment illusions create a flanking-capable threatening square (+1 spell level).',
    source: 'Pathfinder Player Companion: Gnomes of Golarion',
    types: ['metamagic'],
    prerequisites: [
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Threatening Illusion' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    shortDescription: 'Successful feint grants dodge AC equal to weapon training bonus vs. that foe.',
    source: 'Pathfinder Player Companion: Gnomes of Golarion',
    types: ['combat'],
    prerequisites: [
      { type: 'skill', skillId: 'bluff', ranks: 1 },
