...
export const TIER3_BATCH5_FEATS: FeatDefinition[] = [
    ...
    effects: [
      {
        ...
        bonusType: BonusType.UNTYPED,
        target: 'special.ability',
        source: 'Inscribe Magical Tattoo',
      },
    ],
  ...
  // ─── Inner Sea Intrigue (Stylized Spell already in acg-extra.ts) ──────────────
  {
    ...
    prerequisites: [
      {
        type: 'special',
        description: 'Bluff 5 ranks and Perform (act) 5 ranks, or dual identity class feature',
      },
    ],
    effects: [
      {
