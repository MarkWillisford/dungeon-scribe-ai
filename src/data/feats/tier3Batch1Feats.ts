...
export const TIER3_BATCH1_FEATS: FeatDefinition[] = [
  // ─── Blood of the Coven ──────────────────────────────────────────────────────
  {
    ...
    effects: [{ type: 'bonus', target: 'arcane', value: 2, bonusType: BonusType.RACIAL, source: 'Awakened Hag Heritage' }],
  ...
  },
  {
    ...
    types: ['general'],
    prerequisites: [],
    effects: [{ type: 'bonus', target: 'save.curse', value: 1, bonusType: BonusType.UNTYPED, source: 'Cursed Conduit' }],
    activationMode: 'passive',
  ...
  },
  {
    ...
    effects: [{ type: 'bonus', target: 'spellcraft', value: 5, bonusType: BonusType.UNTYPED, source: 'Familiar Link' }],
    activationMode: 'passive',
  ...
  },
  {
    ...
    effects: [{ type: 'bonus', target: 'curse', value: 2, bonusType: BonusType.UNTYPED, source: 'Scapegoat' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'bonus', target: 'spellcraft', value: 2, bonusType: BonusType.UNTYPED, source: 'Cursed Item Detection' }],
    activationMode: 'passive',
  ...
  // ─── Black Markets ────────────────────────────────────────────────────────────
  {
    ...
    types: ['general'],
    prerequisites: [],
    effects: [{ type: 'bonus', target: 'diplomacy', value: 4, bonusType: BonusType.UNTYPED, source: 'Black Market Dealings' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'bonus', target: 'fear', value: 2, bonusType: BonusType.UNTYPED, source: 'Pesh Euphoria' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    types: ['general'],
    prerequisites: [{ type: 'special', description: 'Sahir-Afiyun feat or pesh addict' }],
    effects: [{ type: 'bonus', target: 'hp.temporary', value: 1, bonusType: BonusType.UNTYPED, source: 'Pesh Healing' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'bonus', target: 'sleight_of_hand', value: 5, bonusType: BonusType.UNTYPED, source: 'Wary Smuggler' }],
    activationMode: 'passive',
