...
export const TIER3_BATCH1_FEATS: FeatDefinition[] = [
  // ─── Blood of the Coven ──────────────────────────────────────────────────────
  {
    ...
    shortDescription: '+2 racial saves vs. arcane spells plus hag heritage ability; risk of evil aura.',
    ...
    effects: [{ type: 'save_bonus', target: 'arcane', value: 2, bonusType: BonusType.RACIAL, source: 'Awakened Hag Heritage' }],
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Coven-Touched' }],
    activationMode: 'passive',
  ...
  },
  {
    ...
    shortDescription: 'Resist cursed item compulsion; save bonus vs. curses from carried cursed items.',
    source: 'Pathfinder Player Companion: Blood of the Coven',
    types: ['general'],
    prerequisites: [],
    effects: [{ type: 'save_bonus', target: 'curse', value: 0, bonusType: BonusType.UNTYPED, source: 'Cursed Conduit' }],
    activationMode: 'passive',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 3, bonusType: BonusType.UNTYPED, target: 'special', source: 'Enhanced Coven' }],
    activationMode: 'passive',
  ...
  },
  {
    ...
    shortDescription: 'Access coven members\' familiar abilities; +5 Spellcraft for familiar spell sharing.',
    source: 'Pathfinder Player Companion: Blood of the Coven',
    types: ['teamwork'],
    prerequisites: [
      { type: 'special', description: 'Coven hex or Coven-Touched' },
    ...
    effects: [{ type: 'skill_bonus', target: 'spellcraft', value: 5, bonusType: BonusType.UNTYPED, source: 'Familiar Link' }],
    activationMode: 'passive',
  ...
  },
  {
    ...
    types: ['metamagic'],
    prerequisites: [],
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Latent Curse' }],
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Metamagical Synergy' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'save_bonus', target: 'curse', value: 2, bonusType: BonusType.UNTYPED, source: 'Scapegoat' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Sin-Sharing Critical' }],
    activationMode: 'conditional',
  ...
  // ─── Dungeoneer's Handbook ────────────────────────────────────────────────────
  {
    ...
    types: ['general'],
    prerequisites: [{ type: 'special', description: 'Ability to cast dispel magic or greater dispel magic' }],
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Arcane Trap Suppressor' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Close Call' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Coaxing Spell' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'skill_bonus', target: 'spellcraft', value: 2, bonusType: BonusType.UNTYPED, source: 'Cursed Item Detection' }],
    activationMode: 'passive',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'stealth', source: 'Dampen Presence' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    types: ['general'],
    prerequisites: [],
    effects: [{ type: 'special', value: 1, bonusType: BonusType.UNTYPED, target: 'special', source: 'Ostentatious Display' }],
    activationMode: 'passive',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: -2, bonusType: BonusType.UNTYPED, target: 'special', source: 'Tactical Reposition' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    shortDescription: 'Torches are simple weapons; +10 ft light radius; 1/day reroll vs. light extinguish.',
    source: "Pathfinder Player Companion: Dungeoneer's Handbook",
    types: ['combat'],
    prerequisites: [],
    effects: [{ type: 'special', value: 10, bonusType: BonusType.UNTYPED, target: 'special', source: 'Torch Handling' }],
    activationMode: 'passive',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Torchbearer' }],
    activationMode: 'passive',
  ...
  // ─── Black Markets ────────────────────────────────────────────────────────────
  {
    ...
    types: ['general'],
    prerequisites: [],
    effects: [{ type: 'skill_bonus', target: 'diplomacy', value: 4, bonusType: BonusType.UNTYPED, source: 'Black Market Dealings' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    shortDescription: 'Roll twice on black market Diplomacy/Knowledge (local); track in cities with Diplomacy.',
    source: 'Pathfinder Player Companion: Black Markets',
    types: ['general'],
    prerequisites: [
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Black Market Sleuth' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Connected Criminal' }],
    activationMode: 'passive',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Infuse Poison' }],
    activationMode: 'passive',
  ...
  },
  {
    ...
    effects: [{ type: 'save_bonus', target: 'fear', value: 2, bonusType: BonusType.UNTYPED, source: 'Pesh Euphoria' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    types: ['general'],
    prerequisites: [{ type: 'special', description: 'Sahir-Afiyun feat or pesh addict' }],
    effects: [{ type: 'hp_bonus', target: 'temporary', value: 0, bonusType: BonusType.UNTYPED, source: 'Pesh Healing' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    types: ['general'],
    prerequisites: [{ type: 'special', description: 'Sahir-Afiyun feat or pesh addict' }],
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Pesh Rejuvenation' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Sahir-Afiyun' }],
    activationMode: 'passive',
  ...
  },
  {
    ...
    shortDescription: '+5 Sleight of Hand to conceal objects; always take 10 on urban Perception/Stealth/SoH.',
    source: 'Pathfinder Player Companion: Black Markets',
    types: ['general'],
    prerequisites: [
    ...
    effects: [{ type: 'skill_bonus', target: 'sleight_of_hand', value: 5, bonusType: BonusType.UNTYPED, source: 'Wary Smuggler' }],
    activationMode: 'passive',
