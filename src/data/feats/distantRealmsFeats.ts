...
export const DISTANT_REALMS_FEATS: FeatDefinition[] = [
  ...
  },
  {
    ...
    prerequisites: [
      ...
      { type: 'special', description: 'Good or lawful alignment, caster level 7th or monk level 7th' },
    ],
    effects: [
      {
        type: 'special',
  ...
  },
  {
    ...
    prerequisites: [
      ...
      { type: 'feat', featId: 'point_blank_shot' },
      { type: 'feat', featId: 'precise_shot' },
      { type: 'special', description: 'Good or lawful alignment, caster level 11th or monk level 11th' },
    ],
    effects: [
      {
        type: 'special',
