...
export const HELLKNIGHT_FEATS: FeatDefinition[] = [
  ...
  },
  {
    ...
    source: 'Pathfinder Campaign Setting: Path of the Hellknight',
    types: ['general'],
    prerequisites: [{ type: 'special', description: 'Ability to cast a spell of the scrying subschool' }],
    effects: [
      {
        type: 'special',
        value: 0,
  ...
  },
  {
    ...
    shortDescription: "Daily Hellknight reckonings grant order weapon proficiency and scaling boons.",
    source: 'Pathfinder Campaign Setting: Path of the Hellknight',
    types: ['general'],
    prerequisites: [
  ...
  },
  {
    ...
    shortDescription: 'Identify enemy casters via Spellcraft; bonus Intimidate against identified casters.',
    source: 'Pathfinder Campaign Setting: Path of the Hellknight',
    types: ['combat'],
