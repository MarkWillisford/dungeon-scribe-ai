...
export const AP_VOLUME_FEATS: FeatDefinition[] = [
    ...
    effects: [
      {
        ...
        target: 'special.charisma',
        source: 'Dragon Gold Crown',
      },
    ],
    activationMode: 'passive',
  ...
  // ─── Curse of the Crimson Throne Player's Guide (3 new — Crossbow Mastery + Harrowed are reprints) ─
  {
    ...
    prerequisites: [
      {
        type: 'special',
        description: 'Specialist wizard 1st level; conjuration not a forbidden school',
      },
    ],
    effects: [
      {
    ...
    effects: [
      {
        ...
        value: 2,
        bonusType: BonusType.MORALE,
        source: 'All Gnolls Must Die',
      },
      {
        type: 'bonus',
        target: 'special.gnolls',
        value: 2,
  ...
  },
  {
    ...
    prerequisites: [
      {
        type: 'special',
        description: 'Knocked unconscious or killed by fire damage at least 10 times',
      },
    ],
    effects: [
      {
  ...
  },
  {
    ...
    prerequisites: [
      {
        type: 'special',
        description: 'Successfully affect 25 different targets with charm or compulsion spells',
      },
    ],
    effects: [
      {
    ...
    prerequisites: [
      {
        type: 'special',
        description:
          'Cure 1,000 cumulative damage for others using healing spells (dealing damage reduces progress by 2 per point)',
      },
    ],
    effects: [
      {
    ...
    prerequisites: [
      {
        type: 'special',
        description:
          'Accumulate 1,000 points of damage (magical healing reduces total by 1 per 5 healed)',
      },
    ],
    effects: [
      {
  ...
  // ─── Rise of the Runelords Player's Guide (4 new — Totem Spirit + Varisian Tattoo are reprints) ─
  {
    ...
    effects: [
      {
        type: 'bonus',
        target: 'special.large_creatures',
        value: 1,
        bonusType: BonusType.UNTYPED,
  ...
  },
  {
    ...
    prerequisites: [
      {
        type: 'special',
        description: '1st-level character; cannot have Country Born or Lone Wolf',
      },
    ],
    effects: [
      {
  ...
  },
  {
    ...
    prerequisites: [
      {
        type: 'special',
        description: '1st-level character; cannot have City Born or Country Born',
      },
    ],
    effects: [
      {
        type: 'bonus',
        target: 'special.fortitude',
        value: 1,
        bonusType: BonusType.UNTYPED,
        source: 'Lone Wolf',
      },
