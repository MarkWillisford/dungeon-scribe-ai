...
export const AP_VOLUME_FEATS: FeatDefinition[] = [
  ...
  },
  {
    ...
    effects: [
      { type: 'bonus', target: 'attack', value: 2, bonusType: BonusType.MORALE, source: 'Blood for the Empire' },
      { type: 'damage', target: 'damage', value: 2, bonusType: BonusType.MORALE, source: 'Blood for the Empire' },
    ],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [
      { type: 'bonus', target: 'skill.bluff', value: 2, bonusType: BonusType.UNTYPED, source: 'Imperial Prankster' },
      { type: 'bonus', target: 'cmb', value: 2, bonusType: BonusType.UNTYPED, source: 'Imperial Prankster' },
    ],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'bonus', target: 'ride', value: 2, bonusType: BonusType.UNTYPED, source: 'Sable Company Marine' }],
    activationMode: 'passive',
  ...
  },
  {
    ...
    effects: [
      { type: 'bonus', target: 'acrobatics', value: 2, bonusType: BonusType.UNTYPED, source: 'Shingle Runner' },
      { type: 'bonus', target: 'climb', value: 2, bonusType: BonusType.UNTYPED, source: 'Shingle Runner' },
    ],
    activationMode: 'passive',
  ...
  // ─── Legacy of Fire Player's Guide (8 feats — all achievement feats except Sandwalker) ─
  {
    ...
    effects: [
      { type: 'bonus', target: 'will', value: 2, bonusType: BonusType.MORALE, source: 'All Gnolls Must Die' },
      { type: 'bonus', target: 'gnolls', value: 2, bonusType: BonusType.COMPETENCE, source: 'All Gnolls Must Die' },
    ],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [
      { type: 'resistance', target: 'fire', value: 5, bonusType: BonusType.UNTYPED, source: 'Flame-Tested Survivor' },
      { type: 'bonus', target: 'save.fire', value: 2, bonusType: BonusType.UNTYPED, source: 'Flame-Tested Survivor' },
    ],
    activationMode: 'passive',
  ...
  },
  {
    ...
    effects: [
      { type: 'bonus', target: 'ac.natural', value: 2, bonusType: BonusType.NATURAL, source: 'History of Scars' },
      { type: 'penalty', target: 'skill.charisma_based', value: -2, bonusType: BonusType.UNTYPED, source: 'History of Scars' },
    ],
    activationMode: 'passive',
  ...
  },
  {
    ...
    effects: [{ type: 'bonus', target: 'survival', value: 2, bonusType: BonusType.UNTYPED, source: 'Sandwalker' }],
    activationMode: 'passive',
  ...
  // ─── Rise of the Runelords Player's Guide (4 new — Totem Spirit + Varisian Tattoo are reprints) ─
  {
    ...
    prerequisites: [],
    effects: [
      { type: 'bonus', target: 'large_creatures', value: 1, bonusType: BonusType.UNTYPED, source: 'Big Game Hunter' },
      { type: 'damage', target: 'large_creatures', value: 2, bonusType: BonusType.UNTYPED, source: 'Big Game Hunter' },
    ],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'bonus', target: 'reflex', value: 1, bonusType: BonusType.UNTYPED, source: 'City Born' }],
    activationMode: 'passive',
  ...
  },
  {
    ...
    effects: [{ type: 'bonus', target: 'will', value: 1, bonusType: BonusType.UNTYPED, source: 'Country Born' }],
    activationMode: 'passive',
  ...
  },
  {
    ...
    effects: [{ type: 'bonus', target: 'fortitude', value: 1, bonusType: BonusType.UNTYPED, source: 'Lone Wolf' }],
    activationMode: 'passive',
