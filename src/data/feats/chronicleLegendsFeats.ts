...
export const CHRONICLE_LEGENDS_FEATS: FeatDefinition[] = [
...

  {
    ...
    shortDescription: 'Your inspire action ability affects all allies within 30 feet instead of one.',
    source: 'Pathfinder Player Companion: Chronicle of Legends',
    types: ['combat'],
    prerequisites: [
      { type: 'special', description: 'Inspire action class feature' },
    ],
    effects: [],
    activationMode: 'conditional',
...

  {
    ...
    shortDescription: 'Unlock the two-item set bonus when wearing at least two items from a magical item set.',
    source: 'Pathfinder Player Companion: Chronicle of Legends',
    types: ['general'],
    prerequisites: [
...

  {
    ...
    shortDescription: 'Your enhance arrows ability grants access to additional magical properties including corrosive, ghost touch, limning, and planar.',
    source: 'Pathfinder Player Companion: Chronicle of Legends',
    types: ['combat'],
    prerequisites: [
      { type: 'special', description: 'Enhance arrows class feature' },
    ],
    effects: [],
    activationMode: 'passive',
...

  {
    ...
    shortDescription: 'Channel an instantaneous area-effect spell through your melee weapon, centered on yourself.',
    source: 'Pathfinder Player Companion: Chronicle of Legends',
    types: ['combat'],
    prerequisites: [
...

  {
    ...
    types: ['combat'],
    prerequisites: [
      { type: 'special', description: 'Hail of arrows class feature' },
    ],
    effects: [],
    activationMode: 'passive',
...

  {
    ...
    types: ['general'],
    prerequisites: [
      { type: 'special', description: 'Spell synthesis class feature' },
    ],
    effects: [],
    activationMode: 'passive',
...

  {
    ...
    shortDescription: "Unlock three-, four-, and five-item set bonuses; gain +2 on Use Magic Device checks with five or more magic items.",
    source: 'Pathfinder Player Companion: Chronicle of Legends',
    types: ['general'],
    prerequisites: [
    ...
    effects: [
      {
        ...
        condition: { type: 'custom', description: 'When wielding at least five magical items total', params: {} },
      },
    ],
    activationMode: 'passive',
...

  {
    ...
    shortDescription: 'Once per day, cast two spells from different spellcasting classes simultaneously as a full-round action.',
    source: 'Pathfinder Player Companion: Chronicle of Legends',
    types: ['general'],
    prerequisites: [
      { type: 'special', description: 'Combined spells class feature' },
    ],
    effects: [],
    activationMode: 'conditional',
...

  {
    ...
    shortDescription: "Creatures that fail their save against your breath weapon suffer lingering energy damage each round.",
    source: 'Pathfinder Player Companion: Chronicle of Legends',
    types: ['combat'],
    prerequisites: [
...

  {
    ...
    shortDescription: 'Choose one spell; you can use special magic tricks with that spell that go beyond its normal effects.',
    source: 'Pathfinder Player Companion: Chronicle of Legends',
    types: ['general'],
    prerequisites: [
      { type: 'special', description: 'Ability to cast the chosen spell or use it as a spell-like ability' },
    ],
    effects: [],
    activationMode: 'conditional',
...

  {
    ...
    shortDescription: 'Your sneak attacks impose a Will save penalty equal to your sneak attack dice for 1 round.',
    source: 'Pathfinder Player Companion: Chronicle of Legends',
    types: ['combat'],
    prerequisites: [
      { type: 'special', description: 'Ranged legerdemain class feature' },
    ],
    effects: [],
    activationMode: 'conditional',
...

  {
    ...
    shortDescription: 'Use death attacks with ranged weapons from within 30 feet, extending range with additional study rounds.',
    source: 'Pathfinder Player Companion: Chronicle of Legends',
    types: ['combat'],
    prerequisites: [
      { type: 'special', description: 'Death attack class feature' },
    ],
    effects: [],
    activationMode: 'conditional',
...

  {
    ...
    shortDescription: 'Once per day, cast any spell as if it were one of your prepared spells or spells known by expending a matching spell slot.',
    source: 'Pathfinder Player Companion: Chronicle of Legends',
    types: ['general'],
    prerequisites: [
      { type: 'special', description: 'Secret class feature' },
    ],
    effects: [],
    activationMode: 'conditional',
...

  {
    ...
    shortDescription: "Encase yourself in a darkness effect with caster level equal to your shadowdancer level; adjust light level as a standard action.",
    source: 'Pathfinder Player Companion: Chronicle of Legends',
    types: ['general'],
    prerequisites: [
      { type: 'special', description: 'Shadow illusion class feature' },
    ],
    effects: [],
...

  {
    ...
    shortDescription: 'When you parry an attack, you may also attempt a dirty trick, disarm, or sunder maneuver with a +2 morale bonus without provoking attacks of opportunity.',
    source: 'Pathfinder Player Companion: Chronicle of Legends',
    types: ['combat'],
    prerequisites: [
      { type: 'special', description: 'Riposte class feature' },
    ],
    effects: [
      {
        type: 'bonus',
        ...
        condition: { type: 'custom', description: 'On dirty trick, disarm, or sunder attempts made after a successful parry', params: {} },
      },
    ],
    activationMode: 'conditional',
