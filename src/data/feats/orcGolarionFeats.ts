...
export const ORC_GOLARION_FEATS: FeatDefinition[] = [
  ...
  // Sympathetic Rage — already in racialFeats.ts
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Adept Channel' }],
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 1, bonusType: BonusType.UNTYPED, target: 'rage_rounds', source: 'Thrill of the Kill' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: "Warleader's Rage" }],
