...
export const TECHNOLOGY_GUIDE_FEATS: FeatDefinition[] = [
  ...
  },
  {
    ...
    effects: [
      { type: 'bonus', target: 'robots', value: 1, bonusType: BonusType.UNTYPED, source: "Robot's Bane" },
      { type: 'damage', target: 'robots', value: 1, bonusType: BonusType.UNTYPED, source: "Robot's Bane" },
  ...
  },
  {
    ...
    effects: [
      { type: 'bonus', target: 'attack', value: 2, bonusType: BonusType.MORALE, source: 'Technophobe' },
      { type: 'bonus', target: 'all', value: 2, bonusType: BonusType.MORALE, source: 'Technophobe' },
    ],
    activationMode: 'conditional',
