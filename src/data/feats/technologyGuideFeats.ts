...
export const TECHNOLOGY_GUIDE_FEATS: FeatDefinition[] = [
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Craft Cybernetics' }],
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Craft Pharmaceutical' }],
    activationMode: 'passive',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Craft Technological Arms and Armor' }],
    activationMode: 'passive',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Craft Technological Item' }],
    activationMode: 'passive',
  ...
  },
  {
    ...
    effects: [
      { type: 'attack_bonus', target: 'robots', value: 1, bonusType: BonusType.UNTYPED, source: "Robot's Bane" },
      { type: 'damage_bonus', target: 'robots', value: 1, bonusType: BonusType.UNTYPED, source: "Robot's Bane" },
      { type: 'ac_bonus', target: 'ac', value: 1, bonusType: BonusType.DODGE, source: "Robot's Bane" },
      { type: 'save_bonus', target: 'robots', value: 1, bonusType: BonusType.UNTYPED, source: "Robot's Bane" },
    ],
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: "Scavenger's Luck" }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    types: ['general'],
    prerequisites: [],
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Technologist' }],
    activationMode: 'passive',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 1, bonusType: BonusType.UNTYPED, target: 'special', source: 'Technology Adept' }],
    activationMode: 'passive',
  ...
  },
  {
    ...
    effects: [
      { type: 'attack_bonus', target: 'attack', value: 2, bonusType: BonusType.MORALE, source: 'Technophobe' },
      { type: 'save_bonus', target: 'all', value: 2, bonusType: BonusType.MORALE, source: 'Technophobe' },
    ],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    shortDescription: 'Extract one more charge from depleted tech batteries (DC 20 Disable Device).',
    source: 'Pathfinder Campaign Setting: Technology Guide',
    types: ['general'],
    prerequisites: [
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Wrest Charge' }],
    activationMode: 'conditional',
