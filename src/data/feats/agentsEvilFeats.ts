    ...
    prerequisites: [
      {
        type: 'special',
        description:
          'Had a valuable item worth at least 1,000 gp per character level stolen by a former ally, been left for dead by a former ally, or have the Wrong Enemy background',
      },
    ],
    effects: [
      {
    ...
    prerequisites: [
      {
        type: 'special',
        description:
          'Have a romantic interest who has fallen to dark influence and rejects you, or have the Bad Romance or Temptation background',
      },
    ],
    effects: [
      {
    ...
    prerequisites: [
      {
        type: 'special',
        description:
          'Failed saving throws against at least five different emotion-manipulating spells or supernatural fear effects, or possess the Sunless or Sole Survivor background',
      },
    ],
    effects: [
      {
    ...
    prerequisites: [
      {
        type: 'special',
        description:
          'Been rendered unconscious and left for dead on a battlefield between warring factions, or possess the Child Soldier or Drafted background',
      },
    ],
    effects: [
      {
    ...
    prerequisites: [
      {
        type: 'special',
        description:
          'Refused an evil creature with at least 15 Hit Dice who offered gifts or assistance, or possess the Planar Offering background',
      },
    ],
    effects: [
      {
    ...
    prerequisites: [
      {
        type: 'special',
        description:
          'Defeated by the same individual, organization, or creature type at least four times, or possess the Boarding School or Humiliated background',
      },
    ],
    effects: [
      {
    ...
    prerequisites: [
      {
        type: 'special',
        description:
          'Purchased a scroll or spellbook containing a spell with the evil descriptor in an illegal location, or possess the Secret Society Inductee or Diabolical Upbringing background',
      },
    ],
    effects: [
      {
