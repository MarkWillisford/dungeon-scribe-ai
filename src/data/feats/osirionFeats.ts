...
export const OSIRION_FEATS: FeatDefinition[] = [
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Black Marketeer' }],
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Conceal Scent' }],
    activationMode: 'passive',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'perception', source: 'Heightened Trap Sense' }],
    activationMode: 'passive',
  ...
  },
  {
    ...
    prerequisites: [],
    effects: [
      { type: 'skill_bonus', target: 'stealth', value: 2, bonusType: BonusType.CIRCUMSTANCE, source: 'Lost in the Crowd' },
      { type: 'ac_bonus', target: 'ac', value: 1, bonusType: BonusType.DODGE, source: 'Lost in the Crowd' },
    ],
  ...
  },
  {
    ...
    shortDescription: '+1 social skills in Osirion; +5 on knowledge/research about ancient Osirion.',
    source: 'Pathfinder Companion: Osirion, Land of the Pharaohs',
    types: ['general'],
    prerequisites: [
    ...
    effects: [
      { type: 'skill_bonus', target: 'bluff', value: 1, bonusType: BonusType.CIRCUMSTANCE, source: 'Osiriontologist' },
      { type: 'skill_bonus', target: 'diplomacy', value: 1, bonusType: BonusType.CIRCUMSTANCE, source: 'Osiriontologist' },
    ],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [
      { type: 'save_bonus', target: 'will', value: 1, bonusType: BonusType.SACRED, source: 'Religious Pilgrim' },
      { type: 'skill_bonus', target: 'diplomacy', value: 1, bonusType: BonusType.SACRED, source: 'Religious Pilgrim' },
      { type: 'skill_bonus', target: 'survival', value: 1, bonusType: BonusType.SACRED, source: 'Religious Pilgrim' },
    ],
    activationMode: 'passive',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Serpent Lash' }],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [{ type: 'special', value: 0, bonusType: BonusType.UNTYPED, target: 'special', source: 'Swarm Dodger' }],
    activationMode: 'conditional',
