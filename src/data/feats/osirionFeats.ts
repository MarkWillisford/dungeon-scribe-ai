...
export const OSIRION_FEATS: FeatDefinition[] = [
  ...
  },
  {
    ...
    prerequisites: [],
    effects: [
      { type: 'bonus', target: 'stealth', value: 2, bonusType: BonusType.CIRCUMSTANCE, source: 'Lost in the Crowd' },
      { type: 'bonus', target: 'ac', value: 1, bonusType: BonusType.DODGE, source: 'Lost in the Crowd' },
    ],
  ...
  },
  {
    ...
    effects: [
      { type: 'bonus', target: 'bluff', value: 1, bonusType: BonusType.CIRCUMSTANCE, source: 'Osiriontologist' },
      { type: 'bonus', target: 'diplomacy', value: 1, bonusType: BonusType.CIRCUMSTANCE, source: 'Osiriontologist' },
    ],
    activationMode: 'conditional',
  ...
  },
  {
    ...
    effects: [
      { type: 'bonus', target: 'will', value: 1, bonusType: BonusType.SACRED, source: 'Religious Pilgrim' },
      { type: 'bonus', target: 'diplomacy', value: 1, bonusType: BonusType.SACRED, source: 'Religious Pilgrim' },
      { type: 'bonus', target: 'survival', value: 1, bonusType: BonusType.SACRED, source: 'Religious Pilgrim' },
    ],
    activationMode: 'passive',
