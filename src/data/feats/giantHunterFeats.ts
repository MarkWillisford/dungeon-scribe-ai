...
export const GIANT_HUNTERS_HANDBOOK_FEATS: FeatDefinition[] = [
  {
    ...
    shortDescription: 'Control splash damage placement when hitting Large or larger targets with splash weapons.',
  ...
  },
  {
    ...
    shortDescription: 'Deliberately provoke attacks of opportunity after a 5-foot step, gaining +4 dodge AC against them.',
    source: "Pathfinder Player Companion: Giant Hunter's Handbook",
    types: ['combat'],
    prerequisites: [
  ...
  },
  {
    ...
    shortDescription: 'Use an immediate action to grab or reposition a disarmed weapon when your ally disarms a foe.',
    source: "Pathfinder Player Companion: Giant Hunter's Handbook",
  ...
  },
  {
    ...
    shortDescription: 'Story feat granting bonuses against a chosen giant type, with expanding benefits as you defeat more giants.',
    source: "Pathfinder Player Companion: Giant Hunter's Handbook",
    types: ['story'],
    prerequisites: [
      { type: 'special', description: 'Must have been knocked unconscious by a challenging giant, or must have the Giant Foe or Giantslayer Scion regional or campaign trait' },
    ],
    effects: [
      {
        type: 'bonus',
  ...
  },
  {
    ...
    shortDescription: 'Add half your favored enemy (giants) bonus to spell save DCs and CL checks vs. giants.',
    source: "Pathfinder Player Companion: Giant Hunter's Handbook",
    types: ['general'],
    prerequisites: [
  ...
  },
  {
    ...
    shortDescription: 'Treat your reach weapon as having brace against Large or larger foes; hits impose a -2 attack penalty.',
    source: "Pathfinder Player Companion: Giant Hunter's Handbook",
    types: ['combat'],
    prerequisites: [
  ...
  },
  {
    ...
    shortDescription: '+2 competence bonus to CMD against awesome blow, bull rush, drag, reposition, and trip from larger foes.',
    source: "Pathfinder Player Companion: Giant Hunter's Handbook",
    types: ['combat'],
    prerequisites: [
    ...
    effects: [
      {
        type: 'cmd_bonus',
        target: 'vs_maneuvers_from_larger_foes',
        value: 2,
  ...
  },
  {
    ...
    shortDescription: 'Charge attacks against larger foes deal damage as one size larger; +2 to Stunning Fist DC on such charges.',
    source: "Pathfinder Player Companion: Giant Hunter's Handbook",
    types: ['combat'],
    prerequisites: [
  ...
  },
  {
    ...
    shortDescription: "Sacrifice sneak attack dice (2d6 per +1) to increase a delivered poison's save DC.",
    source: "Pathfinder Player Companion: Giant Hunter's Handbook",
    types: ['combat'],
    prerequisites: [
  ...
  },
  {
    ...
    shortDescription: 'Crawl at half speed, take 5-ft steps while crawling, and avoid AoOs from larger foes while crawling.',
    source: "Pathfinder Player Companion: Giant Hunter's Handbook",
    types: ['general'],
    prerequisites: [],
    effects: [],
  ...
  },
  {
    ...
    shortDescription: '+4 dodge AC vs. hurled rocks and similar projectiles when an ally with this feat is nearby; Reflex save for half damage on a hit.',
    source: "Pathfinder Player Companion: Giant Hunter's Handbook",
    types: ['teamwork'],
    prerequisites: [],
    effects: [
  ...
  },
  {
    ...
    shortDescription: "When you suppress a foe's regeneration, allies with this feat can attack to extend the suppression by 1 round each.",
    source: "Pathfinder Player Companion: Giant Hunter's Handbook",
    types: ['combat', 'teamwork'],
    prerequisites: [],
    effects: [],
  ...
  },
  {
    ...
    shortDescription: 'Use a move action to reposition a willing ally with this feat to any adjacent square.',
    source: "Pathfinder Player Companion: Giant Hunter's Handbook",
    types: ['teamwork'],
    prerequisites: [
  ...
  },
  {
    ...
    shortDescription: 'Metamagic: cast ray spells from your forehead (no somatic component) and gain regeneration 1 for rounds equal to spell level; uses a slot 3 levels higher.',
    source: "Pathfinder Player Companion: Giant Hunter's Handbook",
    types: ['metamagic'],
    prerequisites: [
