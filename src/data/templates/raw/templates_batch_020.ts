// Batch 020 | first: 'Waxwork Creature' | last: 'Zombie, Slime' | count: 17
...
export const TEMPLATES_BATCH_020: TemplateDefinition[] = [
    ...
    features: [
      {
        ...
        description: 'A waxwork creature restores 5 hit points per round. A waxwork creature with 11 or more HD restores 10 hit points per round. Fire damage disables this regeneration for 1 round after the creature is hit. The creature becomes staggered at 0 HP instead of destroyed while regenerating, and ignores damage that would reduce it below 0 HP.',
      },
      {
        scalingType: 'flat',
        name: 'Freeze (Ex)',
        description: 'A waxwork creature can hold itself so still it appears to be a wax sculpture. A waxwork creature that uses freeze can take 20 on Stealth checks to hide in plain sight as a wax sculpture.',
      },
      {
        scalingType: 'flat',
        name: 'Construct Traits',
        description: 'A waxwork creature gains all standard construct immunities and traits, including immunity to cold damage. It has no Constitution score (Wisdom and Charisma become 10). Racial HD convert to d10s with bonus HP by size (Small +10, Medium +20, Large +30, Huge +40, Gargantuan +60, Colossal +80). BAB equals HD. All saves equal +1/3 HD.',
      },
    ],
    ...
    features: [
      {
        ...
        description: 'The whispering phantasm forms a bond with a creature, usually a humanoid of the Material Plane. The bonded victim can always perceive the whispering phantasm regardless of what plane either is on. They communicate via a constant telepathic bond or whispering wind with no distance or planar limit. The bond is released if the phantasm is bound (the victim becomes permanently immune). Forming a new bond requires 24 uninterrupted hours of meditation.',
      },
      {
        scalingType: 'flat',
        name: 'Ethereal Ambush (Ex)',
        description: 'During the surprise round, when a whispering phantasm shifts from the Ethereal Plane to the plane of its bonded victim, it gains a full round of actions rather than only a standard action.',
      },
      {
        scalingType: 'flat',
        name: 'Ethereal Jaunt (Su)',
        description: 'The whispering phantasm can shift from the Ethereal Plane to the plane its bonded victim is on as a free action (even if the planes are not normally connected) and back again as a move action. Otherwise functions as the ethereal jaunt spell (CL 15th).',
      },
      {
        scalingType: 'flat',
        name: 'Ethereal Stealth (Su)',
        description: 'While ethereal, detection effects (detect invisibility, detect magic, true seeing, etc.) automatically fail unless a successful caster level check (DC 15 + phantasm\'s CR) is made. Effects without a caster level require a Will save (DC 10 + 1/2 HD + Charisma modifier).',
      },
      {
        scalingType: 'flat',
        name: 'Natural Invisibility',
        description: 'The whispering phantasm is naturally invisible unless it chooses to manifest to its bonded victim.',
      },
      {
        scalingType: 'flat',
        name: 'Bound Flaw (Weakness)',
        description: 'A binding spell cast on the bonded victim affects the phantasm instead. The binding spell\'s DC increases by 4 and automatically overcomes immunities and spell resistance. The binding imprisons the phantasm on the Ethereal Plane for one year and one day, negating its abilities; afterward it remains trapped until the binding\'s focus is destroyed.',
      },
    ],
    ...
    features: [
      {
        ...
        description: 'A wight\'s slam or natural weapon attacks inflict one negative level on a hit. The Will save DC to remove the negative level is 10 + 1/2 HD + Charisma modifier.',
      },
      {
        scalingType: 'flat',
        name: 'Create Spawn (Su)',
        description: 'Any humanoid slain by the wight rises as a wight in 1d4 rounds. Spawn have a –2 penalty to all d20 rolls and checks and –2 HP per HD. Spawn are enslaved to the creator until its death, whereupon they become independent wights.',
      },
      {
        scalingType: 'flat',
        name: 'Resurrection Vulnerability (Su)',
        description: 'A raise dead or similar spell cast on the wight destroys it (Will negates). The wight does not gain a saving throw if it is helpless.',
      },
      {
        scalingType: 'flat',
        name: 'Undead Traits',
        description: 'No Constitution score; uses Charisma modifier for bonus HP. Racial HD convert to d8s. Class-level HD, BAB, and saves are unchanged. Gains darkvision 60 ft. and +8 racial bonus on Stealth checks. Gains Blind-Fight as a bonus feat.',
      },
    ],
    sourceInfo: { type: 'third_party', publisher: 'AndyCollins.net', publication: 'Wight Template (web)' },
    verificationStatus: 'needs_review',
    visibility: 'global',
    rev: 1,
  },
    ...
    features: [
      {
        ...
        description: 'Creatures struck by the winter-touched fey\'s natural or manufactured weapon attacks must succeed at a Fortitude save (DC is Constitution-based) or become staggered for 1 round.',
      },
    ],
    sourceInfo: { type: 'official', publication: 'Pathfinder Adventure Path #67: The Snows of Summer' },
    verificationStatus: 'needs_review',
    visibility: 'global',
    rev: 1,
  },
    ...
    features: [
      {
        ...
        description: 'The wishtouched gains a +4 inherent bonus to one ability score, typically associated with the nature of its granted wish.',
      },
      {
        scalingType: 'flat',
        name: 'Spell-Like Abilities (Su)',
        description: 'Once per day, CL equals base creature\'s HD. By HD range: 1–3 HD: faerie fire; 4–6 HD: silence; 7–9 HD: gravity bow; 9–13 HD: lesser geas; 14–16 HD: life bubble; 17+ HD: voidflight (transmutation, grants vacuum flight at Speed 1 with varying acceleration, minimum 50 ft./round atmospheric flight at CL 1, scaling to 250 ft. at CL 20+).',
      },
      {
        scalingType: 'flat',
        name: 'Starquiet',
        description: 'The wishtouched progressively loses its voice as it ages. At adulthood it becomes soft-spoken; all hearing-dependent abilities function at half their normal range. At middle age it becomes completely mute; verbal spell components are replaced with emotional components.',
      },
      {
        scalingType: 'flat',
        name: 'Fey Magic Vulnerability',
        description: 'The wishtouched takes a –3 penalty on saving throws against the spells and spell-like abilities of fey, and against fey-touched celestial phenomena.',
      },
    ],
    sourceInfo: { type: 'third_party', publisher: 'd20pfsrd.com Publishing', publication: 'Wishtouched (3pp)' },
    verificationStatus: 'needs_review',
    visibility: 'global',
    rev: 1,
  },
    ...
    features: [
      {
        ...
        description: 'Immune to critical hits and flanking. Takes 150% damage from area effects. Becomes staggered at 0 HP and dying at negative HP. Immune to single-target spells (except those cast by itself). Gains blindsight 30 ft. and darkvision 60 ft.',
      },
      {
        scalingType: 'flat',
        name: 'Discorporate',
        description: 'As a standard action the worm that walks can collapse into a true swarm with Strength 1, losing defensive abilities but gaining standard swarm traits (including swarm damage and immunity to weapon damage). It can reform into its normal body as a full-round action while at 1 or more HP.',
      },
      {
        scalingType: 'flat',
        name: 'Squirming Embrace (Ex)',
        description: 'While grappling a creature, the worm that walks can deal its swarm damage as a swift action. The grappled creature must make a Fortitude save (DC 10 + 1/2 HD + Con modifier) or become nauseated for 1 round.',
      },
      {
        scalingType: 'flat',
        name: 'Tenacious (Ex)',
  ...
  // 483. Wrathful Creature (CR +1)
  {
    ...
    features: [
      ...
      },
      {
        scalingType: 'flat',
        name: 'Blood Feud (Ex)',
        description: 'Upon killing its chosen foe, the wrathful creature loses this template. The template immediately transfers to the closest blood relative or close friend of the slain foe.',
      },
      {
        scalingType: 'flat',
        name: 'Cold Vengeance (Ex)',
        description: 'Once per day as a free action, the wrathful creature gains the benefit of any single barbarian rage power, using its Hit Dice as its barbarian level, without suffering the rage penalties.',
      },
      {
        scalingType: 'flat',
        name: 'Discern Kith (Sp)',
        description: 'Once per day, the wrathful creature learns the name, relationship, and location of one of its chosen foe\'s allies, as per discern location.',
      },
      {
        scalingType: 'flat',
        name: 'Disproportionate Retribution (Ex)',
        description: 'Once per day as part of a melee attack action, the wrathful creature deals damage equal to 150% of the damage dealt to it by a single attack within the last round, replacing all normal damage and effects.',
      },
      {
        scalingType: 'flat',
        name: 'Taking You With Me (Su)',
        description: 'When killed by its chosen foe, the wrathful creature explodes, dealing 5 points of damage per Hit Die (half fire, half divine) to all creatures within 10 feet per HD. A Reflex save (DC 10 + 1/2 HD + Con modifier) halves the damage.',
      },
      {
        scalingType: 'flat',
        name: 'Vengeful List (Su)',
        description: 'Against its chosen foes, the wrathful creature\'s weapons gain the bane property. At CR 15+, the enhancement bonus increases by 2 with an additional +3d6 damage. Critical hits force a Fortitude save (DC 10 + 1/2 HD + Con modifier) or the victim takes 10 damage per HD (this effect ignores critical immunity). At CR 15+, it also affects later-added foes.',
      },
      {
        scalingType: 'flat',
        name: 'Worse than Death (Su)',
        description: 'The wrathful creature can negate lethal damage or effects to instead render the opponent permanently unconscious. It may also scar, blind, remove appendages, or suppress the victim\'s abilities or magic item use. This curse is removed by break enchantment, limited wish, miracle, remove curse, or wish cast by a divine caster whose CL exceeds the wrathful creature\'s CR and whose deity governs mercy.',
      },
    ],
    sourceInfo: { type: 'third_party', publisher: 'Rite Publishing', publication: 'Pathways Bestiary' },
    verificationStatus: 'needs_review',
    ...
    features: [
      {
        ...
        description: 'Any creature attempting to strike or cast a targeted spell at the wretched creature must make a Will save (DC based on Wisdom). On a failed save, the attack or spell fails and the action is lost. On a success, the creature may attack and is immune to this ability for 24 hours.',
      },
      {
        scalingType: 'flat',
        name: 'Gloom Touch (Su)',
        description: 'The wretched creature transmits the disease gloomtouch with a successful touch or natural attack.',
      },
      {
        scalingType: 'flat',
        name: 'Type Change (Animals Only)',
        description: 'Animal base creatures become magical beasts when this template is applied. Humanoids and monstrous humanoids retain their original type.',
      },
    ],
  ...
  // 485. Wyrmskull (CR varies — decreases from base)
  {
    ...
    abilityScoreChangeNote: 'Dexterity +4 from size reduction (typically). Constitution score eliminated (undead).',
    damageReduction: { scalingType: 'flat', value: 5, bypassedBy: 'bludgeoning' },
    features: [
      {
        scalingType: 'flat',
        name: 'Ghostlight (Su)',
        description: "The wyrmskull's bite ignores the incorporeal miss chance and adds 1d6 energy damage matching its breath weapon type. Creatures hit are limned with faerie fire for 1 minute.",
      },
      {
        scalingType: 'flat',
        name: 'Speiro (Su)',
        description: 'Once per week, the wyrmskull can create skeletal warriors equal in number to its age category. Warriors possess the wyrmskull\'s fast healing 5, damage reduction, spell resistance, and breath weapon immunity. The effect lasts 1 hour.',
      },
      {
        scalingType: 'flat',
        name: 'Lorewarden (Ex)',
        description: 'The wyrmskull gains bardic knowledge as a bard whose level equals half the wyrmskull\'s Hit Dice.',
      },
      {
        scalingType: 'flat',
        name: 'Spell-Like Abilities (Su)',
        description: 'Once per day each: legend lore, speak with dead, whispering wind. The wyrmskull also retains the base creature\'s spell-like abilities.',
      },
      {
        scalingType: 'flat',
        name: 'Telepathy',
        description: 'The wyrmskull can communicate telepathically with any creature within 100 feet that shares a language.',
      },
    ],
    sourceInfo: { type: 'official', publication: 'Pathfinder Adventure Path #22: The End of Eternity' },
    verificationStatus: 'needs_review',
    visibility: 'global',
    rev: 1,
  },
    ...
    features: [
      {
        ...
        description: 'Grants fortification against critical hits and sneak attacks. 1–4 HD: 25%; 5–10 HD: 50%; 11+ HD: 75%.',
      },
      {
        scalingType: 'flat',
        name: 'True Strike (Su)',
        description: 'Once per day as a swift action, the xenoid creature can gain the benefit of true strike (+20 insight bonus on its next attack roll).',
      },
      {
        scalingType: 'flat',
      ...
      },
      {
        ...
        description: 'The xenoid must remain in its natural (non-true) form for no more than a number of hours equal to its Constitution score. After that time it must make a Will save (DC 15, +1 per additional hour) or become confused for 1d6 rounds and involuntarily transform.',
      },
      {
        scalingType: 'flat',
        name: 'Toxic Reality (Ex, Weakness)',
        description: 'While in its unnatural true form, the xenoid takes 1d6 nonlethal damage per hour and cannot heal nonlethal damage until it returns to its natural form or enters an alien environment.',
      },
    ],
    srFormula: 'new CR + 5',
    resistances: [
  ...
  // 487. Yellow Musk Zombie (CR +0)
  {
    ...
    abilityScoreChangeNote: 'Dexterity –4 (minimum 8). Intelligence set to 2, Wisdom set to 10, Charisma set to 1.',
    features: [
      {
        scalingType: 'flat',
        name: 'Link to Creator (Ex)',
        description: 'A yellow musk zombie cannot move more than 200 feet away from the yellow musk creeper that created it.',
      },
      {
        scalingType: 'flat',
        name: 'Sprout New Creeper (Ex)',
        description: 'After approximately 2 months of existence, the yellow musk zombie wanders up to 1 mile from its creator, collapses, and dies. Within one hour, new yellow musk creepers sprout from its corpse.',
      },
    ],
    sourceInfo: { type: 'third_party', publisher: 'Necromancer Games / Frog God Games', publication: 'Tome of Horrors Complete' },
    verificationStatus: 'needs_review',
    visibility: 'global',
    rev: 1,
  },
  ...
  // 488. Zombie (CR varies)
  {
    ...
    abilityScoreChangeNote: 'Constitution and Intelligence scores are lost (undead). Wisdom and Charisma set to 10.',
    damageReduction: { scalingType: 'flat', value: 5, bypassedBy: 'slashing' },
    immunities: ['undead immunities (cold, nonlethal damage, paralysis, sleep, stunning, disease, death effects)'],
    features: [
      {
        scalingType: 'flat',
        name: 'Staggered (Ex)',
        description: 'Zombies have poor reflexes and can only perform a single move action or standard action each round. A zombie can move up to its speed and attack in the same round as a charge action.',
      },
      {
        scalingType: 'flat',
        name: 'Undead Traits',
        description: 'No Constitution score (Wisdom and Charisma set to 10, HP from Charisma modifier). Racial HD become d8s. All skills and feats lost; gains Toughness as a bonus feat. No additional feats from HD increases. Natural armor increases by size: Tiny/smaller +0, Small +1, Medium +2, Large +3, Huge +4, Gargantuan +7, Colossal +11.',
      },
      {
        scalingType: 'flat',
        name: 'Variant: Fast Zombie',
        description: 'Speed +10 ft.; no DR 5/slashing; gains Quick Strikes (additional slam attack on a full attack); Dex +2 instead of –2; loses the staggered condition.',
      },
      {
        scalingType: 'flat',
        name: 'Variant: Plague Zombie',
        description: 'No DR 5/slashing. Death Burst: explodes on death, exposing adjacent creatures to zombie rot disease. Disease (zombie rot): Fort save DC 10 + 1/2 HD + Cha modifier; onset 1d4 days; 1d2 Con damage/day; cured by 2 consecutive saves. Corpses rise as plague zombies in 2d6 hours.',
      },
    ],
  ...
  // 489. Zombie Lord (CR +1)
  {
    ...
    abilityScoreChangeNote: 'Constitution score is lost (undead). Racial HD convert to d8s and +2 racial HD are added.',
    damageReduction: { scalingType: 'flat', value: 5, bypassedBy: 'slashing' },
    ...
    features: [
      {
        scalingType: 'flat',
        name: 'Undead Mastery',
        description: 'Unlike common zombies, zombie lords do not gain the staggered condition. They retain their intelligence (minimum 3) and full action economy. Channel resistance +4. Skills: 4 + Int modifier per racial HD.',
      },
      {
        scalingType: 'flat',
        name: 'Bonus Hit Dice',
        description: 'The zombie lord gains 2 additional racial Hit Dice (d8s). Creatures without racial HD gain 2 undead HD instead.',
      },
    ],
    sourceInfo: { type: 'official', publication: 'Pathfinder Roleplaying Game Bestiary 4' },
    verificationStatus: 'needs_review',
  ...
  // 490. Zombie, Juju (CR +1 or +2) [TOHC version]
  {
    ...
    abilityScoreChangeNote: 'Intelligence set to 4, Wisdom set to 10, Constitution score lost (undead). CR: base creature if 5 HD or fewer; +1 at 6–10 HD; +2 at 11+ HD.',
    damageReduction: {
      scalingType: 'hd_tiered',
      tiers: [
    ...
    features: [
      ...
      },
      {
        scalingType: 'flat',
        name: 'Slam Attack',
        description: 'Gains a slam attack dealing damage as if one size category larger (Medium = 1d6). Natural weapons function as magic for overcoming DR.',
      },
      {
        scalingType: 'flat',
        name: 'Bonus Feats and Skills',
        description: 'Gains Improved Initiative and Toughness. Gains a +8 racial bonus on Climb checks. Flight maneuverability (if applicable) drops to clumsy.',
      },
    ],
    sourceInfo: { type: 'third_party', publisher: 'Necromancer Games / Frog God Games', publication: 'Tome of Horrors Complete' },
    verificationStatus: 'needs_review',
  ...
  // 491. Zombie, Juju (CR +1) [Bestiary 2 version]
  {
    ...
    abilityScoreChangeNote: 'Constitution replaced by Charisma for HP and saves (undead). Natural armor +3 over base creature.',
    ...
    features: [
      ...
      },
      {
        scalingType: 'flat',
        name: 'Slam Attack',
        description: 'Gains a slam attack dealing damage as if one size category larger. Natural weapons are treated as magic for overcoming DR.',
      },
      {
        scalingType: 'flat',
        name: 'Bonus Feats and Skills',
        description: 'Gains Improved Initiative and Toughness as bonus feats. Gains +8 racial bonus on Climb checks. Flight maneuverability (if applicable) drops to clumsy; magical flight is unaffected.',
      },
    ],
    sourceInfo: { type: 'official', publication: 'Pathfinder Roleplaying Game Bestiary 2' },
    verificationStatus: 'needs_review',
  ...
  // 492. Zombie, Slime (CR varies)
  {
    ...
    abilityScoreChangeNote: 'Intelligence set to 2, Wisdom set to 10, Charisma set to 1. Class levels dropped; remaining dice doubled and converted to d8s.',
    damageReduction: {
      scalingType: 'hd_tiered',
      tiers: [
    ...
    features: [
      {
        scalingType: 'flat',
        name: 'Infestation (Ex)',
        description: 'Any creature hit by the slime zombie\'s slam attack must succeed on a Fortitude save (DC based on Constitution) or become infested with olive slime.',
      },
      {
        scalingType: 'flat',
        name: 'Death Throes (Ex)',
        description: 'Upon reaching 0 hit points, the slime zombie transforms in a single round into a pool of olive slime.',
      },
      {
        scalingType: 'flat',
        name: 'Mind Link (Su)',
        description: 'The slime zombie has a symbiotic connection with its creator olive slime, allowing communication over up to 200 miles on the same plane.',
      },
      {
        scalingType: 'flat',
        name: 'Telepathic Bond (Su)',
        description: 'The slime zombie can communicate with other slime zombies created by the same olive slime within 100 feet.',
      },
      {
        scalingType: 'flat',
