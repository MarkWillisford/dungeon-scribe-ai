...
export const HELLS_VENGEANCE_TRAITS: TraitDefinition[] = [
  // ==================== CAMPAIGN TRAITS — Hell's Vengeance ====================
  {
    ...
    shortDescription: '+1 Sense Motive; class skill; 1/day appear neutral vs good effects targeting evil',
  ...
  },
  {
    ...
    shortDescription: 'Summon monster +1 round for devils; +1 Cha checks vs planar binding devils; 10% cheaper planar ally',
    source: "Hell's Vengeance Player's Guide",
    category: 'campaign',
    subcategory: "Hell's Vengeance",
    prerequisites: [],
  ...
  },
  {
    ...
    shortDescription: '+1 Diplomacy, Knowledge (planes), Knowledge (religion); one is class skill; gain Infernal language',
    source: "Hell's Vengeance Player's Guide",
    category: 'campaign',
    subcategory: "Hell's Vengeance",
    prerequisites: [],
  ...
  },
  {
    ...
    shortDescription: '+1 Knowledge (nobility); class skill; +1 Cha checks vs nobles; Noble Scion needs no Cha prereq; starting equipment',
    source: "Hell's Vengeance Player's Guide",
    category: 'campaign',
    subcategory: "Hell's Vengeance",
    prerequisites: [],
  ...
  },
  {
    ...
    shortDescription: 'Choose: +1 attack and damage vs Iomedae followers, or +1 spell save DC vs same',
    source: "Hell's Vengeance Player's Guide",
    category: 'campaign',
    subcategory: "Hell's Vengeance",
    prerequisites: [],
    ...
    choices: [
      {
        ...
        options: ['+1 attack and damage rolls vs followers of Iomedae', '+1 save DC of spells vs followers of Iomedae'],
        affectsEffects: true,
  ...
  },
  {
    ...
    shortDescription: '+1 Bluff; class skill; 1/day reroll Will save when adjacent to a Chelish human ally',
    source: "Hell's Vengeance Player's Guide",
    category: 'campaign',
    subcategory: "Hell's Vengeance",
  ...
  },
  {
    ...
    shortDescription: '+1 Knowledge (planes); class skill; proficiency with chosen Hellknight order weapon; +1 CMD vs sunder/disarm for that weapon',
    source: "Hell's Vengeance Player's Guide",
    category: 'campaign',
    subcategory: "Hell's Vengeance",
    prerequisites: [],
  ...
  },
  {
    ...
    shortDescription: '+1 Knowledge (planes); class skill; gain Infernal; +2 Will saves vs mind-affecting from good outsiders',
    source: "Hell's Vengeance Player's Guide",
    category: 'campaign',
    subcategory: "Hell's Vengeance",
    prerequisites: [],
