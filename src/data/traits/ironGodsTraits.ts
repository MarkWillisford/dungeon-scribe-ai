...
export const IRON_GODS_TRAITS: TraitDefinition[] = [
...

  {
    ...
    tags: ['numeria', 'torch', 'technology', 'disable-device', 'knowledge-engineering', 'technologist'],
  },

  {
    ...
    effects: [
      ...
      },
      {
        type: 'special',
        bonusType: BonusType.UNTYPED,
        target: 'technology_glitch_roll',
        value: 0,
        source: 'Numerian Archaeologist',
        condition: {
          type: 'custom',
          description: 'Roll twice for glitches when using timeworn technological items and choose the result',
          params: {},
        },
      },
    ],
...

  {
    ...
    shortDescription:
      '+1 attack rolls vs. robots; +1 dodge bonus to AC vs. robot attacks.',
    source: "Iron Gods Player's Guide",
    category: 'campaign',
    subcategory: 'Iron Gods',
    prerequisites: [],
...

  {
    ...
    effects: [
      ...
      },
      {
        type: 'special',
        bonusType: BonusType.UNTYPED,
        target: 'technologist_feat_alien_id',
        value: 0,
        source: 'Stargazer',
        condition: {
          type: 'custom',
          description: 'Treated as having Technologist feat for identifying alien creatures and Knowledge (geography) checks',
          params: {},
        },
      },
    ],
