...
export const HELLS_REBELS_TRAITS: TraitDefinition[] = [
  // ==================== CAMPAIGN TRAITS — Hell's Rebels ====================
  {
    ...
    shortDescription: '+1 Knowledge (nobility); class skill; Noble Scion feat loses Charisma prerequisite',
  ...
  },
  {
    ...
    shortDescription: '+1 one Perform skill; all Perform class skills; +1 DC on language-dependent effects',
    source: "Hell's Rebels Player's Guide",
    category: 'campaign',
    subcategory: "Hell's Rebels",
    prerequisites: [],
  ...
  },
  {
    ...
    shortDescription: 'Choose: +1 attack and damage, or +1 spell save DCs vs House Thrune and Asmodeus worshipers',
    source: "Hell's Rebels Player's Guide",
    category: 'campaign',
    subcategory: "Hell's Rebels",
    prerequisites: [],
    ...
    choices: [
      {
        ...
        options: ['Attack and damage bonus', 'Spell save DC bonus vs House Thrune and Asmodeus worshipers'],
        affectsEffects: true,
  ...
  },
  {
    ...
    shortDescription: '+1 Disguise; class skill; aura suppression vs detect spells; +1 saves vs mind-affecting',
    source: "Hell's Rebels Player's Guide",
    category: 'campaign',
    subcategory: "Hell's Rebels",
    prerequisites: [],
  ...
  },
  {
    ...
    shortDescription: '+1 Stealth; class skill; +2 on one Silver Ravens Organization check per phase',
    source: "Hell's Rebels Player's Guide",
    category: 'campaign',
    subcategory: "Hell's Rebels",
    prerequisites: [],
  ...
  },
  {
    ...
    shortDescription: 'Treat Cha as 14 (or +2) for rebellion teams; +1 Leadership score if you take Leadership feat',
    source: "Hell's Rebels Player's Guide",
    category: 'campaign',
    subcategory: "Hell's Rebels",
    prerequisites: [],
  ...
  },
  {
    ...
    shortDescription: '+1 Perception; class skill; +1 DC on illusion (pattern) spells; +1 saves vs illusions',
    source: "Hell's Rebels Player's Guide",
    category: 'campaign',
    subcategory: "Hell's Rebels",
    prerequisites: [],
  ...
  },
  {
    ...
    shortDescription: '+1 Knowledge (local); once per day roll twice on one ability score type skill check',
    source: "Hell's Rebels Player's Guide",
    category: 'campaign',
    subcategory: "Hell's Rebels",
    prerequisites: [],
    ...
    choices: [
      {
        ...
        options: ['Jackdaw (Intelligence)', 'Jilia Bainilus (Wisdom)', 'Octavio Sabinus (Strength)', 'Shensen (Charisma)', 'Strea Vestori (Dexterity)'],
        affectsEffects: true,
        effectTargetTemplate: 'special.{choice}',
      },
    ],
  ...
  },
  {
    ...
    shortDescription: '+1 on one Knowledge skill tied to chosen mystery; class skill; once per day roll twice',
    source: "Hell's Rebels Player's Guide",
    category: 'campaign',
    subcategory: "Hell's Rebels",
    prerequisites: [],
