...
// special material items (no enhancement bonus) and do not fit MagicArmorDefinition.
// They should be represented in the mundane/special materials equipment data instead.

export const specificShieldsBatch1: MagicArmorDefinition[] = [
  {
    ...
    baseArmorId: 'light_wooden_shield', enhancementBonus: 1, armorSpecialAbilities: [],
  },
  {
    id: 'shield-spined',
    name: 'Spined Shield',
  ...
  },
  {
    ...
    activationCategory: 'use_activated', effects: [],
    baseArmorId: 'heavy_steel_shield', enhancementBonus: 2, armorSpecialAbilities: [],
  },
  {
