...
export const wondrousItemsMP7: WondrousItemDefinition[] = [
  ...
  {
    id: 'wondrous-pearl-of-power-4th',
    ...
    price: 16000,
    weight: 0,
    description: 'As Pearl of Power (1st), but recalls a spell of 4th level or lower.',
    construction: { feats: ['Craft Wondrous Item'], spells: ['creator must be able to cast 4th-level spells'], cost: 8000 },
    physicalStats: { hardness: 0, hitPoints: 1, breakDC: 10 },
    activationCategory: 'use_activated',
    effects: [{ type: 'special', target: 'special.pearl_of_power_recall', value: 0, source: 'Pearl of Power (4th)' }],
  },
  {
    id: 'wondrous-pearl-of-power-5th',
    ...
    price: 25000,
    weight: 0,
    description: 'As Pearl of Power (1st), but recalls a spell of 5th level or lower.',
    construction: { feats: ['Craft Wondrous Item'], spells: ['creator must be able to cast 5th-level spells'], cost: 12500 },
    physicalStats: { hardness: 0, hitPoints: 1, breakDC: 10 },
    activationCategory: 'use_activated',
    effects: [{ type: 'special', target: 'special.pearl_of_power_recall', value: 0, source: 'Pearl of Power (5th)' }],
  },
  {
    id: 'wondrous-pearl-of-power-6th',
    ...
    price: 36000,
    weight: 0,
    description: 'As Pearl of Power (1st), but recalls a spell of 6th level or lower.',
    construction: { feats: ['Craft Wondrous Item'], spells: ['creator must be able to cast 6th-level spells'], cost: 18000 },
    physicalStats: { hardness: 0, hitPoints: 1, breakDC: 10 },
    activationCategory: 'use_activated',
    effects: [{ type: 'special', target: 'special.pearl_of_power_recall', value: 0, source: 'Pearl of Power (6th)' }],
  },
  {
    id: 'wondrous-pearl-of-power-7th',
    ...
    price: 49000,
    weight: 0,
    description: 'As Pearl of Power (1st), but recalls a spell of 7th level or lower.',
    construction: { feats: ['Craft Wondrous Item'], spells: ['creator must be able to cast 7th-level spells'], cost: 24500 },
    physicalStats: { hardness: 0, hitPoints: 1, breakDC: 10 },
    activationCategory: 'use_activated',
    effects: [{ type: 'special', target: 'special.pearl_of_power_recall', value: 0, source: 'Pearl of Power (7th)' }],
  },
  {
    id: 'wondrous-pearl-of-power-8th',
    ...
    price: 64000,
    weight: 0,
    description: 'As Pearl of Power (1st), but recalls a spell of 8th level or lower.',
    construction: { feats: ['Craft Wondrous Item'], spells: ['creator must be able to cast 8th-level spells'], cost: 32000 },
    physicalStats: { hardness: 0, hitPoints: 1, breakDC: 10 },
    activationCategory: 'use_activated',
    effects: [{ type: 'special', target: 'special.pearl_of_power_recall', value: 0, source: 'Pearl of Power (8th)' }],
  },
  {
    id: 'wondrous-pearl-of-power-9th',
    ...
    price: 81000,
    weight: 0,
    description: 'As Pearl of Power (1st), but recalls a spell of 9th level or lower.',
    construction: { feats: ['Craft Wondrous Item'], spells: ['creator must be able to cast 9th-level spells'], cost: 40500 },
    physicalStats: { hardness: 0, hitPoints: 1, breakDC: 10 },
    activationCategory: 'use_activated',
    effects: [{ type: 'special', target: 'special.pearl_of_power_recall', value: 0, source: 'Pearl of Power (9th)' }],
  },
  {
    id: 'wondrous-pearl-of-power-two-spells',
    ...
    weight: 0,
    description:
      'As Pearl of Power (1st), but allows the spellcaster to recall two different spells that they had prepared and then cast, ' +
      'provided both spells are of 6th level or lower.',
    construction: { feats: ['Craft Wondrous Item'], spells: ['creator must be able to cast 6th-level spells'], cost: 35000 },
    physicalStats: { hardness: 0, hitPoints: 1, breakDC: 10 },
    activationCategory: 'use_activated',
    effects: [{ type: 'special', target: 'special.pearl_of_power_recall', value: 0, source: 'Pearl of Power (Two Spells)' }],
  },
  {
