...
export const anglerfish: AnimalCompanionEntry = {
  ...
  specialQualities: [
    ...
    'grab (Medium)',
    'low-light vision',
    'lure (sheds light as per a candle)',
    'scent',
  ],
  progressionTiers: [
    {
...
export const assassinBugGiant: AnimalCompanionEntry = {
  ...
  specialQualities: [
    'darkvision 60 ft.',
    'poison (frequency 1 round [4]; effect 1d2 Dex; cure 1 save; Con-based DC)',
    'poison stream (15-ft. line, Reflex negates; usable every 1d4 rounds)',
    'CMD +8 vs. trip',
  ],
  progressionTiers: [
    {
...
export const caterpillarGiant: AnimalCompanionEntry = {
  ...
  specialQualities: [
    'compression',
    'darkvision 60 ft.',
    'poison (frequency 1 round [4]; effect 1d2 Str; cure 1 save; Con-based DC)',
    'CMD cannot be tripped',
  ],
  progressionTiers: [
    {
      atDruidLevel: 4,
...
export const corpseEaterFungus: AnimalCompanionEntry = {
  ...
  specialQualities: [
    'darkvision 60 ft.',
    'spit acid (ranged touch attack, 30-ft. range, 1d6 acid)',
    'CMD +12 vs. trip',
  ],
  progressionTiers: [
    {
...
export const creepingPuffball: AnimalCompanionEntry = {
  ...
  specialQualities: [
    'darkvision 60 ft.',
    'poison (frequency 1 round [4]; effect 1d2 Wis and dazzled; cure 1 save; Con-based DC)',
    'defensive puff (1/minute as immediate action, exposes adjacent creature to poison)',
    'CMD cannot be tripped',
  ],
  progressionTiers: [
    {
