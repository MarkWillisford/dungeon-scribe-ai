...
function blankDraft(): CharacterDraft {
  return {
    ...
    background: '',
    abilities: {
      str: { base: 16, racial: 0, inherent: 0, enhancement: 0, other: [], levelIncrements: 0 },
      dex: { base: 12, racial: 0, inherent: 0, enhancement: 0, other: [], levelIncrements: 0 },
      con: { base: 14, racial: 0, inherent: 0, enhancement: 0, other: [], levelIncrements: 0 },
      ...
      cha: { base: 8, racial: 0, inherent: 0, enhancement: 0, other: [], levelIncrements: 0 },
    },
    levelIncrementSlots: [],
    classes: [],
    templates: [],
